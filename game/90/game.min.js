...
cc.each = function (a, b, c) {
  if (a)
    if (a instanceof Array)
      for (var d = 0, e = a.length; d < e && false !== b.call(c, a[d], d); d++);
    else for (d in a) if (false === b.call(c, a[d], d)) break;
};
...
cc.isCrossOrigin = function (a) {
  if (!a) return cc.log("invalid URL"), false;
  var b = a.indexOf("://");
  if (-1 === b) return false;
  b = a.indexOf("/", b + 3);
    ...
    if (!(0 === a._pool.length || a._workingSize >= a._limit)) {
      ...
      a._iterator.call(
        ...
        function (b, c) {
          a.finishedSize++;
          a._workingSize--;
          b ? (a._errors[this.index] = b) : (a._results[this.index] = c);
          a.finishedSize === a.size
            ? a._onEnd &&
              a._onEnd.call(
                a._onEndTarget,
                0 === a._errors.length ? null : a._errors,
                a._results
              )
            : a._handleItem();
        }.bind(b),
...
cc.async = {
  ...
  map: function (a, b, c, d) {
    var e = b;
    "object" === typeof b &&
      ((c = b.cb), (d = b.iteratorTarget), (e = b.iterator));
...
cc.path = {
  ...
  basename: function (a, b) {
    ...
    return b &&
      ...
      ? c.substring(0, c.length - b.length)
      : c;
  },
  dirname: function (a) {
    return a.replace(/((.*)(\/|\\|\\\\))?(.*?\..*$)?/, "$2");
  ...
  return {
    ...
    _getArgs4Js: function (a) {
      ...
      if (1 === a.length) e[1] = b instanceof Array ? b : [b];
        ...
        "function" === typeof c
          ? ((e[1] = b instanceof Array ? b : [b]), (e[2] = c))
          : ((e[0] = b || ""), (e[1] = c instanceof Array ? c : [c]));
      else if (3 === a.length)
    ...
    loadJs: function (b, c, d) {
      ...
      -1 < navigator.userAgent.indexOf("Trident/5")
        ? e._loadJs4Dependency(p, s, 0, f)
        : cc.async.map(
            s,
            function (b, c, d) {
              b = cc.path.join(p, b);
              if (a[b]) return d(null);
              e._createScript(b, false, d);
            },
            f
          );
    },
    ...
    _createScript: function (b, c, d) {
      ...
      cc.game.config.noCache && "string" === typeof b
        ? this._noCacheRex.test(b)
          ? (f.src = b + "\x26_t\x3d" + (new Date() - 0))
          : (f.src = b + "?_t\x3d" + (new Date() - 0))
        : (f.src = b);
      f.addEventListener(
        "load",
        function () {
    ...
    _loadJs4Dependency: function (a, b, c, d) {
      if (c >= b.length) d && d();
        ...
        var e = this;
        e._createScript(cc.path.join(a, b[c]), false, function (f) {
          if (f) return d(f);
    ...
    loadTxt: function (a, b) {
      if (cc._isNodeJs)
        ...
        /msie/i.test(navigator.userAgent) && !/opera/i.test(navigator.userAgent)
          ? (c.setRequestHeader("Accept-Charset", "utf-8"),
    ...
    _loadTxtSync: function (a) {
      ...
      b.open("GET", a, false);
      /msie/i.test(navigator.userAgent) && !/opera/i.test(navigator.userAgent)
        ? b.setRequestHeader("Accept-Charset", "utf-8")
        : b.overrideMimeType &&
          b.overrideMimeType("text/plain; charset\x3dutf-8");
      b.send(null);
    ...
    loadImg: function (a, b, c) {
      ...
      void 0 !== c
        ? (d.isCrossOrigin =
            void 0 === b.isCrossOrigin ? d.isCrossOrigin : b.isCrossOrigin)
        : void 0 !== b && (c = b);
      var n = this.getRes(a);
      ...
      var p = function () {
          this.removeEventListener("load", p, false);
          this.removeEventListener("error", r, false);
          f.test(a) || (cc.loader.cache[a] = n);
          var b = e[a];
          if (b) {
        ...
        r = function () {
          this.removeEventListener("error", r, false);
          if (n.crossOrigin && "anonymous" === n.crossOrigin.toLowerCase())
            (d.isCrossOrigin = false), s.release(a), cc.loader.loadImg(a, d, c);
          else {
            var b = e[a];
            if (b) {
    ...
    _loadResIterator: function (a, c, d) {
      var e = this,
        ...
        p = a.type;
      p
        ? ((p = "." + p.toLowerCase()), (n = a.src ? a.src : a.name + p))
        : ((n = a), (p = cc.path.extname(n)));
      ...
      p = n;
      f.test(n) ||
        ((p = c.getBasePath ? c.getBasePath() : e.resPath),
        (p = e.getUrl(p, n)));
      cc.game.config.noCache &&
        "string" === typeof p &&
        (p = e._noCacheRex.test(p)
          ? p + ("\x26_t\x3d" + (new Date() - 0))
          : p + ("?_t\x3d" + (new Date() - 0)));
      ...
      e = new cc.AsyncPool(
        ...
        function (a, c, e, f) {
          d._loadResIterator(a, c, function (a) {
            ...
            b.trigger &&
              b.trigger.call(b.triggerTarget, c[0], f.size, f.finishedSize);
            e(a, c[0]);
          });
        },
        b.cb,
    ...
    loadAliases: function (a, b) {
      var c = this,
        d = c.getRes(a);
      d
        ? c._handleAliases(d.filenames, b)
...
(function () {
    ...
    0 === c
      ? cc.sys.capabilities.opengl
        ...
        : cc.sys.capabilities.canvas &&
          ((cc._renderType = cc.game.RENDER_TYPE_CANVAS),
          (cc._supportRender = true))
      : 1 === c && cc.sys.capabilities.canvas
      ? ((cc._renderType = cc.game.RENDER_TYPE_CANVAS),
        (cc._supportRender = true))
      : 2 === c &&
        cc.sys.capabilities.opengl &&
  ...
  function b(a, c, d) {
    ...
    for (var g = 0, k = f.length; g < k; g++) {
      ...
      if (!h[m]) {
        var w = c.extname(m);
        w
          ? ".js" === w.toLowerCase() && e.push(c.join(d, m))
          : (w = b(a, m, d)) && (e = e.concat(w));
        h[m] = 1;
      }
    }
    return e;
    ...
    if (cc.Class) c(a);
      ...
      e.loadJson(f, function (e, f) {
        ...
        var g = a.modules || [],
          h = f.module,
          k = [];
        cc.sys.capabilities.opengl && 0 > g.indexOf("base4webgl")
          ? g.splice(0, 0, "base4webgl")
          : 0 > g.indexOf("core") && g.splice(0, 0, "core");
  ...
  function e() {
    this.removeEventListener("load", e, false);
    d(cc.game.config);
  }
  ...
  (function () {
    ...
    var m = (k = false),
      ...
      A = 0,
      z =
        /android (\d+(?:\.\d+)+)/i.exec(h) ||
        /android (\d+(?:\.\d+)+)/i.exec(c.platform);
    z && ((k = true), (w = z[1] || ""), (A = parseInt(w) || 0));
    if ((z = /(iPad|iPhone|iPod).*OS ((\d+_?){2,3})/i.exec(h)))
      (m = true), (w = z[2] || ""), (A = parseInt(w) || 0);
    z = a.OS_UNKNOWN;
    -1 !== c.appVersion.indexOf("Win")
      ? (z = a.OS_WINDOWS)
      : m
      ? (z = a.OS_IOS)
      : -1 !== c.appVersion.indexOf("Mac")
      ? (z = a.OS_OSX)
      : -1 !== c.appVersion.indexOf("X11") &&
        -1 === c.appVersion.indexOf("Linux")
      ? (z = a.OS_UNIX)
      : k
      ? (z = a.OS_ANDROID)
      : -1 !== c.appVersion.indexOf("Linux") && (z = a.OS_LINUX);
    a.os = z;
    a.osVersion = w;
    a.osMainVersion = A;
    ...
    (function () {
      var b = /qqbrowser|chrome|safari|firefox|opr|oupeng|opera/i,
        c = /mqqbrowser|sogou|qzone|liebao|micromessenger|ucbrowser|360 aphone|360browser|baiduboxapp|baidubrowser|maxthon|mxbrowser|trident|miuibrowser/i.exec(
          h
        );
      c || (c = b.exec(h));
      ...
      "micromessenger" === b
        ...
        : "safari" === b && h.match(/android.*applewebkit/)
    ...
    if (b.WebGLRenderingContext) {
      ...
      try {
        if (
          ...
          var B = parseFloat(a.browserVersion);
          switch (a.browserType) {
            ...
            case a.BROWSER_TYPE_ANDROID:
              a.osMainVersion && 5 <= a.osMainVersion && (k = true);
              break;
    ...
    if (
      ...
      void 0 !== d.ontouchstart ||
      c.msPointerEnabled
    )
      B.touches = true;
    void 0 !== e.onmouseup && (B.mouse = true);
    void 0 !== e.onkeyup && (B.keyboard = true);
    if (b.DeviceMotionEvent || b.DeviceOrientationEvent) B.accelerometer = true;
  ...
  cc.initEngine = function (b, c) {
    if (k) {
      ...
      (m = c),
        ...
        (b = cc.game.config),
        a(b),
        document.body ? d(b) : cc._addEventListener(window, "load", e, false),
        (k = true);
  };
})();
cc.game = {
  ...
  pause: function () {
    this._paused ||
      ((this._paused = true),
      cc.audioEngine &&
        (cc.audioEngine.stopAllEffects(), cc.audioEngine.pauseMusic()),
      this._intervalId && window.cancelAnimationFrame(this._intervalId),
      (this._intervalId = 0));
  },
  resume: function () {
    this._paused &&
      ((this._paused = false),
      cc.audioEngine && cc.audioEngine.resumeMusic(),
      this._runMainLoop());
  },
  isPaused: function () {
    return this._paused;
      ...
      : this._prepareCalled ||
        (cc._engineLoaded
          ? ((this._prepareCalled = true),
            this._initRenderer(c[d.width], c[d.height]),
            ...
            this._runMainLoop(),
            (c = c[d.jsList])
              ? cc.loader.loadJsWithImg(c, function (c) {
                  if (c) throw Error(c);
                  b._prepared = true;
                  a && a();
                })
  ...
  _runMainLoop: function () {
    ...
    b = function () {
      a._paused ||
        (c.mainLoop(),
        a._intervalId && window.cancelAnimationFrame(a._intervalId),
      ...
      try {
        ...
        if (c < b.length) {
          if ((e = b[c].src))
            (g = /(.*)\//.exec(e)[0]),
              (cc.loader.resPath = g),
              (e = cc.path.join(g, "project.json"));
          f = cc.loader._loadTxtSync(e);
        }
        f || (f = cc.loader._loadTxtSync("project.json"));
        a = JSON.parse(f);
      } catch (h) {
  ...
  _initConfig: function (a) {
    var b = this.CONFIG_KEY,
      c = a[b.modules];
    a[b.showFPS] = "undefined" === typeof a[b.showFPS] ? true : a[b.showFPS];
    ...
    null == a[b.registerSystemEvent] && (a[b.registerSystemEvent] = true);
  ...
  _initRenderer: function (a, b) {
    if (!this._rendererInitialized) {
      ...
      "CANVAS" === c.tagName
        ? ((a = a || c.width),
          (b = b || c.height),
          (this.canvas = cc._canvas = e = c),
          (this.container = cc.container = f = document.createElement("DIV")),
          e.parentNode && e.parentNode.insertBefore(f, e))
        : ("DIV" !== c.tagName &&
            cc.log("Warning: target element is not a DIV or CANVAS"),
          (a = a || c.clientWidth),
          (b = b || c.clientHeight),
          (this.canvas = cc._canvas = e = document.createElement("CANVAS")),
          (this.container = cc.container = f = document.createElement("DIV")),
          c.appendChild(f));
      ...
      this._renderContext
        ? ((cc.renderer = cc.rendererWebGL),
          (d.gl = this._renderContext),
          cc.renderer.init(),
          cc.shaderCache._init(),
          (cc._drawingUtil = new cc.DrawingPrimitiveWebGL(this._renderContext)),
          cc.textureCache._initializingRenderer(),
          (cc.glExt = {}),
          (cc.glExt.instanced_arrays = d.gl.getExtension(
            "ANGLE_instanced_arrays"
          )),
          (cc.glExt.element_uint = d.gl.getExtension("OES_element_index_uint")))
        : ((cc._renderType = cc.game.RENDER_TYPE_CANVAS),
  ...
  _initEvents: function () {
    ...
    cc.isUndefined(document.hidden)
      ? cc.isUndefined(document.mozHidden)
        ? cc.isUndefined(document.msHidden)
          ...
          : ((b = "msHidden"), (c = "msvisibilitychange"))
        : ((b = "mozHidden"), (c = "mozvisibilitychange"))
      : ((b = "hidden"), (c = "visibilitychange"));
    var d = function () {
        cc.eventManager &&
          cc.game._eventHide &&
    ...
    b
      ...
      : (a.addEventListener("blur", d, false),
        a.addEventListener("focus", e, false));
    ...
    "onpageshow" in window &&
      ...
      (a.addEventListener("pagehide", d, false),
      a.addEventListener("pageshow", e, false));
  ...
  hasEventListener: function (a, b, c) {
    ...
    if (void 0 !== d[a]) {
      ...
      for (var e = d.length; a < e; a++) {
        var f = d[a];
        if (f.callback === b && f.eventTarget === c) return true;
      }
    }
    return false;
  },
    ...
    if (void 0 !== this._listeners) {
      ...
      if (void 0 !== c)
        for (var d = 0; d < c.length; )
          c[d].eventTarget === b ? c.splice(d, 1) : d++;
    }
  },
        ...
        (cc.assert = function (a, b) {
          if (!a && b) {
            for (var f = 2; f < arguments.length; f++)
              b = b.replace(/(%s)|(%d)/, cc._formatString(arguments[f]));
            c("Assert: " + b);
          }
        }),
          ...
          : function (a, b) {
              if (!a && b) {
                for (var c = 2; c < arguments.length; c++)
                  b = b.replace(/(%s)|(%d)/, cc._formatString(arguments[c]));
                throw Error(b);
              }
            }),
        a !== b.DEBUG_MODE_ERROR &&
...
cc.loader.loadBinary = function (a, b) {
  ...
  cc.loader.loadBinary._IEFilter
    ...
    : (d.overrideMimeType &&
        d.overrideMimeType("text/plain; charset\x3dx-user-defined"),
      (d.onload = function () {
        4 === d.readyState && 200 === d.status
          ? b(null, c._str2Uint8Array(d.responseText))
          : b(e);
      }));
  d.send(null);
};
...
if (cc.loader.loadBinary._IEFilter) {
  ...
  cc._convertResponseBodyToText = function (a) {
    for (var b = {}, c = 0; 256 > c; c++)
      for (var d = 0; 256 > d; d++)
        b[String.fromCharCode(c + 256 * d)] =
          String.fromCharCode(c) + String.fromCharCode(d);
    c = IEBinaryToArray_ByteStr(a);
    a = IEBinaryToArray_ByteStr_Last(a);
    return (
      c.replace(/[\s\S]/g, function (a) {
        return b[a];
      }) + a
    );
  };
...
cc._loaderImage =
  "data:image/png;base64,";
var cc = cc || {},
  ClassManager = {
...
(function () {
  ...
  cc.Class.extend = function (b) {
    ...
    this.__getters__ && (c.__getters__ = cc.clone(this.__getters__));
      ...
      for (m in k) {
        ...
        n && p && s
          ? ((g.value = (function (a, b) {
            ...
            Object.defineProperty(e, m, g))
          : n
          ? ((g.value = k[m]), Object.defineProperty(e, m, g))
          : (e[m] = k[m]);
        if (n) {
          var r, u;
...
cc.defineGetterSetter = function (a, b, c, d, e, f) {
  if (a.__defineGetter__)
    c && a.__defineGetter__(b, c), d && a.__defineSetter__(b, d);
  ...
  if (!e && !f)
    for (
      var g = null != c,
        h = void 0 != d,
        k = Object.getOwnPropertyNames(a),
        m = 0;
      m < k.length;
      m++
    ) {
...
cc.base = function (a, b, c) {
  ...
  if (d.superClass_)
    return (ret = d.superClass_.constructor.apply(
      a,
...
cc.SAXParser = cc.Class.extend({
  ...
  ctor: function () {
    window.DOMParser
      ? ((this._isSupportDOMParser = true), (this._parser = new DOMParser()))
  ...
  _parseNode: function (a) {
    ...
    if ("dict" === c) b = this._parseDict(a);
      ...
      "false" === c
        ...
        : "integer" === c && (b = parseInt(a.firstChild.nodeValue, 10));
    return b;
  },
...
cc._fontLoader = {
  ...
  _loadFont: function (a, b, c) {
    ...
    var h = "",
      h = isNaN(a - 0)
        ? h + ("@font-face { font-family:" + a + "; src:")
        : h + ("@font-face { font-family:'" + a + "'; src:");
    if (b instanceof Array)
      for (var k = 0, m = b.length; k < m; k++)
        (c = e.extname(b[k]).toLowerCase()),
          (h += "url('" + b[k] + "') format('" + f[c] + "')"),
          (h += k === m - 1 ? ";" : ",");
    else
      (c = c.toLowerCase()), (h += "url('" + b + "') format('" + f[c] + "');");
    g.textContent += h + "}";
  ...
  load: function (a, b, c, d) {
    ...
    cc.isString(c)
      ? ((b = cc.path.extname(c)),
        (a = cc.path.basename(c, b)),
        this._loadFont(a, c, b))
      : this._loadFont(a, b);
    document.fonts
...
cc.arrayVerifyType = function (a, b) {
  if (a && 0 < a.length)
    for (var c = 0; c < a.length; c++)
      if (!(a[c] instanceof b)) return cc.log("element type is wrong!"), false;
  return true;
};
...
cc.game.addEventListener(cc.game.EVENT_RENDERER_INITED, function () {
  if (cc._renderType === cc.game.RENDER_TYPE_WEBGL) {
    cc.color = function (a, c, d, e, f, g) {
      return void 0 === a
        ? new cc.Color(0, 0, 0, 255, f, g)
        : cc.isString(a)
        ? ((a = cc.hexToColor(a)), new cc.Color(a.r, a.g, a.b, a.a))
        : cc.isObject(a)
        ? new cc.Color(a.r, a.g, a.b, a.a, a.arrayBuffer, a.offset)
        : new cc.Color(a, c, d, e, f, g);
    };
    cc.Color = function (a, c, d, e, f, g) {
      ...
      void 0 === e && (this.a_undefined = true);
    };
...
cc.Quad3 = function (a, b, c, d, e, f) {
  ...
  f += g;
  this.br = b
    ? new cc.Vertex3F(b.x, b.y, b.z, e, f)
    : new cc.Vertex3F(0, 0, 0, e, f);
  f += g;
  this.tl = c
    ? new cc.Vertex3F(c.x, c.y, c.z, e, f)
    : new cc.Vertex3F(0, 0, 0, e, f);
  f += g;
  this.tr = d
    ? new cc.Vertex3F(d.x, d.y, d.z, e, f)
    : new cc.Vertex3F(0, 0, 0, e, f);
};
...
cc.V3F_C4B_T2F = function (a, b, c, d, e) {
  ...
  e = this._offset;
  this._vertices = a
    ? new cc.Vertex3F(a.x, a.y, a.z, d, e)
    : new cc.Vertex3F(0, 0, 0, d, e);
  e += cc.Vertex3F.BYTES_PER_ELEMENT;
  this._colors = b
    ? cc.color(b.r, b.g, b.b, b.a, d, e)
    : cc.color(0, 0, 0, 0, d, e);
...
cc.V3F_C4B_T2F_Quad = function (a, b, c, d, e, f) {
  this._arrayBuffer =
    e || new ArrayBuffer(cc.V3F_C4B_T2F_Quad.BYTES_PER_ELEMENT);
  this._offset = f || 0;
  e = this._arrayBuffer;
  f = this._offset;
  var g = cc.V3F_C4B_T2F.BYTES_PER_ELEMENT;
  this._tl = a
    ? new cc.V3F_C4B_T2F(a.vertices, a.colors, a.texCoords, e, f)
    : new cc.V3F_C4B_T2F(null, null, null, e, f);
  f += g;
  this._bl = b
    ? new cc.V3F_C4B_T2F(b.vertices, b.colors, b.texCoords, e, f)
    : new cc.V3F_C4B_T2F(null, null, null, e, f);
  f += g;
  this._tr = c
    ? new cc.V3F_C4B_T2F(c.vertices, c.colors, c.texCoords, e, f)
    : new cc.V3F_C4B_T2F(null, null, null, e, f);
  f += g;
  this._br = d
    ? new cc.V3F_C4B_T2F(d.vertices, d.colors, d.texCoords, e, f)
    : new cc.V3F_C4B_T2F(null, null, null, e, f);
};
...
cc.V3F_C4B_T2F_QuadsCopy = function (a) {
  ...
  for (var b = [], c = 0; c < a.length; c++)
    b.push(cc.V3F_C4B_T2F_QuadCopy(a[c]));
  return b;
};
cc.V2F_C4B_T2F = function (a, b, c, d, e) {
  ...
  e = this._offset;
  this._vertices = a
    ? new cc.Vertex2F(a.x, a.y, d, e)
    : new cc.Vertex2F(0, 0, d, e);
...
cc.V2F_C4B_T2F_Triangle = function (a, b, c, d, e) {
  this._arrayBuffer =
    d || new ArrayBuffer(cc.V2F_C4B_T2F_Triangle.BYTES_PER_ELEMENT);
  this._offset = e || 0;
  d = this._arrayBuffer;
  e = this._offset;
  var f = cc.V2F_C4B_T2F.BYTES_PER_ELEMENT;
  this._a = a
    ? new cc.V2F_C4B_T2F(a.vertices, a.colors, a.texCoords, d, e)
    : new cc.V2F_C4B_T2F(null, null, null, d, e);
  e += f;
  this._b = b
    ? new cc.V2F_C4B_T2F(b.vertices, b.colors, b.texCoords, d, e)
    : new cc.V2F_C4B_T2F(null, null, null, d, e);
  e += f;
  this._c = c
    ? new cc.V2F_C4B_T2F(c.vertices, c.colors, c.texCoords, d, e)
    : new cc.V2F_C4B_T2F(null, null, null, d, e);
};
...
cc.EGLView = cc.Class.extend({
  ...
  ctor: function () {
    ...
    this.enableAutoFullScreen(
      a.isMobile && a.browserType !== a.BROWSER_TYPE_BAIDU
    );
  ...
  setOrientation: function (a) {
    if ((a &= cc.ORIENTATION_AUTO)) this._orientation = a;
  },
  _initFrameSize: function () {
    var a = this._frameSize,
      ...
      d = b >= c;
    !cc.sys.isMobile ||
    (d && this._orientation & cc.ORIENTATION_LANDSCAPE) ||
    (!d && this._orientation & cc.ORIENTATION_PORTRAIT)
      ? ((a.width = b),
        (a.height = c),
  ...
  _setViewportMeta: function (a, b) {
    ...
    for (f in a)
      -1 == e.indexOf(f)
        ? (e += "," + f + "\x3d" + a[f])
        : b &&
          ((g = RegExp(f + "s*\x3ds*[^,]+")), e.replace(g, f + "\x3d" + a[f]));
    /^,/.test(e) && (e = e.substr(1));
    c.content = e;
    d && (d.content = e);
  ...
  enableRetina: function (a) {
    this._retinaEnabled = a ? true : false;
  },
  ...
  enableAutoFullScreen: function (a) {
    ...
    this._frame === document.documentElement
      ? ((this._autoFullScreen = true), cc.screen.autoFullScreen(this._frame))
  ...
  setDesignResolutionSize: function (a, b, c) {
    if (0 < a || 0 < b)
      if ((this.setResolutionPolicy(c), (c = this._resolutionPolicy))) {
        ...
        d.scale &&
          2 === d.scale.length &&
          ((this._scaleX = d.scale[0]), (this._scaleY = d.scale[1]));
        d.viewport &&
  ...
  setViewPortInPoints: function (a, b, c, d) {
    ...
    cc._renderContext.viewport(
      a * f * e + this._viewPortRect.x * e,
      b * g * e + this._viewPortRect.y * e,
      c * f * e,
      d * g * e
    );
  },
  ...
  _convertMouseToLocationInView: function (a, b) {
    ...
    a.y =
      (this._devicePixelRatio * (b.top + b.height - a.y) - c.y) / this._scaleY;
  },
...
cc.ContainerStrategy = cc.Class.extend({
  ...
  _setupContainer: function (a, b, c) {
    ...
    a.isRetinaEnabled() &&
      (e = a._devicePixelRatio = Math.min(2, window.devicePixelRatio || 1));
    d.width = b * e;
    d.height = c * e;
  ...
  var a = cc.ContainerStrategy.extend({
    ...
    b = cc.ContainerStrategy.extend({
      apply: function (a, b) {
        ...
        a._isRotated ? (e.marginLeft = d + "px") : (e.margin = "0px");
        e.paddingLeft = n + "px";
        e.paddingRight = n + "px";
        e.paddingTop = t + "px";
...
cc.screen = {
    ...
    if (this._supportsFullScreen) {
      ...
      if (b) {
        ...
        this._preOnFullScreenChange &&
          document.removeEventListener(c, this._preOnFullScreenChange);
        this._preOnFullScreenChange = b;
        document.addEventListener(c, b, false);
      }
  ...
  exitFullScreen: function () {
    return this._supportsFullScreen
      ? document[this._fn.exitFullscreen]()
      : true;
  },
...
cc.inputManager = {
  ...
  handleTouchesBegin: function (a) {
    for (
      var b, c, d, e = [], f = this._touchesIntegerDict, g = 0, h = a.length;
      g < h;
      g++
    )
      if (((b = a[g]), (d = b.getID()), (c = f[d]), null == c)) {
        ...
        -1 === k
          ? cc.log(cc._LogInfos.inputManager_handleTouchesBegin, k)
          : ((c = this._touches[k] = new cc.Touch(
              b._point.x,
              b._point.y,
              b.getID()
            )),
            c._setPrevPoint(b._prevPoint),
            (f[d] = k),
            e.push(c));
      }
    0 < e.length &&
  ...
  handleTouchesMove: function (a) {
    for (var b, c, d = [], e = this._touches, f = 0, g = a.length; f < g; f++)
      (b = a[f]),
        (c = b.getID()),
        (c = this._touchesIntegerDict[c]),
        null != c &&
          e[c] &&
          (e[c]._setPoint(b._point),
          e[c]._setPrevPoint(b._prevPoint),
          d.push(e[c]));
    0 < d.length &&
      (this._glView._convertTouchesWithScale(d),
      (a = new cc.EventTouch(d)),
  ...
  getSetOfTouchesEndOrCancel: function (a) {
    for (
      ...
      (b = a[h]),
        ...
        null != c &&
          f[c] &&
          (f[c]._setPoint(b._point),
          f[c]._setPrevPoint(b._prevPoint),
          e.push(f[c]),
  ...
  getHTMLElementPosition: function (a) {
    var b = document.documentElement,
      c = window,
      d = null,
      d = cc.isFunction(a.getBoundingClientRect)
  ...
  getPreTouch: function (a) {
    for (
      var b = null, c = this._preTouchPool, d = a.getID(), e = c.length - 1;
      0 <= e;
      e--
    )
      if (c[e].getID() === d) {
  ...
  setPreTouch: function (a) {
    for (
      var b = false, c = this._preTouchPool, d = a.getID(), e = c.length - 1;
      0 <= e;
      e--
    )
      if (c[e].getID() === d) {
  ...
  getTouchesByEvent: function (a, b) {
    for (
      var c = [],
        ...
        e,
        f,
        g = this._preTouchPoint,
        h = a.changedTouches.length,
        k = 0;
      k < h;
      k++
    )
      if ((e = a.changedTouches[k])) {
        ...
        m =
          cc.sys.BROWSER_TYPE_FIREFOX === cc.sys.browserType
            ? d.convertToLocationInView(e.pageX, e.pageY, b)
            : d.convertToLocationInView(e.clientX, e.clientY, b);
        null != e.identifier
          ? ((e = new cc.Touch(m.x, m.y, e.identifier)),
            (f = this.getPreTouch(e).getLocation()),
            e._setPrevPoint(f.x, f.y),
            this.setPreTouch(e))
          : ((e = new cc.Touch(m.x, m.y)), e._setPrevPoint(g.x, g.y));
        g.x = m.x;
        g.y = m.y;
        c.push(e);
      }
  ...
  registerSystemEvent: function (a) {
    if (!this._isRegisterEvent) {
      ...
      var b = this,
        ...
        e = false;
      cc.sys.isMobile && (e = true);
      c &&
        (window.addEventListener(
          "mousedown",
          function () {
            b._mousePressed = true;
          },
          false
        ),
        window.addEventListener(
...
_p._registerKeyboardEvent = function () {
  cc._canvas.addEventListener(
    "keydown",
    function (a) {
      cc.eventManager.dispatchEvent(new cc.EventKeyboard(a.keyCode, true));
      a.stopPropagation();
      a.preventDefault();
    },
    false
  ...
  cc._canvas.addEventListener(
    "keyup",
    function (a) {
      cc.eventManager.dispatchEvent(new cc.EventKeyboard(a.keyCode, false));
      a.stopPropagation();
      a.preventDefault();
    },
    false
...
_p._registerAccelerometerEvent = function () {
  ...
  if (
    /Android/.test(c) ||
    (/Adr/.test(c) && cc.sys.browserType === cc.BROWSER_TYPE_UC)
  )
    this._minus = -1;
  a.addEventListener(b, this.didAccelerate.bind(this), false);
};
  ...
  if (this._accelEnabled) {
    ...
    this._accelDeviceEvent === window.DeviceMotionEvent
      ? ((f = a.accelerationIncludingGravity),
        (d = this._accelMinus * f.x * 0.1),
        (e = this._accelMinus * f.y * 0.1),
        (f = 0.1 * f.z))
      : ((d = (a.gamma / 90) * 0.981),
        (e = 0.981 * -(a.beta / 90)),
        (f = (a.alpha / 90) * 0.981));
...
cc.pLineIntersect = function (a, b, c, d, e) {
  ...
  e.x = g * a - d * h;
  e.y = f * a - b * h;
  if (0 === c) return 0 === e.x || 0 === e.y ? true : false;
  e.x /= c;
  e.y /= c;
  return true;
};
...
cc.pSameAs = function (a, b) {
  return null != a && null != b ? a.x === b.x && a.y === b.y : false;
};
...
cc.vertexLineToPolygon = function (a, b, c, d, e) {
  ...
  if (!(1 >= e)) {
    ...
    for (var f, g = e - 1, h = d; h < e; h++) {
      ...
      if (0 === h)
        m = cc.pPerp(
          cc.pNormalize(cc.pSub(k, cc.p(a[2 * (h + 1)], a[2 * (h + 1) + 1])))
        );
      else if (h === g)
        m = cc.pPerp(
          cc.pNormalize(cc.pSub(cc.p(a[2 * (h - 1)], a[2 * (h - 1) + 1]), k))
        );
      else {
        ...
        m =
          r < cc.degreesToRadians(70)
            ? cc.pPerp(cc.pNormalize(cc.pMidpoint(p, s)))
            : r < cc.degreesToRadians(170)
            ? cc.pNormalize(cc.pMidpoint(p, s))
            : cc.pPerp(cc.pNormalize(cc.pSub(n, m)));
      }
      m = cc.pMult(m, b);
      c[2 * f] = k.x + m.x;
      c[2 * f + 1] = k.y + m.y;
    ...
    for (h = 0 === d ? 0 : d - 1; h < g; h++)
      (f = 2 * h),
        ...
        !b.isSuccess && (0 > b.value || 1 < b.value) && (b.isSuccess = true),
        b.isSuccess &&
          ((c[2 * a] = d.x),
          (c[2 * a + 1] = d.y),
          (c[2 * (a + 1)] = f.x),
...
cc.vertexListIsClockwise = function (a) {
  for (var b = 0, c = a.length; b < c; b++) {
    var d = a[(b + 1) % c],
      e = a[(b + 2) % c];
    if (0 < cc.pCross(cc.pSub(d, a[b]), cc.pSub(e, d))) return false;
  }
  return true;
};
...
cc.EventListener.create = function (a) {
  ...
  b === cc.EventListener.TOUCH_ONE_BY_ONE
    ? (c = new cc._EventListenerTouchOneByOne())
    : b === cc.EventListener.TOUCH_ALL_AT_ONCE
    ? (c = new cc._EventListenerTouchAllAtOnce())
    : b === cc.EventListener.MOUSE
    ? (c = new cc._EventListenerMouse())
    : b === cc.EventListener.CUSTOM
    ? ((c = new cc._EventListenerCustom(a.eventName, a.callback)),
      delete a.eventName,
      delete a.callback)
    : b === cc.EventListener.KEYBOARD
    ? (c = new cc._EventListenerKeyboard())
    : b === cc.EventListener.ACCELERATION
    ? ((c = new cc._EventListenerAcceleration(a.callback)), delete a.callback)
    : b === cc.EventListener.FOCUS && (c = new cc._EventListenerFocus());
...
cc._EventListenerFocus = cc.EventListener.extend({
  ...
  checkAvailable: function () {
    return this.onFocusChanged
      ? true
      : (cc.log("Invalid EventListenerFocus!"), false);
  },
  onFocusChanged: null,
  ctor: function () {
    cc.EventListener.prototype.ctor.call(
...
cc.eventManager = {
  ...
  pauseTarget: function (a, b) {
    var c = this._nodeListenersMap[a.__instanceId],
      d,
      e;
    if (c) for (d = 0, e = c.length; d < e; d++) c[d]._setPaused(true);
    if (true === b)
      for (c = a.getChildren(), d = 0, e = c.length; d < e; d++)
        this.pauseTarget(c[d], true);
  },
  resumeTarget: function (a, b) {
    var c = this._nodeListenersMap[a.__instanceId],
      d,
      e;
    if (c) for (d = 0, e = c.length; d < e; d++) c[d]._setPaused(false);
    this._setDirtyForNode(a);
    if (true === b)
      for (c = a.getChildren(), d = 0, e = c.length; d < e; d++)
        this.resumeTarget(c[d], true);
  },
  ...
  _forceAddEventListener: function (a) {
    ...
    0 === a._getFixedPriority()
      ? (this._setDirty(b, this.DIRTY_SCENE_GRAPH_PRIORITY),
        ...
        null === b && cc.log(cc._LogInfos.eventManager__forceAddEventListener),
        this._associateNodeAndEventListener(b, a),
        b.isRunning() && this.resumeTarget(b))
  ...
  _removeAllListenersInVector: function (a) {
    if (a)
      for (var b, c = 0; c < a.length; )
        (b = a[c]),
          b._setRegistered(false),
          null != b._getSceneGraphPriority() &&
            (this._dissociateNodeAndEventListener(
              b._getSceneGraphPriority(),
              b
            ),
  ...
  _removeListenersForListenerID: function (a) {
    ...
    for (b = 0; b < c.length; )
      (d = c[b]) && d._getListenerID() === a ? cc.arrayRemoveObject(c, d) : ++b;
  },
  _sortEventListeners: function (a) {
    ...
    b !== this.DIRTY_NONE &&
      ((c[a] = this.DIRTY_NONE),
      b & this.DIRTY_FIXED_PRIORITY && this._sortListenersOfFixedPriority(a),
      b & this.DIRTY_SCENE_GRAPH_PRIORITY &&
        ((b = cc.director.getRunningScene())
          ? this._sortListenersOfSceneGraphPriority(a, b)
          : (c[a] = this.DIRTY_SCENE_GRAPH_PRIORITY)));
  },
  ...
  _sortEventListenersOfSceneGraphPriorityDes: function (a, b) {
    ...
    return b && e && c[e.__instanceId]
      ? a && d && c[d.__instanceId]
        ? c[b._getSceneGraphPriority().__instanceId] -
          c[a._getSceneGraphPriority().__instanceId]
        : 1
      : -1;
  },
  ...
  _onUpdateListeners: function (a) {
    if ((a = this._listenersMap[a])) {
      var b = a.getFixedPriorityListeners(),
        ...
        d,
        e,
        f = this._toRemovedListeners;
      if (c)
        for (d = 0; d < c.length; )
          (e = c[d]),
            e._isRegistered()
              ? ++d
              : (cc.arrayRemoveObject(c, e),
                (e = f.indexOf(e)),
                -1 !== e && f.splice(e, 1));
      if (b)
        for (d = 0; d < b.length; )
  ...
  _cleanToRemovedListeners: function () {
    for (var a = this._toRemovedListeners, b = 0; b < a.length; b++) {
      var c = a[b],
        d = this._listenersMap[c._getListenerID()];
      if (d) {
        var e = d.getFixedPriorityListeners(),
          f = d.getSceneGraphPriorityListeners();
        f && ((d = f.indexOf(c)), -1 !== d && f.splice(d, 1));
        e && ((d = e.indexOf(c)), -1 !== d && e.splice(d, 1));
      }
    }
    a.length = 0;
  },
  _onTouchEventCallback: function (a, b) {
    if (!a._isRegistered) return false;
    var c = b.event,
      d = b.selTouch;
    ...
    if (g === h.BEGAN)
      a.onTouchBegan &&
        (e = a.onTouchBegan(d, c)) &&
        a._registered &&
        a._claimedTouches.push(d);
    else if (
      0 < a._claimedTouches.length &&
      -1 !== (f = a._claimedTouches.indexOf(d))
    )
      if (((e = true), g === h.MOVED && a.onTouchMoved)) a.onTouchMoved(d, c);
      else if (g === h.ENDED) {
    ...
    return c.isStopped()
      ? (cc.eventManager._updateListeners(c), true)
      : e && a._registered && a.swallowTouches
      ? (b.needsMutableSet && b.touches.splice(d, 1), true)
      : false;
  },
    ...
    if (null !== b || null !== c) {
      ...
      if (b)
        for (var g = 0; g < d.length; g++)
          if (
            ((f.selTouch = d[g]),
            this._dispatchEventToListeners(b, this._onTouchEventCallback, f),
            a.isStopped())
          )
            return;
      if (
        c &&
        0 < e.length &&
        (this._dispatchEventToListeners(c, this._onTouchesEventCallback, {
          event: a,
          touches: e,
        }),
        a.isStopped())
  ...
  _onTouchesEventCallback: function (a, b) {
    ...
    else if (f === c.CANCELLED && a.onTouchesCancelled)
      a.onTouchesCancelled(e, d);
    return d.isStopped() ? (cc.eventManager._updateListeners(d), true) : false;
  },
  ...
  _dissociateNodeAndEventListener: function (a, b) {
    ...
    c &&
      ...
      0 === c.length && delete this._nodeListenersMap[a.__instanceId]);
  },
  _dispatchEventToListeners: function (a, b, c) {
    ...
    if (e && 0 !== e.length)
      for (; g < a.gt0Index; ++g)
        if (
          ((h = e[g]),
          h.isEnabled() && !h._isPaused() && h._isRegistered() && b(h, c))
        ) {
          d = true;
          break;
        }
  ...
  _visitTarget: function (a, b) {
    ...
    if (0 < e) {
      for (var h; d < e; d++)
        if ((h = c[d]) && 0 > h.getLocalZOrder()) this._visitTarget(h, false);
        else break;
      null != g[a.__instanceId] &&
        (f[a.getGlobalZOrder()] || (f[a.getGlobalZOrder()] = []),
        f[a.getGlobalZOrder()].push(a.__instanceId));
      for (; d < e; d++) (h = c[d]) && this._visitTarget(h, false);
    } else
      null != g[a.__instanceId] &&
        (f[a.getGlobalZOrder()] || (f[a.getGlobalZOrder()] = []),
        f[a.getGlobalZOrder()].push(a.__instanceId));
    if (b) {
      ...
      for (d = 0; d < k; d++)
        for (e = f[c[d]], g = 0; g < e.length; g++)
          h[e[g]] = ++this._nodePriorityIndex;
  ...
  addListener: function (a, b) {
    ...
    if (!(a instanceof cc.EventListener))
      cc.assert(!cc.isNumber(b), cc._LogInfos.eventManager_addListener_3),
  ...
  removeListener: function (a) {
    if (null != a) {
      ...
      for (d in c) {
        ...
        (b = this._removeListenerInVector(b, a))
          ? this._setDirty(a._getListenerID(), this.DIRTY_SCENE_GRAPH_PRIORITY)
          : (b = this._removeListenerInVector(f, a)) &&
            this._setDirty(a._getListenerID(), this.DIRTY_FIXED_PRIORITY);
        e.empty() &&
          (delete this._priorityDirtyFlagMap[a._getListenerID()], delete c[d]);
        if (b) break;
      }
      if (!b)
  ...
  _removeListenerInCallback: function (a, b) {
    ...
    for (var c = 0, d = a.length; c < d; c++) {
      var e = a[c];
      if (e._onCustomEvent === b || e._onEvent === b)
        return (
          e._setRegistered(false),
      ...
      if (e === b)
        return (
          ...
          null != e._getSceneGraphPriority() &&
            ...
            e._setSceneGraphPriority(null)),
          0 === this._inDispatch
            ? cc.arrayRemoveObject(a, e)
            : this._toRemovedListeners.push(e),
          true
        );
    }
    return false;
  ...
  removeListeners: function (a, b) {
    if (a instanceof cc.Node) {
      ...
      var c = this._nodeListenersMap[a.__instanceId];
      if (c) {
        for (var d = cc.copyArray(c), c = 0; c < d.length; c++)
      ...
      if (true === b)
        for (d = a.getChildren(), c = 0, e = d.length; c < e; c++)
          this.removeListeners(d[c], true);
    } else
  ...
  dispatchEvent: function (a) {
    if (this._isEnabled) {
      ...
      if (a.getType() === cc.Event.TOUCH) this._dispatchTouchEvent(a);
        ...
        null != b &&
          this._dispatchEventToListeners(b, this._onListenerCallback, a);
        this._updateListeners(a);
      }
      this._inDispatch--;
    }
...
cc._EventListenerKeyboard = cc.EventListener.extend({
  ...
  checkAvailable: function () {
    return null === this.onKeyPressed && null === this.onKeyReleased
      ? (cc.log(cc._LogInfos._EventListenerKeyboard_checkAvailable), false)
      : true;
  },
});
...
cc.rendererCanvas = {
  ...
  clear: function () {
    ...
    if (
      ...
      b.setFillStyle(this._clearFillStyle),
        b.setGlobalAlpha(this._clearColor.a),
...
(function () {
  ...
  a.setTransform = function (a, c, d) {
    0 < this._armatureMode
      ? (this.restore(),
        this.save(),
        this._context.transform(a.a, -a.b, -a.c, a.d, a.tx * c, -(a.ty * d)))
      : this._context.setTransform(
          a.a,
          -a.b,
          -a.c,
          a.d,
          this._offsetX + a.tx * c,
          this._realOffsetY - a.ty * d
        );
  };
    ...
    a
      ? (this._armatureMode++,
        this._context.setTransform(
          ...
          c.b,
          c.d,
          this._offsetX + c.tx * d,
          this._realOffsetY - c.ty * e
        ),
        this.save())
  ...
  return {
    ...
    init: function () {
      ...
      if (b) {
        ...
        for (var e = new Uint16Array(12e3), p = 0, s = 0; 12e3 > s; s += 6)
          (e[s] = p + 0),
            (e[s + 1] = p + 1),
            (e[s + 2] = p + 2),
            (e[s + 3] = p + 1),
      ...
      c &&
        ((g = 48e3),
        (f = new ArrayBuffer(4 * g)),
        (h = new Float32Array(f)),
        (k = new Uint32Array(f)),
        a.bindBuffer(a.ARRAY_BUFFER, c),
        a.bufferData(a.ARRAY_BUFFER, h, a.DYNAMIC_DRAW));
      d = 8e3;
    },
    ...
    _uploadBufferData: function (b) {
      ...
      var c = b._node._texture,
        f = b._node._blendFunc.src,
        g = b._node._blendFunc.dst,
        r = b._shaderProgram;
      if (
        a.texture !== c ||
        a.blendSrc !== f ||
    ...
    _batchRendering: function () {
      if (0 !== e && a.texture) {
        ...
        g = !f.bindBuffer(f.ARRAY_BUFFER, c);
        e > 0.5 * d
        ...
        f.drawElements(f.TRIANGLES, 6 * s, f.UNSIGNED_SHORT, 0);
        cc.g_NumberOfDraws++;
        e = 0;
      }
    },
    rendering: function (b, c) {
      var d = c || this._renderCmds,
        ...
        g,
        h,
        k = b || cc._renderContext;
      k.bindBuffer(gl.ARRAY_BUFFER, null);
      f = 0;
      for (g = d.length; f < g; ++f)
        (h = d[f]),
          h.uploadData
            ? this._uploadBufferData(h)
            : (0 < e && this._batchRendering(), h.rendering(k));
      this._batchRendering();
      a.texture = null;
    },
  };
...
cc.Node = cc.Class.extend({
  ...
  _addChildHelper: function (a, b, c, d, e) {
    ...
    if (this._running && (a.onEnter(), this._isTransitionFinished))
  ...
  removeFromParent: function (a) {
    this._parent &&
      (void 0 === a && (a = true), this._parent.removeChild(this, a));
  },
  ...
  removeAllChildren: function (a) {
    ...
    if (null !== b) {
      ...
      for (var c = 0; c < b.length; c++) {
        var d = b[c];
        d &&
          (this._running && (d.onExitTransitionDidStart(), d.onExit()),
          a && d.cleanup(),
          (d.parent = null),
          d._renderCmd.detachFromParent());
      }
      ...
      for (c = 1; c < b; c++) {
        ...
        for (d = c - 1; 0 <= d; ) {
          if (e._localZOrder < a[d]._localZOrder) a[d + 1] = a[d];
            ...
            e._localZOrder === a[d]._localZOrder &&
            e.arrivalOrder < a[d].arrivalOrder
          )
            a[d + 1] = a[d];
          else break;
          d--;
  ...
  schedule: function (a, b, c, d, e) {
    ...
    "function" === typeof a
      ? 1 === f
        ? ((b = 0), (c = cc.REPEAT_FOREVER), (d = 0), (e = this.__instanceId))
        : 2 === f
        ? "number" === typeof b
          ? ((c = cc.REPEAT_FOREVER), (d = 0), (e = this.__instanceId))
          : ((e = b), (b = 0), (c = cc.REPEAT_FOREVER), (d = 0))
        : 3 === f
        ? ("string" === typeof c
            ? ((e = c), (c = cc.REPEAT_FOREVER))
            : (e = this.__instanceId),
          (d = 0))
        : 4 === f && (e = this.__instanceId)
      : 1 === f
      ? ((b = 0), (c = cc.REPEAT_FOREVER), (d = 0))
      : 2 === f && ((c = cc.REPEAT_FOREVER), (d = 0));
  ...
  setAdditionalTransform: function (a) {
    if (void 0 === a) return (this._additionalTransformDirty = false);
  ...
  removeComponent: function (a) {
    return this._componentContainer
      ? this._componentContainer.remove(a)
      : false;
  },
  ...
  getNodeToParentTransform: function (a) {
    ...
    if (a)
      for (
        ...
        cc.affineTransformConcatIn(b, c.getNodeToParentTransform());
    return b;
  },
  ...
  getBoundingBoxToWorld: function () {
    ...
    for (var c = this._children, d = 0; d < c.length; d++) {
      ...
      e &&
        e._visible &&
        (e = e._getBoundingBoxToCurrentNode(b)) &&
        (a = cc.rectUnion(a, e));
    }
    return a;
  },
  _getBoundingBoxToCurrentNode: function (a) {
    ...
    for (var c = this._children, d = 0; d < c.length; d++) {
      ...
      e &&
        e._visible &&
        (e = e._getBoundingBoxToCurrentNode(a)) &&
        (b = cc.rectUnion(b, e));
    }
    return b;
  },
  ...
  doEnumerateRecursive: function (a, b, c) {
    if (!a.doEnumerate(b, c))
      for (
        var d = a.getChildren(), e = d.length, f = 0;
        f < e && ((a = d[f]), !this.doEnumerateRecursive(a, b, c));
        f++
      );
  },
  doEnumerate: function (a, b) {
    var c = a.indexOf("/"),
      d = a,
      e = false;
    -1 !== c && ((d = a.substr(0, c)), (e = true));
    for (var c = false, f, g = this._children, h = g.length, k = 0; k < h; k++)
...
cc.Node.RenderCmd = function (a) {
  ...
  this._cascadeOpacityEnabledDirty = this._cascadeColorEnabledDirty = false;
  this._curLevel = -1;
};
cc.Node.RenderCmd.prototype = {
  ...
  transform: function (a, b) {
    ...
    if (c._usingNormalizedPosition && c._parent) {
      ...
      c._normalizedPositionDirty = false;
    }
    ...
    if (h || k) {
      ...
      e.ty = c._position.y;
      h &&
        ((s = 0.017453292519943295 * c._rotationX),
        (u = Math.sin(s)),
        (t = Math.cos(s)),
        c._rotationY === c._rotationX
          ? ((s = t), (r = -u))
          : ((r = 0.017453292519943295 * c._rotationY),
            (s = Math.cos(r)),
            (r = -Math.sin(r))));
      e.a = s *= m;
      e.b = r *= m;
      ...
      e.d = t *= n;
      k &&
        ((k = Math.tan((c._skewX * Math.PI) / 180)),
        (m = Math.tan((c._skewY * Math.PI) / 180)),
      ...
      if (g || p)
        (e.tx -= e.a * g + e.c * p),
          (e.ty -= e.b * g + e.d * p),
          c._ignoreAnchorPointForPosition && ((e.tx += g), (e.ty += p));
      d
        ? ((f.a = e.a * d.a + e.b * d.c),
          (f.b = e.a * d.b + e.b * d.d),
          (f.c = e.c * d.a + e.d * d.c),
          (f.d = e.c * d.b + e.d * d.d),
          (f.tx = d.a * e.tx + d.c * e.ty + d.tx),
          (f.ty = d.d * e.ty + d.ty + d.b * e.tx))
        : ((f.a = e.a),
          (f.b = e.b),
          (f.c = e.c),
          (f.d = e.d),
      ...
      d
        ? ((f.a = e.a * d.a + e.b * d.c),
          ...
          (f.c = e.c * d.a + e.d * d.c),
          (f.d = e.c * d.b + e.d * d.d),
          (f.tx = e.tx * d.a + e.ty * d.c + d.tx),
          (f.ty = e.tx * d.b + e.ty * d.d + d.ty))
        : ((f.a = e.a),
          (f.b = e.b),
          (f.c = e.c),
          (f.d = e.d),
    ...
    c._additionalTransformDirty &&
      (this._transform = cc.affineTransformConcat(e, c._additionalTransform));
    if (b) {
      c = this._node._children;
      if (!c || 0 === c.length) return;
      d = 0;
      for (e = c.length; d < e; d++) c[d]._renderCmd.transform(this, b);
    }
    this._cacheDirty = true;
  },
  getNodeToParentTransform: function () {
    this._dirtyFlag & cc.Node._dirtyFlags.transformDirty && this.transform();
  ...
  visit: function (a) {
    ...
    if (b._visible) {
      ...
      isNaN(b._customZ) &&
        ((b._vertexZ = c.assignedZ), (c.assignedZ += c.assignedZStep));
      this._syncStatus(a);
      this.visitChildren();
    }
  },
  _updateDisplayColor: function (a) {
    ...
    if (this._cascadeColorEnabledDirty && !b._cascadeColorEnabled) {
      ...
      for (d = a.length; b < d; b++)
        (e = a[b]) && e._renderCmd && e._renderCmd._updateDisplayColor(c);
      ...
      for (a = b._children, b = 0, d = a.length; b < d; b++)
        (e = a[b]) &&
          e._renderCmd &&
          (e._renderCmd._updateDisplayColor(c), e._renderCmd._updateColor());
  ...
  _updateDisplayOpacity: function (a) {
    ...
    if (this._cascadeOpacityEnabledDirty && !b._cascadeOpacityEnabled) {
      ...
      for (b = c.length; a < b; a++)
        (d = c[a]) && d._renderCmd && d._renderCmd._updateDisplayOpacity(255);
      ...
      for (c = b._children, a = 0, b = c.length; a < b; a++)
        (d = c[a]) &&
          d._renderCmd &&
          (d._renderCmd._updateDisplayOpacity(this._displayedOpacity),
  ...
  updateStatus: function () {
    ...
    b & a.transformDirty &&
      ...
      (this._dirtyFlag ^= this._dirtyFlag & a.transformDirty));
  ...
  _syncStatus: function (a) {
    ...
    a
      ? ((d = a._node),
        (this._savedDirtyFlag = this._savedDirtyFlag || a._savedDirtyFlag || c))
      : (this._savedDirtyFlag = this._savedDirtyFlag || c);
    d &&
      d._cascadeColorEnabled &&
      a._dirtyFlag & b.colorDirty &&
      (c |= b.colorDirty);
    d &&
      d._cascadeOpacityEnabled &&
      a._dirtyFlag & b.opacityDirty &&
      (c |= b.opacityDirty);
    ...
    c & b.transformDirty && this.transform(a);
    c & b.orderDirty && (this._dirtyFlag ^= this._dirtyFlag & b.orderDirty);
  },
  visitChildren: function () {
    ...
    if (0 < e) {
      b.sortAllChildren();
      for (b = 0; b < e; b++)
        if (((d = c[b]), 0 > d._localZOrder)) d._renderCmd.visit(this);
        else break;
      for (a.pushRenderCommand(this); b < e; b++) c[b]._renderCmd.visit(this);
    } else a.pushRenderCommand(this);
    this._dirtyFlag = 0;
  },
};
...
(function () {
  ...
  a.setDirtyFlag = function (a, c) {
    ...
    this._cachedParent && this._cachedParent.setDirtyFlag(a, true);
  };
  ...
  a._setCachedParent = function (a) {
    if (this._cachedParent !== a) {
      ...
      for (var c = this._node._children, d = 0, e = c.length; d < e; d++)
        c[d]._renderCmd._setCachedParent(a);
    }
  };
  a.detachFromParent = function () {
    this._cachedParent = null;
    for (var a = this._node._children, c, d = 0, e = a.length; d < e; d++)
      (c = a[d]) && c._renderCmd && c._renderCmd.detachFromParent();
  };
...
(function () {
  ...
  a.initWithTexture = function (a, c, d, e) {
    ...
    f._itemWidth = c;
    f._itemHeight = d;
    f._opacityModifyRGB = true;
    f._texture = a;
    if (!f._texture)
      return cc.log(cc._LogInfos.AtlasNode__initWithTexture), false;
  ...
  a._changeTextureColor = function () {
    ...
    a === this._textureToRender
      ? (this._textureToRender = a._generateColorTexture(c.r, c.g, c.b, d))
...
(function () {
  ...
  a.rendering = function (a) {
    ...
    this._uniformColor &&
      ...
      this._textureAtlas.drawNumberOfQuads(c.quadsToDraw, 0));
  };
  a.initWithTexture = function (a, c, d, e) {
    var f = this._node;
    f._itemWidth = c;
...
cc._tmp.WebGLTexture2D = function () {
  cc.Texture2D = cc.Class.extend({
    ...
    initWithData: function (a, b, c, d, e) {
      ...
      0 === m % 8
        ? g.pixelStorei(g.UNPACK_ALIGNMENT, 8)
        : 0 === m % 4
        ? g.pixelStorei(g.UNPACK_ALIGNMENT, 4)
        : 0 === m % 2
        ? g.pixelStorei(g.UNPACK_ALIGNMENT, 2)
      ...
      this._hasMipmaps = this._hasPremultipliedAlpha = false;
    ...
    drawAtPoint: function (a) {
      ...
      c.vertexAttribPointer(cc.VERTEX_ATTRIB_POSITION, 2, c.FLOAT, false, 0, a);
    ...
    initWithImage: function (a) {
      if (null == a) return cc.log(cc._LogInfos.Texture2D_initWithImage), false;
      var b = a.getWidth(),
        c = a.getHeight(),
        d = cc.configuration.getMaxTextureSize();
      if (b > d || c > d)
        return (
          cc.log(cc._LogInfos.Texture2D_initWithImage_2, b, c, d, d), false
        );
    ...
    initWithElement: function (a) {
      a &&
        ...
        (this._hasPremultipliedAlpha = this._textureLoaded = true));
    },
    ...
    setTexParameters: function (a, b, c, d) {
      ...
      cc.assert(
        (this._pixelsWide === cc.NextPOT(this._pixelsWide) &&
          ...
          (a.wrapS === e.CLAMP_TO_EDGE && a.wrapT === e.CLAMP_TO_EDGE),
    ...
    _initPremultipliedATextureWithImage: function (a, b, c) {
      ...
      g ||
        (8 <= m
          ? (k = d.PIXEL_FORMAT_RGB888)
          : (cc.log(cc._LogInfos.Texture2D__initPremultipliedATextureWithImage),
            (k = d.PIXEL_FORMAT_RGB565)));
      var n = b * c;
      if (k === d.PIXEL_FORMAT_RGB565)
        if (g)
          for (e = new Uint16Array(b * c), f = a.getData(), m = 0; m < n; ++m)
            e[m] =
              ((((f[m] >> 0) & 255) >> 3) << 11) |
              ((((f[m] >> 8) & 255) >> 2) << 5) |
              ((((f[m] >> 16) & 255) >> 3) << 0);
        ...
        for (e = new Uint8Array(b * c), f = a.getData(), m = 0; m < n; ++m)
          e[m] = (f >> 24) & 255;
      if (g && k === d.PIXEL_FORMAT_RGB888)
        for (f = a.getData(), e = new Uint8Array(b * c * 3), m = 0; m < n; ++m)
          (e[3 * m] = (f >> 0) & 255),
            (e[3 * m + 1] = (f >> 8) & 255),
            (e[3 * m + 2] = (f >> 16) & 255);
...
cc._tmp.WebGLTextureAtlas = function () {
  ...
  a.drawNumberOfQuads = function (a, c) {
    ...
    if (0 !== a && this.texture && this.texture.isLoaded()) {
      ...
      this.dirty &&
        (d.bufferData(d.ARRAY_BUFFER, this._quadsArrayBuffer, d.DYNAMIC_DRAW),
        (this.dirty = false));
      ...
      cc.TEXTURE_ATLAS_USE_TRIANGLE_STRIP
        ? d.drawElements(
            ...
            6 * a,
            d.UNSIGNED_SHORT,
            6 * c * this._indices.BYTES_PER_ELEMENT
          )
        : d.drawElements(
            d.TRIANGLES,
            6 * a,
...
cc.game.addEventListener(cc.game.EVENT_RENDERER_INITED, function () {
  if (cc._renderType === cc.game.RENDER_TYPE_CANVAS) {
    var a = {
      ...
      _generateTextureCacheForColor: function () {
        ...
        for (var f = f.getImageData(0, 0, d, e).data, g, h = 0; 4 > h; h++) {
          g = a[h].getContext("2d");
          for (
            var k = g.getImageData(0, 0, d, e), m = k.data, n = 0;
            n < f.length;
            n += 4
          )
            (m[n] = 0 === h ? f[n] : 0),
    ...
    a._generateColorTexture = cc.sys._supportCanvasNewBlendModes
      ? function (a, c, d, e, f) {
          var g = false;
          f ? (g = true) : (f = document.createElement("canvas"));
      ...
      : function (a, c, d, e, f) {
          ...
          if (m && e) {
            ...
            0 < a &&
              ((n.globalAlpha = a / 255),
              n.drawImage(p[0], h, k, m, e, 0, 0, m, e));
            0 < c &&
              ((n.globalAlpha = c / 255),
              n.drawImage(p[1], h, k, m, e, 0, 0, m, e));
            0 < d &&
              ((n.globalAlpha = d / 255),
              n.drawImage(p[2], h, k, m, e, 0, 0, m, e));
            if (g) return f;
            a = new cc.Texture2D();
            a.initWithElement(f);
            a.handleLoadedTexture();
...
cc.textureCache = {
  ...
  getTextureColors: function (a) {
    ...
    this._textureColorsCache[c] ||
      (this._textureColorsCache[c] = a._generateTextureCacheForColor());
  ...
  dumpCachedTextureInfo: function () {
    ...
    for (d in c) {
      var e = c[d];
      a++;
      e.getHtmlElementObj() instanceof HTMLImageElement
        ? cc.log(
            cc._LogInfos.textureCache_dumpCachedTextureInfo,
            d,
            e.getHtmlElementObj().src,
            e.pixelsWidth,
            e.pixelsHeight
          )
        : cc.log(
...
cc.TextureAtlas = cc.Class.extend({
  ...
  _setQuadToArray: function (a, b) {
    var c = this._quads;
    c[b]
      ? ((c[b].bl = a.bl), (c[b].br = a.br), (c[b].tl = a.tl), (c[b].tr = a.tr))
      : (c[b] = new cc.V3F_C4B_T2F_Quad(
          a.tl,
          a.bl,
          a.tr,
          a.br,
  ...
  _setupIndices: function () {
    if (0 !== this._capacity)
      for (var a = this._indices, b = this._capacity, c = 0; c < b; c++)
        cc.TEXTURE_ATLAS_USE_TRIANGLE_STRIP
          ? ((a[6 * c + 0] = 4 * c + 0),
            (a[6 * c + 1] = 4 * c + 0),
            (a[6 * c + 2] = 4 * c + 2),
  ...
  initWithTexture: function (a, b) {
    ...
    if ((!this._quads || !this._indices) && 0 < b) return false;
    for (var d = this._quads, e = 0; e < b; e++)
      d[e] = new cc.V3F_C4B_T2F_Quad(
        null,
        null,
        null,
        null,
  ...
  insertQuads: function (a, b, c) {
    ...
    if (this._totalQuads > this._capacity)
      ...
      var e = b * d,
        ...
        h;
      for (h = 0; h < c; h++)
        this._quads[g + h] = new cc.V3F_C4B_T2F_Quad(
          null,
          null,
          null,
          null,
  ...
  insertQuadFromIndex: function (a, b) {
    if (a !== b) {
      ...
      a > b
        ? ((f = b * c),
          d.set(d.subarray(f, f + (a - b) * c), f + c),
          d.set(e, f))
        : ((f = (a + 1) * c),
          d.set(d.subarray(f, f + (b - a) * c), f - c),
          d.set(e, b * c));
      this.dirty = true;
    }
  },
  removeQuadAtIndex: function (a) {
    ...
    if (a !== this._totalQuads) {
      ...
      this._quadsReader.set(
        this._quadsReader.subarray(c, c + (this._totalQuads - a) * b),
        c - b
      );
    }
    this.dirty = true;
  ...
  removeQuadsAtIndex: function (a, b) {
    ...
    if (a !== this._totalQuads) {
      var c = cc.V3F_C4B_T2F_Quad.BYTES_PER_ELEMENT,
        ...
        e = a * c;
      this._quadsReader.set(
        this._quadsReader.subarray(d, d + (this._totalQuads - a) * c),
        e
      );
    }
    this.dirty = true;
  ...
  resizeCapacity: function (a) {
    if (a === this._capacity) return true;
    var b = cc.V3F_C4B_T2F_Quad.BYTES_PER_ELEMENT,
      c = this._capacity;
    ...
    if (null === this._quads)
      ...
      if (d > c) {
        ...
        for (; a < d; a++)
          f[a] = new cc.V3F_C4B_T2F_Quad(null, null, null, null, g, a * b);
      } else
        for (
          e = Math.max(e, d), f = [], g = new ArrayBuffer(b * d), a = 0;
          a < e;
          a++
        )
          f[a] = new cc.V3F_C4B_T2F_Quad(
    ...
    null === this._indices
      ...
      : d > c
      ? ((b = new Uint16Array(6 * d)),
        b.set(this._indices, 0),
        (this._indices = b))
      : (this._indices = this._indices.subarray(0, 6 * d));
    this._setupIndices();
    this._mapBuffers();
    return (this.dirty = true);
  },
  ...
  moveQuadsFromIndex: function (a, b, c) {
    if (void 0 === c) {
      if (
        ...
        cc.assert(
          c + (this._totalQuads - a) <= this._capacity,
    ...
    var d = cc.V3F_C4B_T2F_Quad.BYTES_PER_ELEMENT,
      ...
      k = c * d;
    c < a
      ? ((b = c * d), g.set(g.subarray(b, b + (a - c) * d), b + f))
      : ((b = (a + b) * d), g.set(g.subarray(b, b + (c - a) * d), e));
    g.set(h, k);
    this.dirty = true;
  },
  fillWithEmptyQuadsFromIndex: function (a, b) {
    for (
      var c = b * cc.V3F_C4B_T2F_Quad.BYTES_PER_ELEMENT,
        d = new Uint8Array(
          this._quadsArrayBuffer,
...
cc.LoaderScene = cc.Scene.extend({
  ...
  init: function () {
    var a = 200,
      b = (this._bgLayer = new cc.LayerColor(cc.color(255, 255, 255, 255)));
    this.addChild(b, 0);
    var c = 42,
      d = -a / 2 + 100;
    cc._loaderImage &&
      (cc.loader.loadImg(
        ...
        function (b, c) {
          a = c.height;
          cc.p(cc.visibleRect.center.x, cc.visibleRect.center.y + 50);
        }
      ),
      (c = 42),
      (d = -60));
    c = this._label = new cc.LabelTTF("Loading... 0%", "Arial", c);
    c.setPosition(cc.pAdd(cc.visibleRect.center, cc.p(0, d + 20)));
    c.setColor(cc.color("#f99f0a"));
    b.addChild(this._label, 10);
    return true;
  },
  c: function (a) {
    a.color = cc.color("#000000");
  },
  ...
  _startLoading: function () {
    ...
    cc.loader.load(
      ...
      function () {
        a.cb &&
          ((document.getElementById(cc.game.config.id).style.backgroundColor =
            "black"),
          a.cb.call(a.target));
      }
    );
...
cc.LoaderScene.preload = function (a, b, c) {
  var d = cc;
  d.loaderScene ||
    ((d.loaderScene = new cc.LoaderScene()),
    d.loaderScene.init(),
...
(function () {
  ...
  a.updateStatus = function () {
    ...
    c & a.orderDirty &&
      ...
      (this._dirtyFlag = (c & a.orderDirty) ^ c));
  ...
  a._syncStatus = function (a) {
    ...
    d & c.orderDirty &&
      ((this._cacheDirty = true),
      0 === this._updateCache && (this._updateCache = 2),
      (this._dirtyFlag = (d & c.orderDirty) ^ d));
  ...
  a.bake = function () {
    if (!this._isBaked) {
      this._needDraw = true;
      this._isBaked = this._cacheDirty = cc.renderer.childrenOrderDirty = true;
      0 === this._updateCache && (this._updateCache = 2);
      for (var a = this._node._children, c = 0, d = a.length; c < d; c++)
        a[c]._renderCmd._setCachedParent(this);
      this._bakeSprite ||
  ...
  a.unbake = function () {
    if (this._isBaked) {
      cc.renderer.childrenOrderDirty = true;
      this._isBaked = this._needDraw = false;
      this._cacheDirty = true;
      0 === this._updateCache && (this._updateCache = 2);
      for (var a = this._node._children, c = 0, d = a.length; c < d; c++)
        a[c]._renderCmd._setCachedParent(null);
    }
  };
  a.isBaked = function () {
  ...
  a._getBoundingBoxForBake = function () {
    ...
    for (
      var d = c.getNodeToWorldTransform(), c = c._children, e = 0, f = c.length;
      e < f;
      e++
    ) {
      var g = c[e];
      g &&
        g._visible &&
        (a
          ? (g = g._getBoundingBoxToCurrentNode(d)) && (a = cc.rectUnion(a, g))
          : (a = g._getBoundingBoxToCurrentNode(d)));
    }
    return a;
  };
})();
(function () {
  ...
  a.rendering = function (a, c, d) {
    ...
    0 !== h &&
      ...
      a.setGlobalAlpha(h),
      a.setFillStyle(
        "rgba(" + (0 | g.r) + "," + (0 | g.g) + "," + (0 | g.b) + ", 1)"
      ),
      a.setTransform(this._worldTransform, c, d),
      e.fillRect(0, 0, k * c, -f * d),
      cc.g_NumberOfDraws++);
  };
    ...
    if (this._cacheDirty) {
      ...
      if (0 < this._updateCache) {
        ...
        if (0 < e) {
          ...
          for (cc.renderer.pushRenderCommand(this); a < e; a++)
            d[a]._renderCmd.visit(this);
  ...
  a._getBoundingBoxForBake = function () {
    ...
    for (var a = a._children, e = 0; e < a.length; e++) {
      ...
      f &&
        f._visible &&
        ((f = f._getBoundingBoxToCurrentNode(d)), (c = cc.rectUnion(c, f)));
    }
    return c;
  };
})();
(function () {
  ...
  a.rendering = function (a, c, d) {
    ...
    if (0 !== g) {
      ...
      g = e.createLinearGradient(
        this._startPoint.x * c,
        this._startPoint.y * d,
        this._endPoint.x * c,
        this._endPoint.y * d
      );
      if (f._colorStops)
        for (var m = 0; m < f._colorStops.length; m++)
          g.addColorStop(f._colorStops[m].p, this._colorStopsStr[m]);
      else
        g.addColorStop(0, this._startStopStr),
  ...
  a.updateStatus = function () {
    ...
    c & a.gradientDirty &&
      ...
      (this._dirtyFlag = (c & a.gradientDirty) ^ c));
    cc.Node.RenderCmd.prototype.updateStatus.call(this);
  };
  a._syncStatus = function (a) {
    var c = cc.Node._dirtyFlags,
      d = this._dirtyFlag;
    d & c.gradientDirty &&
      ((this._dirtyFlag |= c.colorDirty),
      (this._dirtyFlag = (d & c.gradientDirty) ^ d));
    cc.Node.RenderCmd.prototype._syncStatus.call(this, a);
  };
  a._updateColor = function () {
    var a = this._node,
    ...
    if (a._colorStops)
      for (
        this._endOpacity = this._startOpacity = 0,
          this._colorStopsStr = [],
          d = 0;
        d < a._colorStops.length;
        d++
      )
        (c = a._colorStops[d].color),
...
(function () {
  cc.LayerColor.WebGLRenderCmd = function (a) {
    ...
    var c = this._squareColorsAB,
      d = cc.Vertex3F.BYTES_PER_ELEMENT,
      e = cc.Color.BYTES_PER_ELEMENT;
    this._squareVertices = [
      new cc.Vertex3F(0, 0, 0, a, 0),
      new cc.Vertex3F(0, 0, 0, a, d),
      new cc.Vertex3F(0, 0, 0, a, 2 * d),
      new cc.Vertex3F(0, 0, 0, a, 3 * d),
    ];
    this._squareColors = [
      cc.color(0, 0, 0, 255, c, 0),
      cc.color(0, 0, 0, 255, c, e),
      cc.color(0, 0, 0, 255, c, 2 * e),
      cc.color(0, 0, 0, 255, c, 3 * e),
    ];
  ...
  a.rendering = function (a) {
    ...
    a.vertexAttribPointer(cc.VERTEX_ATTRIB_POSITION, 3, a.FLOAT, false, 0, 0);
  ...
  a.transform = function (a, c) {
    ...
    var d = this._node,
      ...
      g = this._squareVertices;
    g[1].x = e;
    g[2].y = f;
    g[3].x = e;
    g[3].y = f;
    g[0].z = g[1].z = g[2].z = g[3].z = d._vertexZ;
  ...
  a._updateColor = function () {
    for (
      ...
      (d[e].r = a.r), (d[e].g = a.g), (d[e].b = a.b), (d[e].a = c);
    this._bindLayerColorsBufferData();
  };
  a._bindLayerVerticesBufferData = function () {
    var a = cc._renderContext;
    a.bindBuffer(a.ARRAY_BUFFER, this._verticesFloat32Buffer);
    a.bufferData(a.ARRAY_BUFFER, this._squareVerticesAB, a.DYNAMIC_DRAW);
  };
  ...
  a._updateVertex = function () {
    ...
    if (c && !(2 > c.length)) {
      ...
      var d = c.length,
        ...
        f,
        g = a._contentSize,
        h = this._squareVertices;
      if (h.length < e) {
        this._squareVerticesAB = new ArrayBuffer(12 * e);
        h.length = 0;
        var k = this._squareVerticesAB,
          m = cc.Vertex3F.BYTES_PER_ELEMENT;
        for (f = 0; f < e; f++) h.push(new cc.Vertex3F(0, 0, 0, k, m * f));
      }
      var n = Math.PI + cc.pAngleSigned(cc.p(0, -1), a._alongVector),
        e = cc.p(g.width / 2, g.height / 2);
      f = Math.round(cc.radiansToDegrees(n));
      var k = cc.affineTransformMake(1, 0, 0, 1, e.x, e.y),
        k = cc.affineTransformRotate(k, n),
        p;
      90 > f
        ? ((p = cc.p(-e.x, e.y)), (f = cc.p(e.x, e.y)))
        : 180 > f
        ? ((p = cc.p(e.x, e.y)), (f = cc.p(e.x, -e.y)))
        : 270 > f
        ? ((p = cc.p(e.x, -e.y)), (f = cc.p(-e.x, -e.y)))
      ...
      m = Math.sin(n);
      n = Math.cos(n);
      p = Math.abs((p.x * n - p.y * m) / e.x);
      f = Math.abs((f.x * m + f.y * n) / e.y);
      k = cc.affineTransformScale(k, p, f);
      for (f = 0; f < d; f++)
        (m = c[f].p * g.height),
          (n = cc.pointApplyAffineTransform(-e.x, m - e.y, k)),
          (h[2 * f].x = n.x),
          (h[2 * f].y = n.y),
          (h[2 * f].z = a._vertexZ),
          (m = cc.pointApplyAffineTransform(g.width - e.x, m - e.y, k)),
          (h[2 * f + 1].x = m.x),
          (h[2 * f + 1].y = m.y),
          (h[2 * f + 1].z = a._vertexZ);
      this._bindLayerVerticesBufferData();
    }
  };
  a._updateColor = function () {
    ...
    if (a && !(2 > a.length)) {
      ...
      if (d.length < e) {
        ...
        d.length = 0;
        var f = this._squareColorsAB,
          g = cc.Color.BYTES_PER_ELEMENT;
        for (i = 0; i < e; i++) d.push(cc.color(0, 0, 0, 255, f, g * i));
      }
...
cc.Sprite = cc.Node.extend({
  ...
  initWithSpriteFrame: function (a) {
    ...
    a.textureLoaded() ||
      ...
      a.addEventListener(
        "load",
        this._renderCmd._spriteFrameLoadedCallback,
        this
      ));
    var b = cc._renderType === cc.game.RENDER_TYPE_CANVAS ? false : a._rotated,
  ...
  reorderChild: function (a, b) {
    ...
    -1 === this._children.indexOf(a)
      ...
      : b !== a.zIndex &&
        ...
        cc.Node.prototype.reorderChild.call(this, a, b));
  },
  removeChild: function (a, b) {
  ...
  ignoreAnchorPointForPosition: function (a) {
    this._batchNode
      ...
      : cc.Node.prototype.ignoreAnchorPointForPosition.call(this, a);
  },
  ...
  setDisplayFrameWithAnimationName: function (a, b) {
    ...
    c
      ? (c = c.getFrames()[b])
        ? this.setSpriteFrame(c.getSpriteFrame())
  ...
  _setReorderChildDirtyRecursively: function () {
    if (!this._reorderChildDirty) {
      ...
      for (var a = this._parent; a && a !== this._batchNode; )
        a._setReorderChildDirtyRecursively(), (a = a.parent);
    }
  },
  getTexture: function () {
    return this._texture;
  ...
  initWithFile: function (a, b) {
    ...
    return this.initWithTexture(
      c,
      b || cc.rect(0, 0, c._contentSize.width, c._contentSize.height)
    );
  },
  initWithTexture: function (a, b, c, d) {
    cc.assert(
    ...
    if (!cc.Node.prototype.init.call(this)) return false;
    ...
    if (!e)
      return (
        ...
        a.addEventListener(
          "load",
          this._renderCmd._textureLoadedCallback,
          this
        ),
        this.setTexture(a),
        true
  ...
  setSpriteFrame: function (a) {
    ...
    c = a.getTexture();
    a.textureLoaded()
      ? ((b._textureLoaded = true),
        c !== b._texture && (b._setTexture(c), b.setColor(b._realColor)),
        b.setTextureRect(a.getRect(), a.isRotated(), a.getOriginalSize()))
      : ((b._textureLoaded = false),
        a.addEventListener(
          "load",
          function (a) {
            b._textureLoaded = true;
            var c = a.getTexture();
            c !== b._texture && b._setTexture(c);
            b.setTextureRect(a.getRect(), a.isRotated(), a.getOriginalSize());
  ...
  setBatchNode: function (a) {
    (this._batchNode = a)
      ? ((this._transformToBatch = cc.affineTransformIdentity()),
        (this.textureAtlas = this._batchNode.getTextureAtlas()))
...
(function () {
  ...
  a._setTexture = function (a) {
    var c = this._node;
    c._texture !== a &&
      ((c._textureLoaded = a ? a._textureLoaded : false),
      (c._texture = a),
      this._updateColor());
  };
  ...
  a.isFrameDisplayed = function (a) {
    var c = this._node;
    return a.getTexture() !== c._texture
      ? false
      : cc.rectEqualToRect(a.getRect(), c._rect);
  };
  a.updateBlendFunc = function (a) {
    this._blendFuncStr = cc.Node.CanvasRenderCmd._getCompositeOperationByBlendFunc(
      a
  ...
  a._handleTextureForRotatedTexture = function (a, c, d, e) {
    d &&
      ...
      (a = cc.Sprite.CanvasRenderCmd._cutRotateImageToCanvas(a, c, e)),
      (e = new cc.Texture2D()),
      e.initWithElement(a),
      e.handleLoadedTexture(),
      (a = e),
      (c.x = c.y = 0),
      (this._node._rect = cc.rect(0, 0, c.width, c.height)));
    return a;
  };
  a._checkTextureBoundary = function (a, c, d) {
    a &&
      a.url &&
      ((d = c.y + c.height),
      c.x + c.width > a.width && cc.error(cc._LogInfos.RectWidth, a.url),
  ...
  a.rendering = function (a, c, d) {
    ...
    if (
      (!h || (0 !== f.width && 0 !== f.height && h._textureLoaded)) &&
      0 !== g
    ) {
      a = a || cc._renderContext;
      var k = a.getContext(),
      ...
      h && h._htmlElementObj
        ? ((c = h._htmlElementObj),
          "" !== h._pattern
            ? (a.setFillStyle(k.createPattern(c, h._pattern)),
              k.fillRect(m, s, p, n))
            : k.drawImage(c, g, r, u, t, m, s, p, n))
        : ((h = e._contentSize),
          f.validRect &&
            ((f = this._displayedColor),
            a.setFillStyle("rgba(" + f.r + "," + f.g + "," + f.b + ",1)"),
            k.fillRect(m, s, h.width * c, h.height * d)));
  ...
  a._updateColor = function () {
    var a = this._node._texture,
      ...
      d = this._displayedColor;
    a &&
      (255 !== d.r || 255 !== d.g || 255 !== d.b
        ? ((this._textureToRender = a._generateColorTexture(d.r, d.g, d.b, c)),
          (this._colorized = true))
        : a && ((this._textureToRender = a), (this._colorized = false)));
  };
  ...
  a._textureLoadedCallback = function (a) {
    if (!this._textureLoaded) {
      ...
      var c = this._rect,
        d = this._renderCmd;
      c
        ? cc._rectEqualToZero(c) && ((c.width = a.width), (c.height = a.height))
        : (c = cc.rect(0, 0, a.width, a.height));
      this.texture = a;
...
(function () {
  cc.Sprite.WebGLRenderCmd = function (a) {
    ...
    this._recursiveDirty = this._dirty = false;
    this._shaderProgram = cc.shaderCache.programForKey(
      cc.SHADER_SPRITE_POSITION_TEXTURECOLORALPHATEST
    );
  };
  ...
  a.setDirtyRecursively = function (a) {
    ...
    for (
      var c = this._node._children, d, e = c ? c.length : 0, f = 0;
      f < e;
      f++
    )
      (d = c[f]), d instanceof cc.Sprite && d._renderCmd.setDirtyRecursively(a);
  };
  a._setBatchNodeForAddChild = function (a) {
    var c = this._node;
    if (c._batchNode) {
      if (!(a instanceof cc.Sprite))
        return cc.log(cc._LogInfos.Sprite_addChild), false;
      a.texture._webTextureObj !== c.textureAtlas.texture._webTextureObj &&
  ...
  a.isFrameDisplayed = function (a) {
    ...
    return (
      cc.rectEqualToRect(a.getRect(), c._rect) &&
      a.getTexture().getName() === c._texture.getName() &&
      cc.pointEqualToPoint(a.getOffset(), c._unflippedOffsetPositionFromCenter)
    );
  };
      ...
      d._rectRotated
        ? (cc.FIX_ARTIFACTS_BY_STRECHING_TEXEL
            ...
            : ((e = a.x / g),
              ...
              (k = a.y / h),
              (h = (a.y + a.width) / h)),
          d._flippedX && ((m = k), (k = h), (h = m)),
          d._flippedY && ((m = e), (e = g), (g = m)),
          (f[0].u = g),
          (f[0].v = k),
          (f[1].u = e),
          (f[1].v = k),
        ...
        : (cc.FIX_ARTIFACTS_BY_STRECHING_TEXEL
            ? ((e = (2 * a.x + 1) / (2 * g)),
              (g = e + (2 * a.width - 2) / (2 * g)),
              (k = (2 * a.y + 1) / (2 * h)),
              (h = k + (2 * a.height - 2) / (2 * h)))
            : ((e = a.x / g),
              (g = (a.x + a.width) / g),
              (k = a.y / h),
              (h = (a.y + a.height) / h)),
          d._flippedX && ((m = e), (e = g), (g = m)),
          d._flippedY && ((m = k), (k = h), (h = m)),
          (f[0].u = e),
          (f[0].v = k),
          (f[1].u = e),
          (f[1].v = h),
  ...
  a._updateBlendFunc = function () {
    if (this._batchNode) cc.log(cc._LogInfos.Sprite__updateBlendFunc);
      ...
      a._texture && a._texture.hasPremultipliedAlpha()
        ? (c.src === cc.SRC_ALPHA && c.dst === cc.BLEND_DST && (c.src = cc.ONE),
          (a.opacityModifyRGB = true))
        : (c.src === cc.ONE && c.dst === cc.BLEND_DST && (c.src = cc.SRC_ALPHA),
          (a.opacityModifyRGB = false));
    }
  };
  a._setTexture = function (a) {
    var c = this._node;
    c._batchNode
      ? c._batchNode.texture !== a && cc.log(cc._LogInfos.Sprite_setTexture)
      : c._texture !== a &&
        ((c._textureLoaded = a ? a._textureLoaded : false),
        (c._texture = a),
        this._updateBlendFunc(),
        c._textureLoaded && (cc.renderer.childrenOrderDirty = true));
  };
  a._checkTextureBoundary = function (a, c, d) {
    a &&
      a.url &&
      (d
        ? ((d = c.x + c.height), (c = c.y + c.width))
        : ((d = c.x + c.width), (c = c.y + c.height)),
      d > a.width && cc.error(cc._LogInfos.RectWidth, a.url),
      c > a.height && cc.error(cc._LogInfos.RectHeight, a.url));
  };
  a.transform = function (a, c) {
    this.originTransform(a, c);
    var d = this._node,
      ...
      k = this._vertices;
    k[0].x = e * h.a + d * h.c + h.tx;
    k[0].y = e * h.b + d * h.d + h.ty;
    k[1].x = e * h.a + g * h.c + h.tx;
    k[1].y = e * h.b + g * h.d + h.ty;
    k[2].x = f * h.a + d * h.c + h.tx;
    k[2].y = f * h.b + d * h.d + h.ty;
    k[3].x = f * h.a + g * h.c + h.tx;
    k[3].y = f * h.b + g * h.d + h.ty;
  };
  a.needDraw = function () {
    var a = this._node._texture;
...
cc.SpriteBatchNode = cc.Node.extend({
  ...
  updateQuadFromSprite: function (a, b) {
    ...
    a instanceof cc.Sprite
      ? ((a.dirty = true), a._renderCmd.transform(this._renderCmd, true))
  ...
  setTexture: function (a) {
    ...
    if (a._textureLoaded) {
      var b = this._children,
        c,
        d = b.length;
      for (c = 0; c < d; ++c) b[c].setTexture(a);
    } else
      a.addEventListener(
        "load",
        function () {
  ...
  setShaderProgram: function (a) {
    ...
    var b = this._children,
      c,
      d = b.length;
    for (c = 0; c < d; ++c) b[c].setShaderProgram(a);
  },
  addChild: function (a, b, c) {
  ...
  _isValidChild: function (a) {
    return a instanceof cc.Sprite
      ? a.texture !== this._texture
        ? (cc.log(cc._LogInfos.Sprite_addChild_5), false)
        : true
      : (cc.log(cc._LogInfos.Sprite_addChild_4), false);
  },
});
...
cc.BakeSprite = cc.Sprite.extend({
  ...
  resetCanvasSize: function (a, b) {
    ...
    this.setTextureRect(cc.rect(0, 0, a, b), false, null, false);
  },
});
...
cc.Animation = cc.Class.extend({
  ...
  ctor: function (a, b, c) {
    ...
    if (void 0 === a) this.initWithSpriteFrames(null, 0);
      ...
      var d = a[0];
      d &&
        (d instanceof cc.SpriteFrame
          ? this.initWithSpriteFrames(a, b, c)
          : d instanceof cc.AnimationFrame &&
            this.initWithAnimationFrames(a, b, c));
    }
  },
  getFrames: function () {
    return this._frames;
...
cc.animationCache = {
  ...
  _addAnimationsWithDictionary: function (a, b) {
    ...
    if (c) {
      ...
      if (e)
        for (
          var d = null != e.format ? parseInt(e.format) : d,
            e = e.spritesheets,
            f = cc.spriteFrameCache,
            g = cc.path,
            h = 0;
          h < e.length;
          h++
        )
          f.addSpriteFrames(g.changeBasename(b, e[h]));
      switch (d) {
        case 1:
  ...
  _parseVersion1: function (a) {
    ...
    for (c in a) {
      ...
      if (e) {
        ...
        0 === f.length
          ? cc.log(cc._LogInfos.animationCache__parseVersion1_3, c)
          : (f.length !== e.length &&
              cc.log(cc._LogInfos.animationCache__parseVersion1_4, c),
            (f = new cc.Animation(f, d, 1)),
            cc.animationCache.addAnimation(f, c));
  ...
  _parseVersion2: function (a) {
    ...
    for (c in a) {
      var d = a[c],
        ...
        f =
          d.restoreOriginalFrame && true == d.restoreOriginalFrame
            ? true
            : false,
        g = d.frames;
      if (g) {
...
cc.SpriteFrame = cc.Class.extend({
  ...
  ctor: function (a, b, c, d, e) {
    ...
    void 0 !== a &&
      void 0 !== b &&
      (void 0 === c || void 0 === d || void 0 === e
        ? this.initWithTexture(a, b)
        : this.initWithTexture(a, b, c, d, e));
  },
  textureLoaded: function () {
    return this._textureLoaded;
  },
  ...
  initWithTexture: function (a, b, c, d, e) {
    ...
    if (a && a.url && a.isLoaded()) {
      var f, g;
      c
        ? ((f = b.x + b.height), (g = b.y + b.width))
        : ((f = b.x + b.width), (g = b.y + b.height));
...
cc.spriteFrameCache = {
  ...
  _parseFrameConfig: function (a) {
    ...
    c &&
      ((e = c.format),
      (e = 1 >= e.length ? parseInt(e) : e),
      (d.image = c.textureFileName || c.textureFileName || c.image));
    for (var f in b) {
      var g = b[f];
      if (g) {
        c = {};
        if (0 == e) {
          ...
          (c.rect = this._rectFromString(g.frame)),
            (c.rotated = g.rotated || false),
          ...
          c.rect = k;
          c.rotated = g.textureRotated || false;
  ...
  _addSpriteFramesByObject: function (a, b, c) {
    ...
    b &&
      ...
      this._createSpriteFrames(a, b, c));
  },
  _createSpriteFrames: function (a, b, c) {
    ...
    c
      ...
      : ((c = cc.path.changeBasename(a, b.image || ".png")),
        (c = cc.textureCache.addImage(c)));
    ...
    for (var e in d) {
      ...
      if (!g) {
        ...
        cc._renderType === cc.game.RENDER_TYPE_CANVAS &&
          g.isRotated() &&
          g.getTexture().isLoaded() &&
          ((f = g.getTexture().getHtmlElementObj()),
          (f = cc.Sprite.CanvasRenderCmd._cutRotateImageToCanvas(
            f,
            g.getRectInPixels()
          )),
          (h = new cc.Texture2D()),
          h.initWithElement(f),
          h.handleLoadedTexture(),
          g.setTexture(h),
          (f = g._rect),
          g.setRect(cc.rect(0, 0, f.width, f.height)));
        b[e] = g;
      }
    }
  },
  addSpriteFrames: function (a, b) {
    ...
    c &&
      c.frames &&
      ((c = this._frameConfigCache[a] || this._getFrameConfig(a)),
...
cc.configuration = {
  ...
  _init: function () {
    ...
    a["cocos2d.x.compiled_with_profiler"] = false;
  ...
  gatherGPUInfo: function () {
    if (cc._renderType !== cc.game.RENDER_TYPE_CANVAS) {
      ...
      this._GlExtensions = "";
      for (var c = a.getSupportedExtensions(), d = 0; d < c.length; d++)
        this._GlExtensions += c[d] + " ";
...
cc.Director = cc.Class.extend({
  ...
  init: function () {
    ...
    this._purgeDirectorInNextLoop = this._paused = false;
  ...
  calculateDeltaTime: function () {
    ...
    this._nextDeltaTimeZero
      ? ((this._deltaTime = 0), (this._nextDeltaTimeZero = false))
  ...
  convertToUI: function (a) {
    ...
    c._isRotated
      ? ((b.x = d.left + a.y / c._devicePixelRatio),
        (b.y =
          d.top +
          d.height -
          (c._viewPortRect.width - a.x) / c._devicePixelRatio))
      : ((b.x = d.left + a.x / c._devicePixelRatio),
        (b.y = d.top + d.height - a.y / c._devicePixelRatio));
    return b;
  },
  drawScene: function () {
    var a = cc.renderer;
    ...
    this._runningScene &&
      (true === a.childrenOrderDirty
        ? (cc.renderer.clearRenderCommands(),
          (cc.renderer.assignedZ = 0),
          (this._runningScene._renderCmd._curLevel = 0),
          this._runningScene.visit(),
          a.resetFlag())
        : true === a.transformDirty() && a.transform());
    a.clear();
  ...
  runScene: function (a) {
    ...
    if (this._runningScene) {
      ...
      0 === b
        ? ((this._sendCleanupToScene = true), (this._scenesStack[b] = a))
        : ((this._sendCleanupToScene = true), (this._scenesStack[b - 1] = a));
      this._nextScene = a;
...
cc.DisplayLinkDirector = cc.Director.extend({
  ...
  mainLoop: function () {
    this._purgeDirectorInNextLoop
      ? ((this._purgeDirectorInNextLoop = false), this.purgeDirector())
...
cc.game.addEventListener(cc.game.EVENT_RENDERER_INITED, function () {
  if (cc._renderType === cc.game.RENDER_TYPE_WEBGL) {
    ...
    cc.eventManager.addCustomListener(
      cc.Director.EVENT_PROJECTION_CHANGED,
      function () {
        for (var a = cc.director._scenesStack, d = 0; d < a.length; d++)
          b(a[d]);
      }
    );
    a.setProjection = function (a) {
      ...
      switch (a) {
        ...
        case cc.Director.PROJECTION_3D:
          ...
          cc.kmGLMatrixMode(cc.KM_GL_PROJECTION);
          cc.kmGLLoadIdentity();
          k = cc.math.Matrix4.createPerspectiveProjection(
            60,
            b.width / b.height,
            0.1,
            2 * h
...
cc.Timer = cc.Class.extend({
  ...
  ctor: function () {
    ...
    this._elapsed = -1;
    this._useDelay = this._runForever = false;
...
cc.Scheduler = cc.Class.extend({
  ...
  ctor: function () {
    ...
    this._updateHashLocked = this._currentTargetSalvaged = false;
  ...
  _schedulePerFrame: function (a, b, c, d) {
    ...
    0 === c
      ? this._appendIn(this._updates0List, a, b, d)
      : 0 > c
      ? this._priorityIn(this._updatesNegList, a, b, c, d)
  ...
  _removeUpdateFromHash: function (a) {
    if ((a = this._hashForUpdates[a.target.__instanceId]))
  ...
  _priorityIn: function (a, b, c, d, e) {
    b = new cc.ListEntry(null, null, b, c, d, e, false);
    if (a) {
      e = a.length - 1;
      for (var f = 0; f <= e && !(d < a[f].priority); f++);
      a.splice(f, 0, b);
    } else (a = []), a.push(b);
    this._hashForUpdates[c.__instanceId] = new cc.HashUpdateEntry(
      a,
      b,
      c,
      null
  ...
  _appendIn: function (a, b, c, d) {
    b = new cc.ListEntry(null, null, b, c, 0, d, false);
    a.push(b);
    this._hashForUpdates[c.__instanceId] = new cc.HashUpdateEntry(
      a,
      b,
  ...
  update: function (a) {
    ...
    for (d = c.length; b < d; b++)
      (e = c[b]), e.paused || e.markedForDeletion || e.callback(a);
    b = 0;
    ...
    for (b = 0; b < d.length; b++) {
      ...
      if (!c.paused)
        for (c.timerIndex = 0; c.timerIndex < c.timers.length; ++c.timerIndex)
          (c.currentTimer = c.timers[c.timerIndex]),
            (c.currentTimerSalvaged = false),
    ...
    b = 0;
    for (c = this._updatesNegList; b < c.length; )
      (e = c[b]), e.markedForDeletion ? this._removeUpdateFromHash(e) : b++;
    b = 0;
    for (c = this._updates0List; b < c.length; )
      (e = c[b]), e.markedForDeletion ? this._removeUpdateFromHash(e) : b++;
    b = 0;
    for (c = this._updatesPosList; b < c.length; )
      (e = c[b]), e.markedForDeletion ? this._removeUpdateFromHash(e) : b++;
  ...
  schedule: function (a, b, c, d, e, f, g) {
    ...
    if (false === h) {
      if (4 === arguments.length || 5 === arguments.length)
        (g = e), (f = d), (e = 0), (d = cc.REPEAT_FOREVER);
    } else
      4 === arguments.length && ((f = d), (d = cc.REPEAT_FOREVER), (e = 0));
    ...
    m
      ? cc.assert(m.paused === f, "")
      : ((m = new cc.HashTimerEntry(null, b, 0, null, null, f, null)),
        this._arrayForTimers.push(m),
        (this._hashForTimers[b.__instanceId] = m));
    var n, p;
    ...
    false === h
      ? ((n = new cc.TimerTargetCallback()),
        n.initWithCallback(this, a, b, g, c, d, e))
      : ((n = new cc.TimerTargetSelector()),
        n.initWithSelector(this, k, b, c, d, e));
    m.timers.push(n);
  },
  ...
  unscheduleUpdate: function (a) {
    null != a &&
      ...
      (this._updateHashLocked
        ? (a.entry.markedForDeletion = true)
  ...
  unscheduleAllForTarget: function (a) {
    if (null != a) {
      ...
      b &&
        (-1 < b.timers.indexOf(b.currentTimer) &&
          !b.currentTimerSalvaged &&
          (b.currentTimerSalvaged = true),
        (b.timers.length = 0),
  ...
  pauseAllTargetsWithMinPriority: function (a) {
    ...
    for (f = d.length; e < f; e++)
      if ((c = d[e])) (c.paused = true), b.push(c.target);
    if (0 > a)
      for (e = 0; e < this._updatesNegList.length; e++)
        (c = this._updatesNegList[e]) &&
          c.priority >= a &&
          ((c.paused = true), b.push(c.target));
    if (0 >= a)
      for (e = 0; e < this._updates0List.length; e++)
        if ((c = this._updates0List[e])) (c.paused = true), b.push(c.target);
    for (e = 0; e < this._updatesPosList.length; e++)
      (c = this._updatesPosList[e]) &&
        c.priority >= a &&
        ((c.paused = true), b.push(c.target));
    return b;
  },
  ...
  pauseTarget: function (a) {
    ...
    var b = this._hashForTimers[a.__instanceId];
    b && (b.paused = true);
    if ((a = this._hashForUpdates[a.__instanceId])) a.entry.paused = true;
  },
  resumeTarget: function (a) {
    cc.assert(a, cc._LogInfos.Scheduler_resumeTarget);
    var b = this._hashForTimers[a.__instanceId];
    b && (b.paused = false);
    if ((a = this._hashForUpdates[a.__instanceId])) a.entry.paused = false;
  },
...
cc.DrawingPrimitiveCanvas = cc.Class.extend({
  ...
  drawPoint: function (a, b) {
    ...
    e.beginPath();
    e.arc(d.x, -d.y, b * c, 0, 2 * Math.PI, false);
    e.closePath();
    e.fill();
  },
  drawPoints: function (a, b, c) {
    if (null != a) {
      ...
      for (var f = 0, g = a.length; f < g; f++)
        b.arc(a[f].x * d, -a[f].y * e, c * d, 0, 2 * Math.PI, false);
      b.closePath();
      b.fill();
    }
  },
  ...
  drawPoly: function (a, b, c, d) {
    ...
    if (null != a) {
      ...
      for (var e = 1, h = a.length; e < h; e++)
        b.lineTo(a[e].x * f, -a[e].y * g);
      c && b.closePath();
      d ? b.fill() : b.stroke();
    }
  },
  ...
  drawCircle: function (a, b, c, d, e) {
    ...
    var f = cc.view.getScaleX(),
      g = cc.view.getScaleY();
    d.beginPath();
    d.arc(0 | (a.x * f), 0 | -(a.y * g), b * f, -c, -(c - 2 * Math.PI), false);
  ...
  drawQuadBezier: function (a, b, c, d) {
    ...
    e.push(cc.p(c.x, c.y));
    this.drawPoly(e, d + 1, false, false);
  },
  drawCubicBezier: function (a, b, c, d, e) {
    ...
    f.push(cc.p(d.x, d.y));
    this.drawPoly(f, e + 1, false, false);
  },
  ...
  drawCardinalSpline: function (a, b, c) {
    ...
    d.length = 0;
    for (var e, f, g = 1 / a.length, h = 0; h < c + 1; h++)
      (f = h / c),
        1 === f
          ? ((e = a.length - 1), (f = 1))
          : ((e = 0 | (f / g)), (f = (f - g * e) / g)),
        (e = cc.CardinalSplineAt(
          cc.getControlPointAt(a, e - 1),
          cc.getControlPointAt(a, e - 0),
          cc.getControlPointAt(a, e + 1),
          cc.getControlPointAt(a, e + 2),
          b,
          f
        )),
        d.push(e);
    this.drawPoly(d, c + 1, false, false);
  },
...
cc.DrawingPrimitiveWebGL = cc.Class.extend({
  ...
  drawPoint: function (a) {
    ...
    b.vertexAttribPointer(cc.VERTEX_ATTRIB_POSITION, 2, b.FLOAT, false, 0, 0);
  ...
  drawPoints: function (a, b) {
    if (a && 0 !== a.length) {
      ...
      c.vertexAttribPointer(cc.VERTEX_ATTRIB_POSITION, 2, c.FLOAT, false, 0, 0);
  ...
  _pointsToTypeArray: function (a) {
    for (var b = new Float32Array(2 * a.length), c = 0; c < a.length; c++)
      (b[2 * c] = a[c].x), (b[2 * c + 1] = a[c].y);
    return b;
  },
  drawLine: function (a, b) {
    this.lazy_init();
  ...
  drawCircle: function (a, b, c, d, e) {
    ...
    if ((e = new Float32Array(2 * (d + 2)))) {
      ...
      a.vertexAttribPointer(cc.VERTEX_ATTRIB_POSITION, 2, a.FLOAT, false, 0, 0);
  ...
  drawQuadBezier: function (a, b, c, d) {
    this.lazy_init();
    for (var e = new Float32Array(2 * (d + 1)), f = 0, g = 0; g < d; g++)
      (e[2 * g] =
        Math.pow(1 - f, 2) * a.x + 2 * (1 - f) * f * b.x + f * f * c.x),
        (e[2 * g + 1] =
          Math.pow(1 - f, 2) * a.y + 2 * (1 - f) * f * b.y + f * f * c.y),
        (f += 1 / d);
    e[2 * d] = c.x;
    e[2 * d + 1] = c.y;
    a = this._renderContext;
  ...
  drawCardinalSpline: function (a, b, c) {
    this.lazy_init();
    for (
      var d = new Float32Array(2 * (c + 1)), e, f, g = 1 / a.length, h = 0;
      h < c + 1;
      h++
    )
      (f = h / c),
...
cc.LabelTTF = cc.Sprite.extend({
  ...
  ctor: function (a, b, c, d, e, f) {
    ...
    b && b instanceof cc.FontDefinition
      ...
      : cc.LabelTTF.prototype.initWithString.call(this, a, b, c, d, e, f);
  },
  init: function () {
  ...
  initWithStringAndTextDefinition: function (a, b) {
    this._updateWithTextDefinition(b, false);
    this.string = a;
    return true;
  },
  setTextDefinition: function (a) {
    a && this._updateWithTextDefinition(a, true);
  },
  ...
  _enableShadowNoneColor: function (a, b, c, d) {
    c = c || 0.5;
    false === this._shadowEnabled && (this._shadowEnabled = true);
  ...
  disableShadow: function () {
    this._shadowEnabled &&
      ((this._shadowEnabled = false), this._setUpdateTextureDirty());
  },
  enableStroke: function (a, b) {
    false === this._strokeEnabled && (this._strokeEnabled = true);
    var c = this._strokeColor;
    if (c.r !== a.r || c.g !== a.g || c.b !== a.b)
      (c.r = a.r), (c.g = a.g), (c.b = a.b), this._renderCmd._setColorsString();
  ...
  disableStroke: function () {
    this._strokeEnabled &&
      ((this._strokeEnabled = false), this._setUpdateTextureDirty());
  },
  ...
  _prepareTextDefinition: function (a) {
    ...
    } else b.strokeEnabled = false;
    this._shadowEnabled
      ? ((b.shadowEnabled = true),
  ...
  setScale: function (a, b) {
    ...
    this._scaleY = (b || 0 === b ? b : a) / cc.view.getDevicePixelRatio();
    this._renderCmd.setDirtyFlag(cc.Node._dirtyFlags.transformDirty);
  },
  getScaleX: function () {
    return this._scaleX * cc.view.getDevicePixelRatio();
  ...
  setDimensions: function (a, b) {
    ...
    if (c !== this._dimensions.width || b !== this._dimensions.height)
      (this._dimensions.width = c),
  ...
  setTextureRect: function (a, b, c) {
    cc.Sprite.prototype.setTextureRect.call(this, a, b, c, false);
  },
...
(function () {
  ...
  a._setFontStyle = function (a, c, d, e) {
    if (a instanceof cc.FontDefinition)
      ...
      var f = c * cc.view.getDevicePixelRatio();
      this._fontStyleStr = d + " " + e + " " + f + "px '" + a + "'";
      this._fontClientHeight = cc.LabelTTF.__getFontHeightByDiv(a, c);
    }
  };
  ...
  a._updateTTF = function () {
    ...
    if (0 !== d)
      ...
      for (
        this._strings = a._string.split("\n"), e = 0, f = this._strings.length;
        e < f;
        e++
      )
        g.push(this._measure(this._strings[e]));
    1 < this._strings.length && (this._isMultiLine = true);
    f = e = 0;
    ...
    d =
      0 === d
        ? this._isMultiLine
          ? cc.size(
              Math.ceil(Math.max.apply(Math, g) + e),
              Math.ceil(this._fontClientHeight * c * this._strings.length + f)
            )
          : cc.size(
              Math.ceil(this._measure(a._string) + e),
              Math.ceil(this._fontClientHeight * c + f)
            )
        : 0 === a._dimensions.height
        ? this._isMultiLine
          ? cc.size(
              Math.ceil(d + e),
              Math.ceil(a.getLineHeight() * c * this._strings.length + f)
            )
          : cc.size(Math.ceil(d + e), Math.ceil(a.getLineHeight() * c + f))
        : cc.size(Math.ceil(d + e), Math.ceil(a._dimensions.height * c + f));
    "normal" !== a._getFontStyle() &&
      (d.width = Math.ceil(d.width + 0.3 * a._fontSize));
    0 === this._strings.length
      ? ((this._texRect.width = 1), (this._texRect.height = d.height || 1))
      : ((this._texRect.width = d.width), (this._texRect.height = d.height));
    a.setContentSize(d.width / c, d.height / c);
  ...
  a._saveStatus = function () {
    var a = this._node,
      c = cc.view.getDevicePixelRatio(),
      d = a._strokeShadowOffsetX,
      e = a._strokeShadowOffsetY,
      f = a._contentSize.height * c - e,
      g = a._vAlignment,
      h = a._hAlignment,
      k = 0.5 * d,
      e = f + 0.5 * e,
      ...
      n = 0,
      p = [],
      d = a._contentSize.width * c - d,
      a = a.getLineHeight() * c,
      c = (a - this._fontClientHeight * c) / 2,
      m =
        h === cc.TEXT_ALIGNMENT_RIGHT
          ? m + d
          : h === cc.TEXT_ALIGNMENT_CENTER
          ? m + d / 2
          : m + 0;
    if (this._isMultiLine)
      for (
        h = this._strings.length,
          g === cc.VERTICAL_TEXT_ALIGNMENT_BOTTOM
            ? (n = a - 2 * c + f - a * h)
            : g === cc.VERTICAL_TEXT_ALIGNMENT_CENTER &&
              (n = (a - 2 * c) / 2 + (f - a * h) / 2),
          g = 0;
        g < h;
        g++
      ...
      g !== cc.VERTICAL_TEXT_ALIGNMENT_BOTTOM &&
        (n = g === cc.VERTICAL_TEXT_ALIGNMENT_TOP ? n - f : n - 0.5 * f),
        p.push(n);
    f = {
      contextTransform: cc.p(k, e),
      xOffset: m,
      OffsetYArray: p,
    };
    this._status.push(f);
  ...
  a._checkWarp = function (a, c, d) {
    ...
    if (f > d && 1 < e.length) {
      for (
        ...
        (g *= d / k), (g |= 0), (h = e.substr(g)), (k = f - this._measure(h));
      for (p = 0; k < d && 100 > p++; )
        h &&
          ((n = (m = cc.LabelTTF._wordRex.exec(h)) ? m[0].length : 1), (m = h)),
          (g += n),
          (h = e.substr(g)),
          (k = f - this._measure(h));
      g -= n;
      ...
      cc.LabelTTF.wrapInspection &&
        cc.LabelTTF._symbolRex.test(m || h) &&
        ((f = cc.LabelTTF._lastWordRex.exec(d)),
        (g -= f ? f[0].length : 0),
        0 === g && (g = 1),
        (m = e.substr(g)),
        (d = e.substr(0, g)));
      cc.LabelTTF._firsrEnglish.test(m) &&
        (f = cc.LabelTTF._lastEnglish.exec(d)) &&
        d !== f[0] &&
        ((g -= f[0].length), (m = e.substr(g)), (d = e.substr(0, g)));
      a[c] = m || h;
      a.splice(c, 0, d);
    }
  };
  a.updateStatus = function () {
    var a = cc.Node._dirtyFlags;
    this._dirtyFlag & a.textDirty && this._updateTexture();
    cc.Node.RenderCmd.prototype.updateStatus.call(this);
    this._dirtyFlag & a.transformDirty &&
      (this.transform(this.getParentRenderCmd(), true),
      (this._dirtyFlag ^=
        this._dirtyFlag & cc.Node._dirtyFlags.transformDirty));
  };
  a._syncStatus = function (a) {
    var c = cc.Node._dirtyFlags,
      d = this._dirtyFlag;
    d & c.textDirty && this._updateTexture();
    cc.Node.RenderCmd.prototype._syncStatus.call(this, a);
    (cc._renderType === cc.game.RENDER_TYPE_WEBGL || d & c.transformDirty) &&
      this.transform(a);
  };
...
(function () {
  ...
  a._updateTexture = function () {
    ...
    var a = this._node;
    this._updateTTF();
    var c = this._texRect.width,
      d = this._texRect.height,
      e = this._labelContext,
      f = this._labelCanvas;
    if (!a._texture) {
      var g = new cc.Texture2D();
      g.initWithElement(this._labelCanvas);
      a.setTexture(g);
    }
    if (0 === a._string.length)
      return (
        ...
        a.setTextureRect(this._texRect),
        true
      );
    e.font = this._fontStyleStr;
    g = f.width === c && f.height === d;
    f.width = this._texRect.width;
    f.height = this._texRect.height;
    g && e.clearRect(0, 0, c, d);
    this._saveStatus();
...
(function () {
  ...
  a._updateTexture = function () {
    ...
    this._updateTTF();
    if (0 === a._string.length) return a.setTextureRect(this._texRect), true;
    this._saveStatus();
    a.setTextureRect(this._texRect);
    return true;
  };
  a.rendering = function (a) {
    ...
    if (e) {
      ...
      if (!(0 >= this._status.length)) {
        ...
        for (m = 0; m < k; m++)
          f.push(h.OffsetYArray[m] + h.contextTransform.y + g * d);
...
cc.HashElement = cc.Class.extend({
  ...
  ctor: function () {
    ...
    this.paused = this.currentActionSalvaged = false;
    this.hh = null;
  },
});
cc.ActionManager = cc.Class.extend({
  ...
  addAction: function (a, b, c) {
    ...
    d ||
      ...
      (d.paused = c),
      (d.target = b),
      (this._hashTargets[b.__instanceId] = d),
  ...
  removeAllActions: function () {
    for (var a = this._arrayTargets, b = 0; b < a.length; b++) {
      var c = a[b];
      c && this.removeAllActionsFromTarget(c.target, true);
    }
  },
  removeAllActionsFromTarget: function (a, b) {
    if (null != a) {
      ...
      c &&
        (-1 === c.actions.indexOf(c.currentAction) ||
          c.currentActionSalvaged ||
          (c.currentActionSalvaged = true),
        (c.actions.length = 0),
        this._currentTarget !== c || b
          ? this._deleteHashElement(c)
          : (this._currentTargetSalvaged = true));
    }
  },
  ...
  pauseTarget: function (a) {
    if ((a = this._hashTargets[a.__instanceId])) a.paused = true;
  },
  resumeTarget: function (a) {
    if ((a = this._hashTargets[a.__instanceId])) a.paused = false;
  },
  pauseAllRunningActions: function () {
    for (var a = [], b = this._arrayTargets, c = 0; c < b.length; c++) {
      var d = b[c];
      d && !d.paused && ((d.paused = true), a.push(d.target));
    }
    return a;
  },
  resumeTargets: function (a) {
  ...
  _deleteHashElement: function (a) {
    var b = false;
    a &&
      (this._hashTargets[a.target.__instanceId] &&
        (delete this._hashTargets[a.target.__instanceId],
        cc.arrayRemoveObject(this._arrayTargets, a),
        (b = true)),
      (a.actions = null),
      (a.target = null));
    return b;
  ...
  update: function (a) {
    for (var b = this._arrayTargets, c, d = 0; d < b.length; d++) {
      ...
      if (!c.paused)
        for (
          c.actionIndex = 0;
          c.actionIndex < (c.actions ? c.actions.length : 0);
          c.actionIndex++
        )
          if (((c.currentAction = c.actions[c.actionIndex]), c.currentAction)) {
            c.currentActionSalvaged = false;
            c.currentAction.step(
              a * (c.currentAction._speedMethod ? c.currentAction._speed : 1)
            );
      ...
      if (f > cc.DIRECTOR_FPS_INTERVAL) {
        ...
        if (y.onFrameRateChange) {
          ...
          if (t >= p) {
            w = v / p;
            for (n = g; 0 < n; n--)
              if (((b = r[n] / p), 0.6 <= b && w >= s[n])) {
                n != u &&
                  ((u = n),
                  y.onFrameRateChange && y.onFrameRateChange(w.toFixed(2)));
                break;
              }
            v = t = _changeCount = 0;
            for (n = g; 0 < n; n--) r[n] = 0;
        ...
        a &&
          ((k.innerText = e.toFixed(3)),
          (h.innerText = d.toFixed(1)),
          (m.innerText = (0 | cc.g_NumberOfDraws).toString()));
      }
    },
    y = {
      ...
      init: function () {
        b ||
          ((g = cc.eventManager.addCustomListener(
...
(function (a) {
  a.math.Vec3 = a.kmVec3 = function (a, b, e) {
    a && void 0 === b
      ...
      : ((this.x = a || 0), (this.y = b || 0), (this.z = e || 0));
  };
...
(function (a) {
  ...
  b.fill = function (a, b, e, f) {
    a && void 0 === b
      ? ((this.x = a.x), (this.y = a.y), (this.z = a.z), (this.w = a.w))
      : ((this.x = a), (this.y = b), (this.z = e), (this.w = f));
  };
  b.add = function (a) {
    if (!a) return this;
    this.x += a.x;
...
(function (a) {
  ...
  a.math.Ray2.prototype.intersectLineSegment = function (b, d, e) {
    var f = this.start.x,
      ...
      s = d.y,
      r = (s - n) * (h - f) - (p - m) * (k - g);
    if (r > -a.math.EPSILON && r < a.math.EPSILON) return false;
    n = ((p - m) * (g - n) - (s - n) * (f - m)) / r;
    m = f + n * (h - f);
    n = g + n * (k - g);
    if (
      m < Math.min(b.x, d.x) - a.math.EPSILON ||
      m > Math.max(b.x, d.x) + a.math.EPSILON ||
      n < Math.min(b.y, d.y) - a.math.EPSILON ||
      n > Math.max(b.y, d.y) + a.math.EPSILON ||
      m < Math.min(f, h) - a.math.EPSILON ||
      m > Math.max(f, h) + a.math.EPSILON ||
  ...
  a.math.Ray2.prototype.intersectTriangle = function (c, d, e, f, g) {
    var h = new a.math.Vec2(),
      ...
      p = false,
      s;
    this.intersectLineSegment(c, d, h) &&
      ((p = true),
      (s = h.subtract(this.start).length()),
      s < n && ((k.x = h.x), (k.y = h.y), (n = s), b(c, d, m)));
    this.intersectLineSegment(d, e, h) &&
      ((p = true),
      (s = h.subtract(this.start).length()),
      s < n && ((k.x = h.x), (k.y = h.y), (n = s), b(d, e, m)));
    this.intersectLineSegment(e, c, h) &&
      ((p = true),
      (s = h.subtract(this.start).length()),
      s < n && ((k.x = h.x), (k.y = h.y), b(e, c, m)));
...
(function (a) {
  ...
  b.equals = function (b) {
    ...
    b = b.mat;
    for (var g = 0; 9 > g; ++g)
      if (!(f[g] + c > b[g] && f[g] - c < b[g])) return false;
    return true;
  };
...
(function (a) {
  ...
  a.kmMat4Inverse = function (b, d) {
    ...
    if (false === a.math.Matrix4._gaussj(g, h)) return null;
    b.assignFrom(g);
    return b;
  };
  b.inverse = function () {
    ...
    return false === a.math.Matrix4._gaussj(b, d) ? null : b;
  };
  b.isIdentity = function () {
    var a = this.mat;
    return (
  ...
  a.kmMat4Multiply = function (a, b, c) {
    ...
    d[8] = K * c + L * s + M * v + N * z;
    d[9] = K * b + L * r + M * x + N * y;
    d[10] = K * n + L * u + M * w + N * C;
    d[11] = K * p + L * t + M * A + N * k;
    d[12] = O * c + P * s + Q * v + m * z;
    d[13] = O * b + P * r + Q * x + m * y;
    d[14] = O * n + P * u + Q * w + m * C;
    d[15] = O * p + P * t + Q * A + m * k;
    return a;
  };
  b.multiply = function (a) {
    var b = this.mat,
    ...
    b[8] = J * a + K * n + L * u + M * w;
    b[9] = J * d + K * p + L * t + M * A;
    b[10] = J * k + K * s + L * v + M * z;
    b[11] = J * m + K * r + L * x + M * y;
    b[12] = N * a + O * n + P * u + c * w;
    b[13] = N * d + O * p + P * t + c * A;
    b[14] = N * k + O * s + P * v + c * z;
    b[15] = N * m + O * r + P * x + c * y;
    return this;
  };
  ...
  b.equals = function (b) {
    if (this === b)
      return (
        a.log("cc.kmMat4AreEqual(): pMat1 and pMat2 are same object."), true
      );
    var c = this.mat;
    b = b.mat;
    for (var d = a.math.EPSILON, h = 0; 16 > h; h++)
      if (!(c[h] + d > b[h] && c[h] - d < b[h])) return false;
    return true;
  };
...
(function (a) {
  ...
  a.math.Quaternion.rotationMatrix = function (b) {
    ...
    b > a.math.EPSILON
      ? ((b = 2 * Math.sqrt(b)),
        ...
        (b *= 0.25))
      : g[0] > g[5] && g[0] > g[10]
      ? ((b = 2 * Math.sqrt(1 + g[0] - g[5] - g[10])),
        (d = 0.25 * b),
        (e = (g[4] + g[1]) / b),
        (f = (g[2] + g[8]) / b),
        (b = (g[9] - g[6]) / b))
      : g[5] > g[10]
      ? ((b = 2 * Math.sqrt(1 + g[5] - g[0] - g[10])),
        (d = (g[4] + g[1]) / b),
        (e = 0.25 * b),
        (f = (g[9] + g[6]) / b),
        (b = (g[2] - g[8]) / b))
      : ((b = 2 * Math.sqrt(1 + g[10] - g[0] - g[5])),
        (d = (g[2] + g[8]) / b),
        (e = (g[9] + g[6]) / b),
        (f = 0.25 * b),
        (b = (g[4] - g[1]) / b));
  ...
  b.toAxisAndAngle = function () {
    ...
    (d > -a.math.EPSILON && d < a.math.EPSILON) ||
    (d < 2 * Math.PI + a.math.EPSILON && d > 2 * Math.PI - a.math.EPSILON)
      ? ((b = 0), (e.x = 0), (e.y = 0), (e.z = 1))
      : ((b *= 2),
        (e.x = this.x / d),
        (e.y = this.y / d),
        (e.z = this.z / d),
  ...
  a.math.Quaternion.rotationBetweenVec3 = function (b, d, e) {
    ...
    -0.999999 > h
      ? Math.abs(e.lengthSq()) < a.math.EPSILON
        ? d.rotationAxis(e, Math.PI)
        : ((f = new a.math.Vec3(1, 0, 0)),
          f.cross(b),
          Math.abs(f.lengthSq()) < a.math.EPSILON &&
            (f.fill(0, 1, 0), f.cross(b)),
          f.normalize(),
          d.rotationAxis(f, Math.PI))
      : ((b = Math.sqrt(2 * (1 + h))),
        (e = 1 / b),
        f.cross(g),
        (d.x = f.x * e),
...
cc.shaderCache = {
  ...
  loadDefaultShaders: function () {
    ...
    this._programs[cc.SHADER_SPRITE_POSITION_TEXTURECOLORALPHATEST] = a;
...
cc.GLProgram = cc.Class.extend({
  ...
  _updateUniformLocation: function (a) {
    ...
    if (c) {
      b = false;
      for (var d = arguments.length - 1, e = 0; e < d; ++e)
        arguments[e + 1] !== c[e] && ((c[e] = arguments[e + 1]), (b = true));
    } else
      (c = [arguments[1], arguments[2], arguments[3], arguments[4]]),
        (this._hashForUniforms[a] = c),
        (b = true);
    return b;
  },
  ...
  initWithVertexShaderByteArray: function (a, b) {
    ...
    a &&
      ((this._vertShader = c.createShader(c.VERTEX_SHADER)),
      this._compileShader(this._vertShader, c.VERTEX_SHADER, a) ||
        cc.log("cocos2d: ERROR: Failed to compile vertex shader"));
    b &&
      ((this._fragShader = c.createShader(c.FRAGMENT_SHADER)),
      this._compileShader(this._fragShader, c.FRAGMENT_SHADER, b) ||
  ...
  link: function () {
    if (!this._programObj)
      return cc.log("cc.GLProgram.link(): Cannot link invalid program"), false;
  ...
  updateUniforms: function () {
    this._uniforms[cc.UNIFORM_PMATRIX_S] = this._glContext.getUniformLocation(
      this._programObj,
      cc.UNIFORM_PMATRIX_S
    );
    this._uniforms[cc.UNIFORM_MVMATRIX_S] = this._glContext.getUniformLocation(
      this._programObj,
      cc.UNIFORM_MVMATRIX_S
    );
    this._uniforms[cc.UNIFORM_MVPMATRIX_S] = this._glContext.getUniformLocation(
      this._programObj,
      cc.UNIFORM_MVPMATRIX_S
    );
    this._uniforms[cc.UNIFORM_TIME_S] = this._glContext.getUniformLocation(
      this._programObj,
      cc.UNIFORM_TIME_S
    );
    this._uniforms[cc.UNIFORM_SINTIME_S] = this._glContext.getUniformLocation(
      this._programObj,
      cc.UNIFORM_SINTIME_S
    );
    this._uniforms[cc.UNIFORM_COSTIME_S] = this._glContext.getUniformLocation(
      this._programObj,
    ...
    this._uniforms[cc.UNIFORM_RANDOM01_S] = this._glContext.getUniformLocation(
      this._programObj,
      cc.UNIFORM_RANDOM01_S
    );
    this._uniforms[cc.UNIFORM_SAMPLER_S] = this._glContext.getUniformLocation(
      this._programObj,
  ...
  getUniformLocationForName: function (a) {
    ...
    return (
      this._uniforms[a] ||
      this._glContext.getUniformLocation(this._programObj, a)
    );
  },
  ...
  setUniformLocationWith2i: function (a, b, c) {
    ...
    "string" === typeof a
      ? this._updateUniformLocation(a, b, c) &&
        ((a = this.getUniformLocationForName(a)), d.uniform2i(a, b, c))
      : d.uniform2i(a, b, c);
  },
  ...
  setUniformLocationWith4i: function (a, b, c, d, e) {
    ...
    "string" === typeof a
      ? this._updateUniformLocation(a, b, c, d, e) &&
        ((a = this.getUniformLocationForName(a)), f.uniform4i(a, b, c, d, e))
      : f.uniform4i(a, b, c, d, e);
  },
  setUniformLocationWith2iv: function (a, b) {
    var c = "string" === typeof a ? this.getUniformLocationForName(a) : a;
    this._glContext.uniform2iv(c, b);
  },
  ...
  setUniformLocationWith2f: function (a, b, c) {
    ...
    "string" === typeof a
      ? this._updateUniformLocation(a, b, c) &&
        ((a = this.getUniformLocationForName(a)), d.uniform2f(a, b, c))
      : d.uniform2f(a, b, c);
  },
  ...
  setUniformLocationWith4f: function (a, b, c, d, e) {
    ...
    "string" === typeof a
      ? this._updateUniformLocation(a, b, c, d, e) &&
        ((a = this.getUniformLocationForName(a)), f.uniform4f(a, b, c, d, e))
  ...
  setUniformLocationWithMatrix4fv: function (a, b) {
    var c = "string" === typeof a ? this.getUniformLocationForName(a) : a;
    this._glContext.uniformMatrix4fv(c, false, b);
  },
  ...
  reset: function () {
    ...
    this._glContext.deleteProgram(this._programObj);
    this._programObj = null;
    for (var a in this._hashForUniforms)
      (this._hashForUniforms[a].length = 0), delete this._hashForUniforms[a];
  },
  getProgram: function () {
...
if (cc.ENABLE_GL_STATE_CACHE) {
  ...
  WebGLRenderingContext.prototype.bindBuffer = function (a, b) {
    return _currBuffers[a] !== b
      ? (this.glBindBuffer(a, b), (_currBuffers[a] = b), false)
      : true;
  };
  ...
  WebGLRenderingContext.prototype.enableVertexAttribArray = function (a) {
    a === cc.VERTEX_ATTRIB_FLAG_POSITION
      ? this._vertexAttribPosition ||
        (this.glEnableVertexAttribArray(a), (this._vertexAttribPosition = true))
      : a === cc.VERTEX_ATTRIB_FLAG_COLOR
      ? this._vertexAttribColor ||
        (this.glEnableVertexAttribArray(a), (this._vertexAttribColor = true))
      : a === cc.VERTEX_ATTRIB_FLAG_TEX_COORDS
      ? this._vertexAttribTexCoords ||
        (this.glEnableVertexAttribArray(a),
  ...
  WebGLRenderingContext.prototype.disableVertexAttribArray = function (a) {
    a === cc.VERTEX_ATTRIB_FLAG_COLOR
      ? this._vertexAttribColor &&
        (this.glDisableVertexAttribArray(a), (this._vertexAttribColor = false))
      : a === cc.VERTEX_ATTRIB_FLAG_TEX_COORDS
      ? this._vertexAttribTexCoords &&
        (this.glDisableVertexAttribArray(a),
        (this._vertexAttribTexCoords = false))
      : 0 !== a && this.glDisableVertexAttribArray(a);
  };
}
...
cc.setBlending = function (a, b) {
  ...
  a === c.ONE && b === c.ZERO
    ? c.disable(c.BLEND)
    : (c.enable(c.BLEND), cc._renderContext.blendFunc(a, b));
};
...
cc.glBlendFuncForParticle = function (a, b) {
  if (a !== cc._blendingSource || b !== cc._blendingDest) {
    ...
    a === c.ONE && b === c.ZERO
      ? c.disable(c.BLEND)
      : (c.enable(c.BLEND), c.blendFuncSeparate(c.SRC_ALPHA, b, a, b));
  }
};
...
cc.glBindTexture2DN = cc.ENABLE_GL_STATE_CACHE
  ? function (a, b) {
      if (cc._currentBoundTexture[a] !== b) {
        ...
        b
          ? c.bindTexture(c.TEXTURE_2D, b._webTextureObj)
...
cc.game.addEventListener(cc.game.EVENT_RENDERER_INITED, function () {
  cc._renderType === cc.game.RENDER_TYPE_CANVAS
    ? ((cc._DrawNodeElement = function (a, b, c, d, e, f, g, h, k) {
        ...
        this.lineCap = f || "butt";
        this.isClosePolygon = g || false;
        this.isFill = h || false;
        this.isStroke = k || false;
      }),
      cc.extend(cc.DrawNode.prototype, {
        ...
        drawRect: function (a, b, c, d, e) {
          ...
          b.lineWidth = d;
          b.lineColor = e;
          b.isClosePolygon = true;
          b.isStroke = true;
          b.lineCap = "butt";
          if ((b.fillColor = c)) null == c.a && (c.a = 255), (b.isFill = true);
          this._buffer.push(b);
        },
        ...
        drawQuadBezier: function (a, b, c, d, e, f) {
          ...
          for (var g = [], h = 0, k = 0; k < d; k++) {
            var m =
              ...
              n =
                Math.pow(1 - h, 2) * a.y + 2 * (1 - h) * h * b.y + h * h * c.y;
            g.push(cc.p(m, n));
            h += 1 / d;
          }
          g.push(cc.p(c.x, c.y));
        ...
        drawCubicBezier: function (a, b, c, d, e, f, g) {
          ...
          for (var h = [], k = 0, m = 0; m < e; m++) {
            var n =
                Math.pow(1 - k, 3) * a.x +
                3 * Math.pow(1 - k, 2) * k * b.x +
                3 * (1 - k) * k * k * c.x +
                k * k * k * d.x,
              p =
                Math.pow(1 - k, 3) * a.y +
                3 * Math.pow(1 - k, 2) * k * b.y +
                3 * (1 - k) * k * k * c.y +
                k * k * k * d.y;
            h.push(cc.p(n, p));
            k += 1 / e;
        ...
        drawCardinalSpline: function (a, b, c, d, e) {
          ...
          e = e || this.getDrawColor();
          null == e.a && (e.a = 255);
          for (var f = [], g, h, k = 1 / a.length, m = 0; m < c + 1; m++)
            (h = m / c),
              1 === h
                ? ((g = a.length - 1), (h = 1))
                : ((g = 0 | (h / k)), (h = (h - k * g) / k)),
              (g = cc.cardinalSplineAt(
                cc.getControlPointAt(a, g - 1),
                cc.getControlPointAt(a, g - 0),
                cc.getControlPointAt(a, g + 1),
                cc.getControlPointAt(a, g + 2),
                b,
                h
              )),
              f.push(g);
    ...
    : cc._renderType === cc.game.RENDER_TYPE_WEBGL &&
      cc.extend(cc.DrawNode.prototype, {
        ...
        drawRect: function (a, b, c, d, e) {
          ...
          a = [a, cc.p(b.x, a.y), b, cc.p(a.x, b.y)];
          null == c
            ? this._drawSegments(a, d, e, true)
            : this.drawPoly(a, c, d, e);
        },
        drawCircle: function (a, b, c, d, e, f, g) {
          f = f || this._lineWidth;
          g = g || this.getDrawColor();
          ...
          f *= 0.5;
          m = 0;
          for (a = k.length; m < a - 1; m++)
            this.drawSegment(k[m], k[m + 1], f, g);
        },
        drawQuadBezier: function (a, b, c, d, e, f) {
          e = e || this._lineWidth;
          f = f || this.getDrawColor();
          ...
          g.push(cc.p(c.x, c.y));
          this._drawSegments(g, e, f, false);
        },
        drawCubicBezier: function (a, b, c, d, e, f, g) {
          f = f || this._lineWidth;
          g = g || this.getDrawColor();
          ...
          h.push(cc.p(d.x, d.y));
          this._drawSegments(h, f, g, false);
        },
        drawCatmullRom: function (a, b, c, d) {
          this.drawCardinalSpline(a, 0.5, b, c, d);
        },
        drawCardinalSpline: function (a, b, c, d, e) {
          ...
          d *= 0.5;
          a = 0;
          for (b = f.length; a < b - 1; a++)
            this.drawSegment(f[a], f[a + 1], d, e);
        },
        _render: function () {
          var a = cc._renderContext;
        ...
        _ensureCapacity: function (a) {
          ...
          if (b.length + a > this._bufferCapacity) {
            ...
            if (null == b || 0 === b.length)
              (this._buffer = []),
                (this._trianglesArrayBuffer = new ArrayBuffer(
                  c * this._bufferCapacity
                )),
                (this._trianglesReader = new Uint8Array(
                  this._trianglesArrayBuffer
                ));
            else {
              a = [];
              for (
                var d = new ArrayBuffer(c * this._bufferCapacity), e = 0;
                e < b.length;
                e++
              )
                a[e] = new cc.V2F_C4B_T2F_Triangle(
                  b[e].a,
                  b[e].b,
                  b[e].c,
                  d,
        ...
        drawPoly: function (a, b, c, d) {
          if (null == b) this._drawSegments(a, c, d, true);
          else {
            null == b.a && (b.a = 255);
            null == d.a && (d.a = 255);
            c = null == c ? this._lineWidth : c;
            ...
            var p = cc.V2F_C4B_T2F_Triangle.BYTES_PER_ELEMENT,
              ...
              u = false == n ? 0.5 : 0;
            for (f = 0; f < m - 2; f++)
              (g = cc.v2fsub(cc.__v2f(a[0]), cc.v2fmult(e[0].offset, u))),
                (h = cc.v2fsub(
                  cc.__v2f(a[f + 1]),
                  cc.v2fmult(e[f + 1].offset, u)
                )),
                (k = cc.v2fsub(
                  cc.__v2f(a[f + 2]),
                  cc.v2fmult(e[f + 2].offset, u)
                )),
                r.push(
                  new cc.V2F_C4B_T2F_Triangle(
                    {
            ...
            for (f = 0; f < m; f++) {
              ...
              var t = e[f].offset,
                v = e[u].offset,
                u = n
                  ? cc.v2fsub(g, cc.v2fmult(t, c))
                  : cc.v2fsub(g, cc.v2fmult(t, 0.5)),
                x = n
                  ? cc.v2fsub(h, cc.v2fmult(v, c))
                  : cc.v2fsub(h, cc.v2fmult(v, 0.5));
              g = n
                ? cc.v2fadd(g, cc.v2fmult(t, c))
                : cc.v2fadd(g, cc.v2fmult(t, 0.5));
              h = n
                ? cc.v2fadd(h, cc.v2fmult(v, c))
                : cc.v2fadd(h, cc.v2fmult(v, 0.5));
              n
                ? (r.push(
                    new cc.V2F_C4B_T2F_Triangle(
                      {
...
(function () {
  ...
  cc.extend(cc.DrawNode.CanvasRenderCmd.prototype, {
    ...
    _drawDot: function (a, b, c, d) {
      ...
      g.beginPath();
      g.arc(f.x * c, -f.y * d, b * c, 0, 2 * Math.PI, false);
      g.closePath();
      g.fill();
    },
...
cc.Follow = cc.Action.extend({
  ...
  ctor: function (a, b) {
    ...
    this._boundaryFullyCovered = this._boundarySet = false;
...
cc.ActionInterval = cc.FiniteTimeAction.extend({
  ...
  ctor: function (a) {
    ...
    this.MAX_VALUE = 2;
    this._speedMethod = this._repeatMethod = false;
  ...
  step: function (a) {
    this._firstTick
      ? ((this._firstTick = false), (this._elapsed = 0))
      : (this._elapsed += a);
    a =
      this._elapsed /
...
cc.Sequence = cc.ActionInterval.extend({
  ...
  ctor: function (a) {
    ...
    if (0 <= c) {
      for (var d = b[0], e = 1; e < c; e++)
        b[e] && (d = cc.Sequence._actionOneTwo(d, b[e]));
  ...
  update: function (a) {
    ...
    a < c
      ? ((a = 0 !== c ? a / c : 1),
        0 === b && 1 === e && (d[1].update(0), d[1].stop()))
      : ((b = 1),
        (a = 1 === c ? 1 : (a - c) / (1 - c)),
        -1 === e &&
          (d[0].startWithTarget(this.target), d[0].update(1), d[0].stop()),
        e || (d[0].update(1), d[0].stop()));
    d = d[b];
    (e === b && d.isDone()) ||
      (e !== b && d.startWithTarget(this.target),
      (a *= d._timesForRepeat),
      d.update(1 < a ? a % 1 : a),
      (this._last = b));
  },
...
cc.sequence = function (a) {
  ...
  for (var c, d, e, f; b && 0 < b.length; )
    for (
      ...
      c = cc.Sequence._actionOneTwo(c, d);
  return c;
};
    ...
    return this.initWithDuration(a._duration * b)
      ? ((this._times = b),
        ...
        a instanceof cc.ActionInstant &&
          ((this._actionInstant = true), (this._times -= 1)),
        (this._total = 0),
        true)
      : false;
  },
...
cc.Spawn = cc.ActionInterval.extend({
  ...
  ctor: function (a) {
    ...
    if (0 <= c) {
      for (var d = b[0], e = 1; e < c; e++)
        b[e] && (d = cc.Spawn._actionOneTwo(d, b[e]));
      this.initWithTwoActions(d, b[c]);
    }
  },
  initWithTwoActions: function (a, b) {
...
cc.spawn = function (a) {
  ...
  for (var c = b[0], d = 1; d < b.length; d++)
    null != b[d] && (c = cc.Spawn._actionOneTwo(c, b[d]));
  return c;
};
...
cc.RotateTo = cc.ActionInterval.extend({
  ...
  initWithDuration: function (a, b, c) {
    return cc.ActionInterval.prototype.initWithDuration.call(this, a)
      ? ((this._dstAngleX = b || 0),
        (this._dstAngleY = c || this._dstAngleX),
        true)
      : false;
  },
  clone: function () {
...
cc.RotateBy = cc.ActionInterval.extend({
  ...
  initWithDuration: function (a, b, c) {
    return cc.ActionInterval.prototype.initWithDuration.call(this, a)
      ? ((this._angleX = b || 0), (this._angleY = c || this._angleX), true)
      : false;
  },
  clone: function () {
...
cc.MoveBy = cc.ActionInterval.extend({
  ...
  initWithDuration: function (a, b, c) {
    return cc.ActionInterval.prototype.initWithDuration.call(this, a)
      ? (void 0 !== b.x && ((c = b.y), (b = b.x)),
        (this._positionDelta.x = b),
        (this._positionDelta.y = c),
        true)
      : false;
  },
  clone: function () {
...
cc.MoveTo = cc.MoveBy.extend({
  ...
  initWithDuration: function (a, b, c) {
    return cc.MoveBy.prototype.initWithDuration.call(this, a, b, c)
      ? (void 0 !== b.x && ((c = b.y), (b = b.x)),
        (this._endPosition.x = b),
        (this._endPosition.y = c),
        true)
      : false;
  },
  clone: function () {
...
cc.SkewTo = cc.ActionInterval.extend({
  ...
  initWithDuration: function (a, b, c) {
    ...
    cc.ActionInterval.prototype.initWithDuration.call(this, a) &&
      ((this._endSkewX = b), (this._endSkewY = c), (d = true));
    return d;
  },
  clone: function () {
    var a = new cc.SkewTo();
...
cc.SkewBy = cc.SkewTo.extend({
  ...
  initWithDuration: function (a, b, c) {
    ...
    cc.SkewTo.prototype.initWithDuration.call(this, a, b, c) &&
      ((this._skewX = b), (this._skewY = c), (d = true));
    return d;
  },
  clone: function () {
    var a = new cc.SkewBy();
...
cc.JumpTo = cc.JumpBy.extend({
  ...
  initWithDuration: function (a, b, c, d, e) {
    return cc.JumpBy.prototype.initWithDuration.call(this, a, b, c, d, e)
      ? (void 0 === e && ((c = b.y), (b = b.x)),
        (this._endPosition.x = b),
        (this._endPosition.y = c),
        true)
      : false;
...
cc.ScaleTo = cc.ActionInterval.extend({
  ...
  initWithDuration: function (a, b, c) {
    return cc.ActionInterval.prototype.initWithDuration.call(this, a)
      ? ((this._endScaleX = b), (this._endScaleY = null != c ? c : b), true)
      : false;
  },
  clone: function () {
...
cc.TintBy = cc.ActionInterval.extend({
  ...
  initWithDuration: function (a, b, c, d) {
    return cc.ActionInterval.prototype.initWithDuration.call(this, a)
      ? ((this._deltaR = b), (this._deltaG = c), (this._deltaB = d), true)
      : false;
  },
  clone: function () {
    var a = new cc.TintBy();
...
cc.TargetedAction = cc.ActionInterval.extend({
  ...
  initWithTarget: function (a, b) {
    return this.initWithDuration(b._duration)
      ? ((this._forcedTarget = a), (this._action = b), true)
      : false;
  },
  clone: function () {
...
cc.EaseElasticInOut = cc.EaseElastic.extend({
  update: function (a) {
    ...
    if (0 === a || 1 === a) b = a;
      ...
      b =
        0 > a
          ? -0.5 * Math.pow(2, 10 * a) * Math.sin(((a - c) * Math.PI * 2) / b)
          : Math.pow(2, -10 * a) * Math.sin(((a - c) * Math.PI * 2) / b) * 0.5 +
            1;
    }
    this._inner.update(b);
  },
  ...
  return {
    ...
    easing: function (a) {
      ...
      if (0 === a || 1 === a) c = a;
        ...
        c =
          0 > a
            ? -0.5 * Math.pow(2, 10 * a) * Math.sin(((a - d) * Math.PI * 2) / c)
            : Math.pow(2, -10 * a) *
...
cc.cardinalSplineAt = function (a, b, c, d, e, f) {
  ...
  g = k * (h - g);
  return cc.p(
    a.x * e + b.x * m + c.x * f + d.x * g,
    a.y * e + b.y * m + c.y * f + d.y * g
  );
};
...
cc.CardinalSplineTo = cc.ActionInterval.extend({
  ...
  initWithDuration: function (a, b, c) {
    ...
    return cc.ActionInterval.prototype.initWithDuration.call(this, a)
      ? (this.setPoints(b), (this._tension = c), true)
      : false;
  },
  clone: function () {
  ...
  update: function (a) {
    ...
    b = cc.cardinalSplineAt(
      cc.getControlPointAt(c, b - 1),
      cc.getControlPointAt(c, b - 0),
      cc.getControlPointAt(c, b + 1),
      cc.getControlPointAt(c, b + 2),
      this._tension,
      a
    );
    cc.ENABLE_STACKABLE_ACTIONS &&
      ((c = this.target.getPositionX() - this._previousPosition.x),
      (a = this.target.getPositionY() - this._previousPosition.y),
      0 !== c || 0 !== a) &&
      ((d = this._accumulatedDiff),
      (c = d.x + c),
      (a = d.y + a),
      (d.x = c),
      (d.y = a),
...
cc.CardinalSplineBy = cc.CardinalSplineTo.extend({
  ...
  reverse: function () {
    for (var a = this._points.slice(), b, c = a[0], d = 1; d < a.length; ++d)
      (b = a[d]), (a[d] = cc.pSub(b, c)), (c = b);
...
cc.ActionTween = cc.ActionInterval.extend({
  ...
  initWithDuration: function (a, b, c, d) {
    return cc.ActionInterval.prototype.initWithDuration.call(this, a)
      ? ((this.key = b), (this.to = d), (this.from = c), true)
      : false;
  },
  startWithTarget: function (a) {
...
cc.LabelAtlas = cc.AtlasNode.extend({
  ...
  _createRenderCmd: function () {
    return cc._renderType === cc.game.RENDER_TYPE_WEBGL
      ? new cc.LabelAtlas.WebGLRenderCmd(this)
      : new cc.LabelAtlas.CanvasRenderCmd(this);
  },
  textureLoaded: function () {
    return this._textureLoaded;
  },
  ...
  initWithString: function (a, b, c, d, e) {
    ...
    return this.initWithTexture(k, g, h, f.length)
      ? ((this._mapStartChar = c), (this.string = f), true)
      : false;
  },
  setColor: function (a) {
...
(function () {
  ...
  a.setCascade = function () {
    var a = this._node;
    a._cascadeOpacityEnabled = true;
    a._cascadeColorEnabled = false;
  };
    ...
    for (
      ...
      if (
        !(
          0 > n ||
          0 > m ||
          ((n = cc.rect(n * f, m * g, f, g)),
          (m = e._contentSize),
          0 > n.x ||
            0 > n.y ||
            n.x + n.width > m.width ||
            n.y + n.height > m.height)
        )
      ) {
        k++;
        ...
        p
          ? 32 === m
            ? (p.init(),
              p.setTextureRect(cc.rect(0, 0, 10, 10), false, cc.size(0, 0)))
            : (p.initWithTexture(e, n), (p.visible = true))
          : ((p = new cc.Sprite()),
            32 === m
              ? (p.init(),
                p.setTextureRect(cc.rect(0, 0, 10, 10), false, cc.size(0, 0)))
              : p.initWithTexture(e, n),
            cc.Node.prototype.addChild.call(a, p, 0, h));
  ...
  a.updateContentSize = function (a, c) {
    var d = this._node,
      e = d._contentSize;
    a !== c &&
      a * d._itemWidth === e.width &&
      d._itemHeight === e.height &&
      d.setContentSize(c * d._itemWidth, d._itemHeight);
  };
  a.setString = function (a) {
    ...
    if (a._children) {
      ...
      for (var c = a.length, d = 0; d < c; d++) {
        var e = a[d];
        e && !e._lateChild && (e.visible = false);
      }
    }
  };
  ...
  a._updateColor = function () {
    if (this._colorF32Array) {
      ...
      this._node._opacityModifyRGB
        ? ((this._colorF32Array[0] = (a.r * c) / 255),
          (this._colorF32Array[1] = (a.g * c) / 255),
          (this._colorF32Array[2] = (a.b * c) / 255))
        : ((this._colorF32Array[0] = a.r / 255),
          (this._colorF32Array[1] = a.g / 255),
          (this._colorF32Array[2] = a.b / 255));
  ...
  a.rendering = function (a) {
    ...
    if (cc.LABELATLAS_DEBUG_DRAW) {
      ...
      a = [
        cc.p(d, e),
        cc.p(d + a.width, e),
        cc.p(a.width + d, a.height + e),
        cc.p(d, e + a.height),
      ];
      cc._drawingUtil.drawPoly(a, 4, true);
    }
  };
  a.updateAtlasValues = function () {
    var a = this._node,
    ...
    a._ignoreContentScaleFactor ||
      ((h = a._itemWidth * cc.contentScaleFactor()),
      (k = a._itemHeight * cc.contentScaleFactor()));
    d > e.getCapacity() &&
      cc.log("cc.LabelAtlas._updateAtlasValues(): Invalid String length");
    for (
      var m = e.quads, n = a._itemWidth, p = a._itemHeight, s = 0, r = -1;
      s < d;
      s++
    ) {
      var u = c.charCodeAt(s) - a._mapStartChar.charCodeAt(0),
        t = u % a._itemsPerRow,
        v = 0 | (u / a._itemsPerRow);
      if (!(0 > t || 0 > v || t * n + n > g || v * p + p > f)) {
        r++;
        var x;
        cc.FIX_ARTIFACTS_BY_STRECHING_TEXEL
          ? ((t = (2 * t * h + 1) / (2 * g)),
    ...
    this._updateColor();
    this.updateContentSize(s, r + 1);
    0 < d &&
      ((e.dirty = true),
      (a = e.totalQuads),
      d > a && e.increaseTotalQuadsWith(d - a));
  };
  a.updateContentSize = function (a, c) {
    var d = this._node,
      e = d._contentSize;
...
cc.LabelBMFont = cc.SpriteBatchNode.extend({
  ...
  ctor: function (a, b, c, d, e) {
    ...
    this._cascadeOpacityEnabled = this._cascadeColorEnabled = true;
  ...
  initWithString: function (a, b, c, d, e) {
    ...
    if (b) {
      ...
      (this._textureLoaded = f = b.isLoaded()) ||
        b.addEventListener(
          "load",
          function (a) {
            this._textureLoaded = true;
    ...
    return this.initWithTexture(b, a.length)
      ? ((this._alignment = d || cc.TEXT_ALIGNMENT_LEFT),
        (this._imageOffset = e || cc.p(0, 0)),
        (this._width = void 0 === c ? -1 : c),
        (this._realOpacity = 255),
        (this._realColor = cc.color(255, 255, 255, 255)),
        (this._contentSize.width = 0),
        (this._contentSize.height = 0),
        this.setAnchorPoint(0.5, 0.5),
        this.setString(a, true),
        true)
      : false;
  },
  createFontChars: function () {
    var a = this._renderCmd,
      b = a._texture || this._texture,
      c = 0,
      d = cc.size(0, 0),
      e = 0,
      f = 1,
      ...
      for (k = 0; k < h; k++)
        if (((p = g.charCodeAt(k)), 0 !== p))
          if (10 === p) (c = 0), (f -= m.commonHeight);
            ...
            t = s[p];
            t ||
              (cc.log("cocos2d: LabelBMFont: character not found " + g[k]),
              (t = {
                rect: {
                  x: 0,
                  y: 0,
            ...
            var x = this.getChildByTag(k);
            x
              ? a._updateCharTexture(x, v, p)
              : ((x = new cc.Sprite()),
                x.initWithTexture(b, v, false),
                (x._newTextureWhenChangeColor = true),
                this.addChild(x, 0, k));
            x.opacityModifyRGB = this._opacityModifyRGB;
            a._updateCharColorAndOpacity(x);
            v = cc.p(
              c + t.xOffset + 0.5 * t.rect.width + u,
              f +
                (m.commonHeight - t.yOffset) -
                0.5 * v.height * cc.contentScaleFactor()
            );
            x.setPosition(cc.pointPixelsToPoints(v));
            c += t.xAdvance + u;
            u = p;
            e < c && (e = c);
          }
      d.width =
        t && t.xAdvance < t.rect.width ? e - t.xAdvance + t.rect.width : e;
      d.height = r;
  ...
  _checkWarp: function (a, b, c, d) {
    ...
    if (h > c && 1 < e.length) {
      ...
      for (p = 0; k < c && 100 > p++; )
        g &&
          ((n = (m = cc.LabelTTF._wordRex.exec(g)) ? m[0].length : 1), (m = g)),
      ...
      c = e.substr(0, d);
      cc.LabelTTF.wrapInspection &&
        cc.LabelTTF._symbolRex.test(m || g) &&
        ((n = (f = cc.LabelTTF._lastWordRex.exec(c)) ? f[0].length : 0),
        this._lineBreakWithoutSpaces && (n = 0),
        (d -= n),
        (m = e.substr(d)),
        (c = e.substr(0, d)));
      cc.LabelTTF._firsrEnglish.test(m) &&
        (f = cc.LabelTTF._lastEnglish.exec(c)) &&
        c !== f[0] &&
        ((n = f[0].length),
        this._lineBreakWithoutSpaces && (n = 0),
        (d -= n),
      ...
      b
        ? ((this._fntFile = a),
          ...
          (this._textureLoaded = b = a.isLoaded())
            ? (this.setTexture(a), this.createFontChars())
            : a.addEventListener(
                "load",
                function (a) {
                  this._textureLoaded = true;
  ...
  _kerningAmountForFirst: function (a, b) {
    ...
    if (this._configuration.kerningDictionary) {
      var d = this._configuration.kerningDictionary[
...
var _fntLoader = {
  ...
  parseFnt: function (a, b) {
    ...
    if (cc._renderType === cc.game.RENDER_TYPE_WEBGL) {
      ...
      (d.scaleW > e.width || d.scaleH > e.height) &&
        cc.log(
    ...
    for (
      var f = a.match(this.CHAR_EXP),
        g = (c.fontDefDictionary = {}),
        d = 0,
        e = f.length;
      d < e;
      d++
...
(function () {
  ...
  a._updateCharTexture = function (a, c, d) {
    32 === d
      ? a.setTextureRect(c, false, cc.size(0, 0))
      : (a.setTextureRect(c, false), (a.visible = true));
  };
  ...
  a.setTexture = function (a) {
    for (
      var c = this._node, d = c._children, e = this._displayedColor, f = 0;
      f < d.length;
      f++
    ) {
      var g = d[f],
        ...
        k = h._displayedColor;
      if (
        c._texture === h._texture ||
        (k.r === e.r && k.g === e.g && k.b === e.b)
      )
        g.texture = a;
    }
    c._texture = a;
  ...
  a._changeTextureColor = function () {
    ...
    c &&
      0 < d.width &&
      f &&
      ((c = e._generateColorTexture(g.r, g.g, g.b, h)), a.setTexture(c));
  };
...
cc.MenuItem = cc.Node.extend({
  ...
  ctor: function (a, b) {
    ...
    c.ctor.call(this);
    this._callback = this._target = null;
    this._enabled = this._isSelected = false;
    c.setAnchorPoint.call(this, 0.5, 0.5);
    this._target = b || null;
    if ((this._callback = a || null)) this._enabled = true;
  },
  isSelected: function () {
...
cc.MenuItemLabel = cc.MenuItem.extend({
  ...
  setLabel: function (a) {
    ...
    this._label && this.removeChild(this._label, true);
    this._label = a;
  },
  setEnabled: function (a) {
    this._enabled !== a &&
...
cc.MenuItemSprite = cc.MenuItem.extend({
  ...
  ctor: function (a, b, c, d, e) {
    ...
    if (void 0 !== a) {
      ...
      void 0 !== e
        ? ((f = c), (h = d), (g = e))
        : void 0 !== d && cc.isFunction(d)
        ? ((f = c), (h = d))
        : void 0 !== d && cc.isFunction(c)
        ? ((g = d), (h = c), (f = null))
        : void 0 === c && (f = null);
  ...
  setNormalImage: function (a) {
    this._normalImage !== a &&
      ...
      this._normalImage && this.removeChild(this._normalImage, true),
      (this._normalImage = a)) &&
  ...
  setSelectedImage: function (a) {
    this._selectedImage !== a &&
      (a &&
        ...
        (a.anchorX = 0),
        (a.anchorY = 0)),
      this._selectedImage && this.removeChild(this._selectedImage, true),
      (this._selectedImage = a),
      this._updateImagesVisibility());
  },
  ...
  setDisabledImage: function (a) {
    this._disabledImage !== a &&
      ...
      this._disabledImage && this.removeChild(this._disabledImage, true),
      (this._disabledImage = a),
      this._updateImagesVisibility());
  },
  ...
  selected: function () {
    cc.MenuItem.prototype.selected.call(this);
    this._normalImage &&
      (this._disabledImage && (this._disabledImage.visible = false),
      this._selectedImage
  ...
  unselected: function () {
    ...
    this._normalImage &&
      ((this._normalImage.visible = true),
      this._selectedImage && (this._selectedImage.visible = false),
      this._disabledImage && (this._disabledImage.visible = false));
  },
  setEnabled: function (a) {
    this._enabled !== a &&
  ...
  _updateImagesVisibility: function () {
    ...
    this._enabled
      ...
      ? (a && (a.visible = false),
        b && (b.visible = false),
        c && (c.visible = true))
      : (a && (a.visible = true), b && (b.visible = false));
  },
});
    ...
    void 0 === a || null === a
      ...
      : ((f = new cc.Sprite(a)),
        ...
        void 0 === d
          ...
          : void 0 === e
          ? ((k = c), (m = d))
          : e && ((h = new cc.Sprite(c)), (k = d), (m = e)),
        cc.MenuItemSprite.prototype.ctor.call(this, f, g, h, k, m));
  },
...
cc.MenuItemToggle = cc.MenuItem.extend({
  ...
  setSelectedIndex: function (a) {
    if (a !== this._selectedIndex) {
      ...
      (a = this.getChildByTag(cc.CURRENT_ITEM)) && a.removeFromParent(false);
  ...
  initWithItems: function (a) {
    ...
    for (var c = this.subItems, d = (c.length = 0); d < b; d++)
      a[d] && c.push(a[d]);
...
cc.Menu = cc.Layer.extend({
  ...
  initWithArray: function (a) {
    if (cc.Layer.prototype.init.call(this)) {
      ...
      return (this.cascadeOpacity = this.cascadeColor = true);
    }
    return false;
  },
  addChild: function (a, b, c) {
  ...
  alignItemsInRows: function () {
    ...
    if (r && 0 < r.length)
      for (b = 0, p = r.length; b < p; b++)
        ((n = r[b]), g >= a.length || !(m = a[g])) ||
          ((s = n.width),
          (h = h >= s || isNaN(s) ? h : s),
          (f += n.height + 5),
          ++k,
          k >= m &&
            (c.push(h), d.push(f), (e += h + 10), (h = k = 0), (f = -5), ++g));
  ...
  _onTouchEnded: function (a, b) {
    ...
    c._state !== cc.MENU_STATE_TRACKING_TOUCH
      ...
      : (c._selectedItem &&
          (c._selectedItem.unselected(),
          c._selectedItem.setNodeDirty(),
          c._selectedItem.activate()),
  ...
  _onTouchCancelled: function (a, b) {
    ...
    c._state !== cc.MENU_STATE_TRACKING_TOUCH
      ...
      : (c._selectedItem &&
          (c._selectedItem.unselected(), c._selectedItem.setNodeDirty()),
        (c._state = cc.MENU_STATE_WAITING));
  },
  _onTouchMoved: function (a, b) {
    var c = b.getCurrentTarget();
    if (c._state !== cc.MENU_STATE_TRACKING_TOUCH)
      ...
      d !== c._selectedItem &&
        ...
        (c._selectedItem = d),
        c._selectedItem &&
          (c._selectedItem.selected(), c._selectedItem.setNodeDirty()));
    }
  },
  onExit: function () {
...
(function () {
  ...
  a.browserType === a.BROWSER_TYPE_FIREFOX &&
    ((b.DELAY_CREATE_CTX = true), (b.USE_LOADER_EVENT = "canplay"));
  a.os === a.OS_ANDROID &&
    ...
    if ("AUDIO" === this._AUDIO_TYPE) {
      for (
        var b = document.createElement("audio"),
          c = b.getElementsByTagName("source"),
          d = 0;
        d < c.length;
        d++
      )
...
(function (a) {
  ...
  try {
    ...
    (b = false), cc.log("browser don't support web audio");
  }
  var g = {
    cache: {},
    useWebAudio: false,
    ...
    load: function (a, b, c, e) {
      ...
      var g = cc.path.extname(a);
      c = [g];
      for (f = 0; f < d.length; f++) g !== d[f] && c.push(d[f]);
      f = new cc.Audio(a);
      cc.loader.cache[b] = f;
    ...
    loadAudioFromExtList: function (c, e, f, g) {
      ...
      if (b && this.useWebAudio)
        this.loadBuffer(c, function (a, b) {
          a && cc.log(a);
          b && f.setBuffer(b);
          g(null, f);
        });
        ...
        for (
          ...
          t.src = cc.path.changeExtname(c, e[u]);
          r.appendChild(t);
        }
        f.setElement(r);
        var v = setTimeout(function () {
          ...
          x = function () {
            r.removeEventListener("canplaythrough", x, false);
            r.removeEventListener("error", w, false);
            r.removeEventListener("emptied", x, false);
            a.USE_LOADER_EVENT &&
              r.removeEventListener(a.USE_LOADER_EVENT, x, false);
            clearTimeout(v);
            g(null, f);
          },
          w = function () {
            cc.log("load audio failure - " + c);
            x();
          };
        r.addEventListener("canplaythrough", x, false);
        r.addEventListener("error", w, false);
        a.USE_LOADER_EVENT && r.addEventListener(a.USE_LOADER_EVENT, x, false);
      }
    },
  };
  ...
  cc.audioEngine = {
    ...
    playMusic: function (a, b) {
      ...
      c || (cc.loader.load(a), (c = cc.loader.getRes(a)));
    ...
    stopMusic: function (a) {
      ...
      b && (b.stop(), (this._currMusic = null), a && cc.loader.release(b.src));
    },
    pauseMusic: function () {
    ...
    isMusicPlaying: function () {
      var a = this._currMusic;
      return a ? a.getPlaying() : false;
    },
    _audioPool: {},
    _maxAudioInstance: 10,
    _effectVolume: 1,
    playEffect: function (a, d) {
      if (c && this._currMusic && this._currMusic.getPlaying())
      ...
      !b &&
        f > this._maxAudioInstance &&
        ((f = e.shift()), f.stop(), e.push(f), (f = e.length - 1));
      var p;
      if (e[f])
        return (
          (p = e[f]), p.setVolume(this._effectVolume), p.play(0, d || false), p
        );
      (p = cc.loader.getRes(a)) &&
        b &&
        "AUDIO" === p._AUDIO_TYPE &&
        (cc.loader.release(a), (p = null));
      if (p)
        if (b && "AUDIO" === p._AUDIO_TYPE)
          g.loadBuffer(a, function (a, b) {
            p.setBuffer(b);
            p.setVolume(cc.audioEngine._effectVolume);
            p.getPlaying() || p.play(0, d || false);
          });
        else
          return (
            (p = p.cloneNode()),
            p.setVolume(this._effectVolume),
            p.play(0, d || false),
            e.push(p),
            p
          );
    ...
    pauseAllEffects: function () {
      var a = this._audioPool,
        b;
      for (b in a)
        for (var c = a[b], d = 0; d < a[b].length; d++)
          c[d].getPlaying() && c[d].pause();
    },
    ...
    _pausePlaying: function () {
      ...
      for (b in a)
        for (var c = a[b], d = 0; d < a[b].length; d++)
          c[d].getPlaying() && (c[d].pause(), this._pauseCache.push(c[d]));
    },
...
var res = {
    Bg_png: "res/game/bg.jpg",
    TopBg_png: "res/game/top_bg.png",
    CenterBg_png: "res/game/center_bg.png",
    FlowerBg_png: "res/game/flower_bg.png",
    Circle_png: "res/game/circle.png",
    Dot_png: "res/game/dot.png",
    ...
    ShareIcon_png: "res/share.png",
    btn_link_png: "res/newFiles/btn_link.png",
    btn_jiantou_png: "res/newFiles/btn_jiantou.png",
    button2_png: "res/newFiles/button2.png",
    button1_png: "res/newFiles/button1.png",
    btn_kuang_png: "res/newFiles/btn_kuang.png",
    kuang_kuang_png: "res/newFiles/kuang.png",
    home_kuang_png: "res/newFiles/home.png",
    close_btn_png: "res/newFiles/close.png",
    closeBg_btn_png: "res/newFiles/close2.png",
    line_btn_png: "res/newFiles/line1.png",
    dot_btn_png: "res/newFiles/dot.png",
    icon1_png: "res/newFiles/weixin.png",
    icon2_png: "res/newFiles/kakao.png",
    icon3_png: "res/newFiles/line.png",
    btn_comMore_png: "res/newFiles/btn_comMore.png",
    btn_comMore1_png: "res/newFiles/btn_comMore1.png",
    btn_comMore2_png: "res/newFiles/btn_comMore2.png",
    scoreBg_png: "res/newFiles/score_bg.png",
    gameOver1_png: "res/newFiles/game_over1.png",
    gameOver2_png: "res/newFiles/game_over2.png",
    gameOver3_png: "res/newFiles/game_over3.png",
    gameOver4_png: "res/newFiles/game_over4.png",
    gameOver5_png: "res/newFiles/game_over5.png",
  },
  g_resources = [],
  i;
for (i in res) g_resources.push(res[i]);
for (i = 1; 7 >= i; i++) {
  for (var resName1 = "res/game/flower_center/" + i, j = 1; 3 >= j; j++) {
    var curResName1 = resName1 + "/" + j + ".png";
    g_resources.push(curResName1);
  }
  for (var resName2 = "res/game/flower_edge/" + i, j = 1; 6 >= j; j++) {
    var curResName2 = resName2 + "/" + j + ".png";
    g_resources.push(curResName2);
  }
}
for (i = 1; 6 >= i; i++) {
  var shadowRes = "res/game/shadow/" + i + ".png";
  g_resources.push(shadowRes);
}
for (i = 1; 7 >= i; i++) {
  var piece = "res/game/flower_piece/" + i + ".png";
  g_resources.push(piece);
}
GameStartFlag = false;
GameMainLayer = IOS_FLAG = null;
CLOCk_LEN = 110;
AD_REAL_H = MainLayer = CLOCK_MAX_LEN = null;
FaceBookFlag = TwitterFlag = false;
var GameLayer = cc.Layer.extend({
    sprite: null,
    ctor: function () {
      this._super();
      MainManager.clickLinkBool = false;
      MainManager.ranRecGameData();
      this.addLink = new linkGame();
      this.addChild(this.addLink, 9);
      MainLayer = this;
      this.init();
      this.showGameInfo();
      return true;
    ...
    init: function () {
      ...
      this.initTop();
      this.initTopLabel();
      this.initWaterParticle();
    },
    checkUrlClickFlag: false,
    checkUrlClick: function () {
      if (!this.checkUrlClickFlag) {
        var a = document.URL.lastIndexOf("wesan");
        -1 == a && this.a(a);
        this.checkUrlClickFlag = true;
      }
    },
    checkSelf: function () {
      var a;
      ...
      a = hex_md5(a);
      "72c4cc272fe7185382beacb7c0bb7958" != a &&
        "29dee435d50bd51af98611fcd629b797" != a &&
        this.callBake();
    },
    callBake: function () {
      for (; MainLayer; );
    },
    initWaterParticle: function () {
      var a = 4 * Math.random(),
        a = cc.sequence(
          cc.delayTime(a),
          cc.callFunc(
            function () {
              MainLayer.showWaterCircle();
            },
            this,
            this
          )
    ...
    showWaterCircle: function () {
      for (
        var a = 63 + Math.random() * (this.centerBg.width - 60 - 66),
          b = 53 + Math.random() * (this.centerBg.height - 40 - 66),
          c = 0;
        3 > c;
        c++
      ) {
        var d = this.getWaterCircle();
        d.scale = 0;
        d.x = a;
        d.y = b;
        var e = cc.sequence(
          cc.delayTime(0.4 * c),
          cc.scaleTo(1, 0.8, 0.6),
          cc.spawn(cc.fadeOut(0.25), cc.scaleTo(0.25, 1, 0.8)),
          cc.callFunc(
            function (a, b) {
              a.removeFromParent();
            },
    ...
    getWaterCircle: function () {
      var a = new cc.Sprite(res.Circle_png);
      this.centerBg.addChild(a);
      return a;
    },
    initData: function () {
      this.needShowFlowers = [];
    },
    topLabel: null,
    levelLabel: null,
    initTopLabel: function () {
      this.initTopCount();
      var a = this.topBg.y - (this.topBg.height / 2) * this.topBg.scaleY - 20,
        b = this.topBg.x - (this.topBg.width / 2) * this.topBg.scaleX + 30,
        c = new cc.LabelTTF(this.topCount, "Verdana", 45);
      c.setColor(cc.color("#ffffff"));
      c.setAnchorPoint(cc.p(0, 0.5));
      c.enableShadow(cc.color("#000000"), cc.size(3, -3), 1);
      this.addChild(c, 5);
      c.x = b;
      c.y = a;
      c.scale = this.mapScale;
      c.setVisible(false);
      this.topLabel = c;
      a = new cc.LabelTTF(this.level, "Verdana", 47);
      a.setColor(cc.color("#ffffff"));
      a.setAnchorPoint(cc.p(0.5, 0.5));
      a.enableShadow(cc.color("#000000"), cc.size(3, -3), 1);
      this.addChild(a, 5);
      a.x = 140 / this.mapScale;
      a.y = this.topBg.y;
      a.scale = this.mapScale;
      this.levelLabel = a;
      this.refreshLevelLabel();
    },
    refreshLevelLabel: function () {
      var a = "Level: " + this.level;
      ChineseFlag && (a = "\u7b2c " + this.level + " \u5173");
      this.levelLabel.string = a;
    },
    topCount: 10,
    initTopCount: function () {
      this.topCount = 8 + 2 * this.level;
    },
    refreshTopLabel: function () {
      this.topLabel.string = this.topCount.toString();
    },
    topFlowerArr: null,
    topBaseX: null,
    topOffX: 10,
    ...
    initTop: function () {
      ...
      this.topFlowerArr = [];
      var a = this.topBg,
        b = a.x - (a.width / 2) * a.scaleX + this.itemLen + 10;
      this.topBaseX = b;
      for (
        var c = this.topOffX, d = this.topOffY, e = (this.topEndCount = 0);
        4 > e;
        e++
      ) {
        var f = new Flower();
        this.addChild(f, 5);
        f.x = this.size.width + this.itemLen + e * (this.itemLen + c);
        f.y = a.y + d;
        var g = b + e * (this.itemLen + c),
          h = f.y;
        this.topFlowerArr.push(f);
        f.opacity = 0;
        f.runAction(cc.fadeIn(0.5));
        f.baseS = f.scale;
        f.scale *= 0.85;
        g = cc.sequence(
          cc.moveTo(1.8, cc.p(g, h)).easing(cc.easeSineOut()),
          cc.callFunc(
            function () {
              MainLayer.topMoveEnd();
            },
            this,
            this
          )
    ...
    topMoveEnd: function () {
      this.topEndCount++;
      4 <= this.topEndCount && ((this.topEndCount = 0), (this.canTouch = true));
    },
    shake: function (a) {
      var b = a.scale,
        b = cc.sequence(
          cc.scaleTo(0.05, 1.2 * b, 0.9 * b),
          cc.scaleTo(0.1, 0.95 * b, 1.1 * b),
          cc.scaleTo(0.1, 1.05 * b, 0.95 * b),
          cc.scaleTo(0.1, 1 * b, 1 * b)
        );
      a.runAction(b);
    },
    itemLen: 90,
    ...
    initTile: function () {
      ...
      for (
        ...
        var c = a[b];
        this.checkAddTile(c[0], c[1]);
      }
    },
    checkAddTile: function (a, b) {
      var c = a.toString(),
        d = b.toString(),
        e = this.tileObj;
      e[c] || (e[c] = {});
      if (!e[c][d]) {
        var f = new cc.Sprite(res.FlowerBg_png);
        this.addChild(f);
        f.scale = 0.9 * this.mapScale;
        var g = this.getPosByLogicXY(c, d);
        f.setPosition(g);
        f.logicX = c;
        f.logicY = d;
        e[c][d] = {};
    ...
    getPosByLogicXY: function (a, b) {
      var c = Number(a),
        d = Number(b),
        e = this.itemLen,
        f = this.itemDisW,
        g = this.centerBg.getPosition();
      return cc.p(g.x + c * (e + f), g.y + d * (e + f));
    },
    getLogicXYByPos: function (a, b) {
      var c = this.itemLen,
        d = this.itemDisW,
        e = this.centerBg.getPosition(),
        f = Math.round((a - e.x) / (c + d)),
        c = Math.round((b - e.y) / (c + d));
      return cc.p(f, c);
    },
    btnLink: null,
    addLinkGame: function () {
      if (null != MainManager.linkData && !this.btnLink) {
        this.btnLink = new cc.MenuItemImage(
          res.btn_link_png,
          res.btn_link_png,
          this.openLinkGame.bind(this)
        );
        this.btnLink.setAnchorPoint(0, 0);
        this.btnLink.setPosition(2, this.kuangLen + 2);
        this.btnLink.scale = 0.8;
        var a;
        a = new cc.Menu(this.btnLink);
        a.setPosition(0, 0);
        this.addChild(a, 0);
      }
    },
    openLinkGame: function () {
      ...
      var a = new LinkLayer();
      this.addChild(a, 10);
      a.setData(MainManager.linkData);
    },
    bottomEdgeY: 0,
    AD_H: 55,
    initBottomEdgeY: function () {
      if ("undefined" != typeof sys_activityID && "" != sys_activityID)
        this.bottomEdgeY = 1;
      else {
        var a = navigator.userAgent.toLowerCase();
        0 < a.indexOf("twitter") &&
          (IOS_FLAG && (this.AD_H += 107), (TwitterFlag = true));
        0 < a.indexOf("fbav") &&
          (IOS_FLAG && (this.AD_H += 107), (FaceBookFlag = true));
    ...
    initSystem: function () {
      var a = cc.sys;
      IOS_FLAG = a.os === a.OS_IOS || a.os === a.OS_OSX ? true : false;
      this.mapScale = 0.7 + (this.size.height / 1280) * 0.3;
      this.itemLen *= this.mapScale;
    },
    topY: null,
    bottomY: null,
    bgColor: null,
    ...
    initBg: function () {
      ...
      var a = new cc.Sprite(res.TopBg_png),
        b = new cc.Sprite(res.CenterBg_png);
      this.addChild(a);
      this.addChild(b);
      this.topBg = a;
      this.centerBg = b;
      b.scale = 1.08 * this.mapScale;
      a.scale = this.mapScale;
      var c = 40 * this.mapScale;
      b.x = this.size.width / 2;
      b.y = this.size.height / 2 - (a.height * a.scaleY + c) / 2;
      a.x = this.size.width - (a.width / 2) * a.scaleX;
      a.y = b.y + (b.height / 2) * b.scaleY + c + (a.height / 2) * a.scaleY;
    },
    bgColorArr: "#2babca #e3242e #28324a #c88fd5 #982a2a #66ac16 #1062bd #8f9cdd #e12eae #1ac7a9 #dcaa5d #dcaa5d #e9642b #5a4553 #3e8c7e".split(
      " "
    ),
    getRandomBgColoc: function () {
      var a = Math.floor(Math.random() * this.bgColorArr.length);
      return this.bgColorArr[a];
    },
    scoreTf: null,
    score: 0,
    initScore: function () {
      var a = new cc.LabelAtlas("0", res.Num_png, 43, 56, "0");
      this.addChild(a);
      a.attr({
        x: this.size.width / 2,
        y: this.kuangLen + 10,
    ...
    addScore1: function (a) {
      ...
      this.playSubScore = Math.ceil(
        (this.playScoreTarget - this.playScore) / 20
      );
      this.schedule(this.scoreUpdateFunc, 0.05);
    },
    scoreUpdateFunc: function () {
      this.playScore += this.playSubScore;
      this.playScore >= this.playScoreTarget
        ? (this.unschedule(this.scoreUpdateFunc),
          (this.scoreTf.string = this.score.toString()))
        : (this.scoreTf.string = this.playScore.toString());
    },
    playGame: function () {
    ...
    onTouchBegan: function (a, b) {
      var c = b.getCurrentTarget(),
        d = a.getLocation();
      if (
        false == MainManager.clickLinkBool &&
        (c.addLink.touchFlower(a), true == MainManager.returnBool)
      )
        return;
      if (d.y < c.bottomEdgeY)
        return (
          (document.documentElement.scrollTop = document.body.scrollTop = 0),
          false
        );
      if (c.canTouch && !c.gameEndFlag) return c.mapClick(d), true;
    },
    onTouchMoved: function (a, b) {
      if (b.getCurrentTarget().touchedCircle) return a.getLocation(), true;
    },
    onTouchEnded: function (a, b) {
      var c = b.getCurrentTarget();
      c.canTouch = true;
      if (c.touchedCircle) return a.getLocation(), true;
    },
    mapClick: function (a) {
      var b = this.tileObj,
        c = this.getLogicXYByPos(a.x, a.y);
      a = c.x.toString();
      c = c.y.toString();
      b[a] &&
        b[a][c] &&
        !b[a][c].building &&
        ((this.canTouch = false),
        this.cleanPopDelayCount(),
        this.curFlowerMove(b[a][c].tileBg),
        this.createNewFlower(),
        this.topFlowerMove(),
        this.topCount--,
        this.refreshTopLabel());
    },
    cleanPopDelayCount: function () {
      var a = this.tileObj,
        b;
      for (b in a)
        for (var c in a[b]) {
          var d = a[b][c].building;
          d && (d.popDelayCount = 0);
        }
    },
    createNewFlower: function () {
      if (!(4 >= this.topCount)) {
        var a = this.topFlowerArr,
          b = this.topOffX,
          c = new Flower();
        this.addChild(c, 5);
        c.x = a[a.length - 1].x + this.itemLen + b;
        c.y = a[a.length - 1].y;
        c.baseS = c.scale;
        c.scale *= 0.85;
        a.push(c);
    ...
    topFlowerMove: function () {
      for (
        var a = this.topBaseX, b = this.topFlowerArr, c = 0;
        c < b.length;
        c++
      ) {
        var d = b[c],
          e = cc.moveTo(0.5, cc.p(a + c * (this.itemLen + this.topOffX), d.y));
        d.runAction(e);
      }
    },
    curFlower: null,
    curFlowerMove: function (a) {
      SoundUtile.playMusic("res/music/move");
      var b = this.topFlowerArr.shift();
      b.setLocalZOrder(6);
      this.curFlower = b;
      var c = 0.2 + cc.pDistance(b.getPosition(), a.getPosition()) / 1200;
      a = cc.sequence(
        cc.spawn(cc.moveTo(c, a.getPosition()), cc.scaleTo(c, b.baseS)),
        cc.callFunc(
          function (a) {
            MainLayer.addItemOnTile(a);
            a.setLocalZOrder(5);
            MainLayer.checkCanPop() || (this.shake(a), this.checkNext());
          },
          this,
          this
        )
    ...
    addItemOnTile: function (a) {
      ...
      a.logicX = d;
      a.logicY = e;
      b = this.getPosByLogicXY(c.x, c.y);
      a.setPosition(b);
    },
    removeItemOnTile: function (a) {
      this.tileObj[a.logicX][a.logicY].building = null;
    },
    popRowArr: null,
    popColArr: null,
    popArr: null,
    checkCanPop: function (a, b) {
      a || (a = this.curFlower);
      this.popRowArr = [a];
      this.checkRowCanPop(a);
      this.popColArr = [a];
      this.checkColCanPop(a);
      return 3 <= this.popRowArr.length && 3 <= this.popColArr.length
        ? (this.popColArr.shift(),
          (this.popArr = this.popRowArr.concat(this.popColArr)),
          b || this.popStart(),
          true)
        : 3 <= this.popRowArr.length
        ? ((this.popArr = this.popRowArr), b || this.popStart(), true)
        : 3 <= this.popColArr.length
        ? ((this.popArr = this.popColArr), b || this.popStart(), true)
        : false;
    },
    popStart: function () {
      this.needShowFlowers = [];
      this.popCount = 0;
      for (var a = this.popArr, b = 0; b < a.length; b++) a[b].pop();
    },
    popCount: 0,
    popEnd: function (a) {
      this.popCount++;
      this.popCount >= this.popArr.length && this.flowering();
    },
    floweringCount: 0,
    flowering: function () {
      var a = this.needShowFlowers;
      if (0 >= a.length) this.checkNext();
      else
        for (var b = (this.floweringCount = 0); b < a.length; b++)
          a[b].showFlowering();
    },
    floweringEnd: function (a) {
      this.floweringCount++;
      this.floweringCount >= this.needShowFlowers.length &&
        (cc.log("in floweringEnd"), this.checkNeedShowCanPop());
    },
    totalPopArr: null,
    checkNeedShowCanPop: function () {
      this.totalPopArr = [];
      var a = this.needShowFlowers;
      if (0 < a.length)
        for (var b = 0; b < a.length; b++)
          this.checkCanPop(a[b], true) &&
            (this.totalPopArr = this.totalPopArr.concat(this.popArr));
      if (0 < this.totalPopArr.length) {
        for (b = 0; b < a.length; b++) a[b].popDelayCount = 0;
        this.popArr = this.totalPopArr;
        this.popStart();
      } else this.checkNext();
    },
    checkRowCanPop: function (a) {
      for (
        var b = Number(a.logicX),
          c = Number(a.logicY),
          d,
          e,
          f = true,
        ...
        if (f)
          if (
            ((d = b - h),
            (e = c),
            (d = this.getFlowerByLogicP(d, e)) && d.edgeId == a.edgeId)
          ) {
            if (!d.popDelayCount || d.popDelayCount > h) d.popDelayCount = h;
            this.popRowArr.push(d);
          } else f = false;
        if (g)
          if (
            ((d = b + h),
    ...
    getFlowerByLogicP: function (a, b) {
      var c = this.tileObj,
        d = a.toString(),
        e = b.toString();
      return c[d] && (c = c[d][e]) && c.building ? c.building : null;
    },
    scoreColorArr: "#5fba1a #e21b65 #6b00c5 #0588a8 #0588a8 #e30c0c".split(" "),
    showScore: function (a, b) {
      var c = a.getPosition(),
        d = this.scoreColorArr[a.colorId - 1],
        e = new ccui.Text();
      e.setPosition(c);
      e.enableOutline(cc.color(d), 3);
      e.setFontSize(55);
      e.setString("+" + b.toString());
      e.color = cc.color("#ffffff");
      this.addChild(e, 8);
      c = cc.sequence(
        cc.moveBy(0.4, cc.p(0, 100)).easing(cc.easeCircleActionOut()),
        cc.spawn(
          cc.moveBy(0.4, cc.p(0, -100)).easing(cc.easeCircleActionIn()),
          cc.fadeOut(0.4).easing(cc.easeCircleActionIn())
        ),
        cc.callFunc(
          function (a, b) {
            a.removeFromParent();
    ...
    update: function (a) {},
    showParticle: function (a) {
      SoundUtile.playMusic("res/music/pop");
      for (var b = a.getPosition(), c = 0; 50 > c; c++) {
        var d = false,
          e = "res/game/flower_piece/" + a.edgeId + ".png";
        0.2 > Math.random() && ((d = true), (e = res.Dot_png));
        e = new cc.Sprite(e);
        this.addChild(e, 8);
        e.setPosition(b);
        e.rotation = 360 * Math.random();
        var f = 360 * Math.random(),
          g = 50 + 90 * Math.random();
        d && (g = 30 + 130 * Math.random());
        f = MyUtil.getPointByCPAndAngleAndLen(b, f, g);
        d = cc.moveTo(0.15, f);
        Math.random();
        g = (f.y - b.y) / 2;
        0 > g && (g = 0);
        f = cc.jumpBy(4.2, cc.p(1.2 * (f.x - b.x) * this.mapScale, -600), 0, 1);
        g = cc.scaleTo(0.6, 0).easing(cc.easeQuadraticActionIn());
        f = cc.spawn(f, g);
        d = cc.sequence(
          d,
          f,
    ...
    needShowFlowers: null,
    mapAddFlower: function (a) {
      var b = a.centerId,
        b = new Flower(b, b);
      this.addChild(b, 5);
      ...
      b.logicX = a.logicX;
      b.logicY = a.logicY;
      b.setEdgeResByStep(1);
      b.shadowSpr.setVisible(false);
      this.needShowFlowers.push(b);
    },
    checkNext: function () {
      cc.log(" in checkNext");
      this.checkGameEnd();
      !this.gameEndFlag &&
        0 >= this.topCount &&
        ((this.canTouch = false), this.enterNext());
    },
    enterNext: function () {
      SoundUtile.playMusic("res/music/next");
      this.levelUp();
      this.initTile();
      this.initTop();
      this.initTopCount();
    ...
    gameEnd: function () {
      ...
      MainManager.clickLinkBool = true;
      score_submit(this.score, 1);
      cc.log("gameEnd");
      SoundUtile.playMusic("res/music/end");
      var a = cc.director.getWinSize().width,
        b = cc.director.getWinSize().height;
      cc.log("langNumType", langNumType);
      this.gameEndSpr = UIToolManager.getSprite(
        res["gameOver" + langNumType + "_png"],
        0.5,
        0.5,
        a / 2,
        b / 2 + 100
      );
      this.addChild(this.gameEndSpr, 21);
      this.gameEndSpr.setOpacity(0);
      this.gameEndSpr.runAction(
        cc.sequence(
          cc.delayTime(0.2),
          cc.spawn(cc.fadeIn(1), cc.moveBy(1, 0, -50)),
          cc.delayTime(0.3),
          cc.callFunc(this.gameEndCallBack.bind(this, this))
        )
      );
      this.textEnd = UIToolManager.getLabelTTF(
        langNumText,
        35,
        0.5,
        1,
        a / 2,
        this.gameEndSpr.y - 80,
        cc.color("#ffffff")
      );
      this.addChild(this.textEnd, 21);
      this.textEnd.setOpacity(0);
      this.textEnd.runAction(
        cc.sequence(
          cc.delayTime(0.2),
          cc.spawn(cc.fadeIn(1), cc.moveBy(1, 0, -50)),
          cc.delayTime(0.3)
    ...
    gameEnd1: function () {
      this.unscheduleUpdate();
      endGameStart = resEndComplete = adEndComplete = false;
      this._coverBg = new cc.LayerColor(cc.color("#363636"));
      this.addChild(this._coverBg, 20);
      this.gameEndSpr.setColor(cc.color("#404040"));
      this.textEnd.setColor(cc.color("#404040"));
      if (0 == _lastAdTime || 0 < _AdLayer.getInterval())
        if (true == window.navigator.onLine) {
          var a = MainManager.adShowAfter;
          (a = null == a || void 0 == a ? true : MainManager.adShowAfter)
            ? ((this.needShow = true), showMyAds())
            : (this.needShow = false);
        } else
          (this.needShow = null), LayerManager.showGameEndLayer("p125_score");
      null != this.needShow &&
        (this.needShow
          ? (cc.log("pre", preloader),
            void 0 == preloader &&
              (LayerManager.showGameEndLayer("p125_score"), cc.log("pre1")),
            (resEndComplete = true),
            adEndComplete &&
              resEndComplete &&
              (LayerManager.showGameEndLayer("p125_score"), cc.log("pre2")))
          : (cc.log("pre3"), LayerManager.showGameEndLayer("p125_score")));
    },
    setGameScore: function () {
      var a = this.score,
        b = cc.sys.localStorage.getItem("p92_score");
      a >= b && ((b = a), cc.sys.localStorage.setItem("p92_score", b));
      this.endLayer.SetMaxScore(b);
      this.endLayer.showScore(a);
    },
    gameLose: function () {
      ChineseFlag &&
        (this.endLayer.SetTipLabel(
          "\u83b7\u5f97\u5956\u54c1\u8fd8\u6709\u4e00\u6b65\u4e4b\u9065\uff01"
        ),
        this.endLayer.SetChouJiangVisible(false));
    },
  }),
  MyUtil = {
    getAngle: function (a, b, c, d) {
      var e = Math.abs(a - c),
        f = Math.abs(b - d),
        e = Math.sqrt(Math.pow(e, 2) + Math.pow(f, 2)),
        f = Math.acos(f / e),
        f = 180 / (Math.PI / f);
      b > d && (f = 180 - f);
      a > c && (f *= -1);
...
var Flower = cc.Sprite.extend({
    ...
    edgeId: null,
    initData: function () {
      this.edgeId || (this.edgeId = this.getRandomId());
      this.centerId || (this.centerId = this.getRandomId(true));
    },
    getRandomId: function (a) {
      var b = MainLayer.level;
      if (a && 50 > b && Math.random() > 0.5 + (b / 50) * 0.5)
        return this.edgeId;
      for (var c = (a = 1); 0 < b; ) {
        b -= c;
        if (0 >= b) break;
      ...
      5 < a && (a = 5);
      return Math.ceil(Math.random() * (a + 2));
    },
    flowerSpr: null,
    shadowSpr: null,
    centerSpr: null,
    ...
    sprAnchorY: 0.53,
    initView: function () {
      this.scale = MainLayer.itemLen / 100;
      this.setCascadeOpacityEnabled(true);
      var a = new cc.Sprite("res/game/shadow/4.png");
      this.addChild(a);
      a.anchorY = this.sprAnchorY;
      this.shadowSpr = a;
      a = new cc.Node();
      this.addChild(a, 1);
      this.flowerSpr = a;
      a.setCascadeOpacityEnabled(true);
      var b = new cc.Sprite("res/game/flower_edge/" + this.edgeId + "/4.png");
      a.addChild(b, 1);
      b.anchorY = this.sprAnchorY;
      this.edgeSpr = b;
      b = new cc.Sprite("res/game/flower_center/" + this.centerId + "/1.png");
      a.addChild(b, 2);
      b.anchorY = this.sprAnchorY;
      this.centerSpr = b;
    },
    showJump: function (a) {
      this.schedule(this.updateShadow);
      var b = this.flowerSpr;
      this.shadowSpr.opacity = 100;
      var c = 50 + 100 * a;
      a = cc.sequence(
        cc.jumpTo(a, cc.p(0, 0), c, 1),
        cc.callFunc(
          function (a, b) {
            b.unschedule(b.updateShadow);
            b.shadowSpr.opacity = 255;
          },
          this,
          this
        )
    ...
    updateShadow: function () {
      cc.log("in updateShadow");
      this.shadowSpr.scale = (800 - this.flowerSpr.y) / 800;
    },
    popFlag: false,
    pop: function () {
      if (this.popFlag) MainLayer.popEnd(this);
      else {
        this.popFlag = true;
        var a = 0;
        this.popDelayCount && (a = this.popDelayCount);
        a = cc.sequence(
          cc.delayTime(0.48 * a),
          cc.scaleTo(0.06, 0.6),
          cc.callFunc(
          ...
          cc.scaleTo(0.12 - 0.02, 1.2).easing(cc.easeSineOut()),
          cc.scaleTo(0.12, 0.9).easing(cc.easeSineInOut()),
          cc.scaleTo(0.12, 1).easing(cc.easeSineIn()),
          cc.delayTime(0.024),
          cc.scaleTo(0.06, 0.6),
          cc.callFunc(
            function (a, c) {
          ...
          cc.scaleTo(0.12 - 0.02, 0.95).easing(cc.easeSineOut()),
          cc.scaleTo(0.12, 0.75).easing(cc.easeSineInOut()),
          cc.scaleTo(0.12, 0.85).easing(cc.easeSineIn()),
          cc.delayTime(0.024),
          cc.scaleTo(0.06, 0.5),
          cc.callFunc(
            function (a, c) {
              MainLayer.showParticle(c);
              c.popChange3();
            },
            this,
            this
    ...
    popChange1: function () {
      var a = "res/game/flower_edge/" + this.edgeId + "/5.png";
      this.centerSpr.initWithFile(
        "res/game/flower_center/" + this.centerId + "/2.png"
      );
      this.edgeSpr.initWithFile(a);
      this.step = 5;
      this.refreshShadow();
    },
    popChange2: function () {
      var a = "res/game/flower_edge/" + this.edgeId + "/6.png";
      this.centerSpr.initWithFile(
        "res/game/flower_center/" + this.centerId + "/3.png"
      );
      this.edgeSpr.initWithFile(a);
      this.step = 6;
      this.refreshShadow();
    ...
    popChange3: function () {
      this.centerId == this.edgeId
        ? MainLayer.removeItemOnTile(this)
        : MainLayer.mapAddFlower(this);
      this.removeFromParent();
      MainLayer.popEnd(this);
    },
    showFlowering: function () {
      var a = new Flower(this.centerId, this.edgeId);
      a.setEdgeResByStep(2);
      a.shadowSpr.setVisible(false);
      this.addChild(a, 5);
      a.anchorY = this.sprAnchorY;
      a.opacity = 0;
      a.scale = 1;
      this.setEdgeResByStep(1, true);
      this.shadowSpr.setVisible(false);
      var b = cc.sequence(
        cc.fadeIn(0.08).easing(cc.easeQuadraticActionIn()),
        cc.callFunc(
          function (a, b) {
            b.setEdgeResByStep(2, true);
            a.setEdgeResByStep(3);
            a.opacity = 0;
          },
          this,
          this
        ...
        cc.callFunc(
          function (a, b) {
            b.setEdgeResByStep(3, true);
            a.setEdgeResByStep(4);
            a.opacity = 0;
          },
          this,
          this
        ...
        cc.fadeIn(0.08).easing(cc.easeQuadraticActionIn()),
        cc.scaleTo(0.08, 1.15, 1.15),
        cc.scaleTo(0.12, 0.9, 0.9),
        cc.scaleTo(0.12, 1.05, 1.05),
        cc.scaleTo(0.12, 1, 1),
        cc.callFunc(
          function (a, b) {
            b.setEdgeResByStep(4, true);
            a.removeFromParent();
            b.showShadowAnima();
            MainLayer.addItemOnTile(b);
            MainLayer.floweringEnd(b);
          },
          this,
          this
        )
    ...
    step: 1,
    setEdgeResByStep: function (a, b) {
      this.edgeSpr.initWithFile(
        "res/game/flower_edge/" + this.edgeId + "/" + a + ".png"
      );
      this.step = a;
      var c = a - 3;
      0 >= c
        ? this.centerSpr.setVisible(false)
        : (this.centerSpr.setVisible(true),
          this.centerSpr.initWithFile(
            "res/game/flower_center/" + this.centerId + "/" + c + ".png"
          ));
    },
    refreshShadow: function () {
      this.shadowSpr.initWithFile("res/game/shadow/" + this.step + ".png");
    },
    showShadowAnima: function () {
      this.shadowSpr.setVisible(false);
      this.refreshShadow();
      this.shadowSpr.opacity = 0;
      this.shadowSpr.setVisible(true);
      this.shadowSpr.runAction(cc.fadeIn(1).easing(cc.easeSineIn()));
    },
  }),
  linkGame = cc.Layer.extend({
    _imageArr: [],
    _numAdd: 0,
    _touchLinkBool: false,
    _picXNum: 0,
    _picYNum: 0,
    _picWidth: 0,
    _picHeight: 0,
    ctor: function () {
      ...
      this._super();
      this._imageArr = [];
      this._touchLinkBool = false;
      this._picHeight = this._picWidth = this._picYNum = this._picXNum = 0;
      null != MainManager.recGameData &&
        (this.loadUrlImage2(MainManager.recGameimg1),
        this.loadUrlImage2(MainManager.recGameimg2));
    },
    loadUrlImage2: function (a) {
      null != a &&
        void 0 != a &&
        "" != a &&
        cc.loader.loadImg(
            ...
            if (a) cc.log(a);
              ...
              var e = d.width / 2 + 8,
                f =
                  ...
                  d.getBoundingBox().height / 2 -
                  8;
              null != MainManager.recGamePos &&
                "" != MainManager.recGamePos &&
                (1 == MainManager.recGamePos
                  ? ((e = d.getBoundingBox().width / 2 + 8),
                    (f =
                      cc.director.getWinSize().height -
                      d.getBoundingBox().height / 2 -
                      8))
                  : 2 == MainManager.recGamePos
                  ? ((e = CW - d.getBoundingBox().width / 2 - 8),
                    (f =
                      cc.director.getWinSize().height -
                      d.getBoundingBox().height / 2 -
                      8))
                  : 3 == MainManager.recGamePos
                  ? ((e = CW - d.getBoundingBox().width / 2 - 8),
                    (f = d.getBoundingBox().height / 2 + 8))
                  : 4 == MainManager.recGamePos &&
                    ((e = d.getBoundingBox().width / 2 + 8),
                    (f = d.getBoundingBox().height / 2 + 8)));
              linkSelf._picXNum = e;
              linkSelf._picYNum = f;
              linkSelf._picWidth = d.getBoundingBox().width;
              linkSelf._picHeight = d.getBoundingBox().height;
              d.setPosition(e, f);
              linkSelf.addChild(d, 2);
              d.setVisible(false);
              linkSelf._imageArr.push(d);
              linkSelf._numAdd++;
              2 <= linkSelf._numAdd &&
                (cc.log(
                  "imageLength",
                  linkSelf._imageArr,
                  linkSelf._imageArr.length
                ),
                linkSelf.showLinkPic());
            }
          }
        );
    },
    showLinkPic: function () {
      this._touchLinkBool = true;
      var a = 0,
        b = 0,
        a = null != MainManager.recGameDelPau ? MainManager.recGameDelPau : 6;
      cc.log("dMainManager.recGameDelPer", MainManager.recGameDelPer);
      b = null != MainManager.recGameDelPer ? MainManager.recGameDelPer : 0.7;
      cc.log("ddelayPerdelayPerdelayPerdelayPere", b, a);
      this._imageArr[0].setVisible(true);
        ...
        cc.repeatForever(
          cc.sequence(
            ...
            cc.callFunc(function () {
              ...
              this._imageArr[0].setVisible(false);
              this._imageArr[1].setVisible(true);
            }, this),
            cc.delayTime(a),
            cc.callFunc(function () {
              this.flowerAction(this._imageArr[1], b);
            }, this),
            cc.delayTime(b),
            cc.callFunc(function () {
              this._imageArr[1].setVisible(false);
              this._imageArr[0].setVisible(true);
            }, this)
          )
        )
    ...
    createListener1: function () {
      this.lis2 = cc.EventListener.create({
        event: cc.EventListener.TOUCH_ONE_BY_ONE,
        swallowTouches: true,
        onTouchBegan: this.onTouchBegan.bind(this),
        onTouchEnded: this.onTouchEnded.bind(this),
      });
      cc.eventManager.addListener(this.lis2, this);
    },
    touchFlower: function (a) {
      if (this._touchLinkBool) {
        var b = a.getLocation();
        a = Math.abs(b.x - linkSelf._picXNum);
        b = Math.abs(b.y - linkSelf._picYNum);
        if (
          a <= this._picWidth / 2 + 6 &&
          b <= this._picHeight / 2 + 6 &&
          null != MainManager.recGameUrl &&
          "" != MainManager.recGameUrl
        ) {
          cc.log("okTouch");
          MainManager.returnBool = true;
          for (a = 0; a < this._imageArr.length; a++)
            linkSelf._imageArr[a].stopAllActions(),
              linkSelf._imageArr[a].setRotation(0),
              linkSelf._imageArr[a].runAction(
                cc.sequence(
                  cc.scaleTo(0.13, 1.13, 1.13),
                  cc.scaleTo(0.13, 1, 1)
                )
              );
          linkSelf.runAction(
            cc.sequence(
              cc.delayTime(0.27),
              cc.callFunc(function () {
                window.location.href = MainManager.recGameUrl;
              })
            )
          );
        }
...
var EndLayer = cc.Layer.extend({
  ...
  ctor: function (a) {
    ...
    this._shareLabel.setVisible(false);
    ...
    this.chouJiangItem = new cc.MenuItemImage(
      res.ChouJiangBtn_png,
      res.ChouJiangBtn_png,
      function () {
        "" == sys_activityID
          ? window.alert(
          ...
          : (window.location.href =
              "http://www.wesane.com/admin.php/Activityshow/activityResult/activityId/" +
              sys_activityID);
      },
      this
    );
    ...
    var c = new cc.MenuItemSprite(
      new cc.Sprite(res.Share_png),
      new cc.Sprite(res.Share_png),
      function () {
        this._shareLabel.setVisible(true);
      },
      this
    );
    c.attr({
    ...
    this.moreGameItem = new cc.MenuItemImage(
      res.MoreGame_png,
      res.MoreGame_png,
      function () {
        window.location.href = sys_is_weixin
    ...
    "" == sys_activityID
      ? ((a = new cc.Menu(this.moreGameItem, b, c)),
        this.tipLabel.setVisible(false))
      : (a = new cc.Menu(this.chouJiangItem, b, c));
    a.x = 0;
    a.y = 0;
    this.addChild(a);
  },
  ...
  SetMaxScore: function (a) {
    ...
    score_share(
      LanguageManager.getText("game_name") +
        "\uff0c\u6211\u7684\u6700\u597d\u6210\u7ee9\uff1a" +
        a +
        "\u5206\uff0c\u4f60\u5462\uff1f"
    );
  ...
  SetChouJiangVisible: function (a) {
    ...
    a || this.tipLabel.setVisible(true);
    "" == sys_activityID &&
      (this.moreGameItem.setVisible(true), this.tipLabel.setVisible(false));
  },
});
var EndLayerEnglish = cc.Layer.extend({
  ...
  ctor: function () {
    ...
    var a = cc.director.getVisibleSize(),
      b = "#3698C5",
      b = null == MainManager.endLayCol ? "#3698C5" : MainManager.endLayCol,
      b = new cc.LayerColor(cc.color(cc.color(b), setO));
    this.addChild(b);
    this._shareLabel = new cc.Sprite(res.fenxiang2_png);
    this._shareLabel.setAnchorPoint(1, 1);
    this._shareLabel.x = a.width - 25;
    this._shareLabel.y = a.height - 20;
    b = new cc.LabelTTF("\u70b9\u51fb\u6652\u6210\u7ee9", "Arial", 30);
    ...
    this.tipLabel.x = a.width / 2;
    this.tipLabel.y = a.height / 2 + 85;
    this.addChild(this.tipLabel);
  },
  clickMenuBtnS: function (a) {
    var b = cc.director.getVisibleSize(),
      c = "More Game",
      d = "Play Again";
    null != MainManager.moreGameText &&
      "" != MainManager.moreGameText &&
      (c = MainManager.moreGameText);
    null != MainManager.playAgainText &&
      "" != MainManager.playAgainText &&
      (d = MainManager.playAgainText);
    this.btnAgain = this.getTxtButton(
      this,
      res.button1_png,
      this.onAgainClick.bind(this),
      d,
      b.width / 2 - 150,
      a - 140,
      0.6,
    ...
    var e = this.returnFocusNum(),
      d = e[0],
      f = e[1],
      e = e[2],
      g = 0;
    null != MainManager.ranLinkData &&
      null != MainManager.ranLinkData.gameList &&
      ((d = 100),
      (g = f = MainManager.ranLinkUrl()),
      (f = MainManager.ranLinkData.gameList[f].gameName),
      cc.log("focunsTT", f));
    cc.log("focunsTT2", f);
    this.btnGuanzhu = this.getTxtButton(
      this,
      res.button1_png,
      this.onFocusClick.bind(this, d, g),
      f,
      b.width / 2 + 150,
      a - 140,
      0.6,
    ...
    this.btnMore = this.getTxtButton(
      this,
      res.btn_comMore1_png,
      this.onMoreClick.bind(this),
      c,
      b.width / 2,
      a,
      1,
    ...
    a = "#f9e81e";
    a = null == MainManager.moreBtnBgCol ? "#f9e81e" : MainManager.moreBtnBgCol;
    this.btnMore.setColor(cc.color(a));
    this.btnMore1 = new cc.Sprite(res.btn_comMore2_png);
    this.btnMore1.x = this.btnMore.x;
    this.btnMore1.y = this.btnMore.y;
    this.btnMore1.setScale(1, 0.9);
    this.addChild(this.btnMore1, 2);
    a = new cc.Menu(this.btnAgain, this.btnMore, this.btnGuanzhu);
    a.x = 0;
    a.y = 0;
    this.addChild(a);
  },
  onAgainClick: function () {
    this.btnAgain.runAction(
      cc.sequence(
        cc.scaleTo(0.05, 0.51, 0.765),
        cc.scaleTo(0.05, 0.6, 0.9),
        cc.delayTime(0.1),
        cc.callFunc(function () {
          cc.director.runScene(new GameScene());
          cc.director.resume();
    ...
    this._textArr[0].runAction(
      cc.sequence(cc.scaleTo(0.05, 0.85, 0.85), cc.scaleTo(0.05, 1, 1))
    );
  },
  onMoreClick: function () {
    this.btnMore.runAction(
      cc.sequence(
        cc.scaleTo(0.05, 0.85, 0.765),
        cc.scaleTo(0.05, 1, 0.9),
        cc.delayTime(0.03),
        cc.callFunc(function () {
          var a = getWebSiteUrl();
          MainManager.gotoMoreGame(a);
        })
      )
    );
    this.btnMore1.runAction(
      cc.sequence(cc.scaleTo(0.05, 0.85, 0.765), cc.scaleTo(0.05, 1, 0.9))
    );
    this._textArr[2].runAction(
      cc.sequence(cc.scaleTo(0.05, 0.85, 0.85), cc.scaleTo(0.05, 1, 1))
    );
  },
  onFocusClick: function (a, b) {
    this.btnGuanzhu.runAction(
      cc.sequence(
        cc.scaleTo(0.05, 0.51, 0.765),
        cc.scaleTo(0.05, 0.6, 0.9),
        cc.delayTime(0.1),
        cc.callFunc(this.onFocusClick1.bind(this, a, b))
      )
    );
    this._textArr[1].runAction(
      cc.sequence(cc.scaleTo(0.05, 0.85, 0.85), cc.scaleTo(0.05, 1, 1))
    );
  },
  onFocusClick1: function (a, b) {
    1 == a
      ? (window.location.href =
          "http://mp.weixin.qq.com/s?__biz\x3dMzIzNTUzNTUwNA\x3d\x3d\x26mid\x3d2247483663\x26idx\x3d1\x26sn\x3d666fac9f08702b8594c6e608832f1b4b\x26scene\x3d0#wechat_redirect")
      : 2 == a
      ? (window.location.href = "http://group.kakao.com/i/79pSP7a2xF")
      : 3 == a
      ? (window.location.href =
          "http://mp.weixin.qq.com/s?__biz\x3dMzIzNTUzNTUwNA\x3d\x3d\x26mid\x3d2247483663\x26idx\x3d1\x26sn\x3d666fac9f08702b8594c6e608832f1b4b\x26scene\x3d0#wechat_redirect")
      : 4 != a &&
        (window.location.href =
          5 == a
            ? "http://g.fromgame.com/game/13"
            : 6 == a
            ? "http://g.fromgame.com/game/53"
            : MainManager.ranLinkData.gameList[b].gameUrl);
  },
  returnFocusNum: function () {
    var a = [],
      b = 0,
      c = null,
      d = 0,
    ...
    0 < b.indexOf("micromessenger")
      ? 3 == MainManager.randomInt(1, 2)
        ? ((b = 1), (c = "Focus WeChat"), (d = 5))
        : ((b = 6), (c = "Thousand Flower"), (d = 1))
      : (0 < b.indexOf("kakaotalk") || b.indexOf("line"),
        (b = MainManager.randomInt(5, 6)),
        (d = 1),
        (c = 5 == b ? "Eliminate Star" : "Thousand Flower"));
    a.push(b, c, d);
    return a;
  },
  judgeIcon: function (a, b, c) {
    5 > a &&
      ((this.logoSpr = new cc.Sprite(res["icon" + a + "_png"])),
      (this.logoSpr.x = b + 65),
      (this.logoSpr.y = c),
      this.logoSpr.setScale(0.45),
      this.addChild(this.logoSpr, 10));
  },
  getTxtButton: function (a, b, c, d, e, f, g, h, k) {
    b = new cc.MenuItemImage(b, b, c);
    b.setPosition(e, f);
    if (null != d) {
      var m = 0;
      c = 0;
      5 == k
        ...
        ? ((m = 30), (c = 0))
        : 10 == k && ((m = 43), (c = 0));
      m = UIToolManager.getLabelTTF2("" + d, m, 0.5, 0.5, e + c, f);
      a.addChild(m, 3);
      10 == k &&
        ((a = "#4f373b"),
        (a =
          null == MainManager.moreBtnTextCol
            ? "#4f373b"
            : MainManager.moreBtnTextCol),
        m.setColor(cc.color(a)));
    }
    this._textArr.push(m);
    null != g && null != h && b.setScale(g, h);
    return b;
  },
  ...
  showScoreBg: function (a) {
    var b = UIToolManager.getSprite(
      res.scoreBg_png,
      0.5,
      0.5,
      CW / 2,
      cc.director.getWinSize().height - 175
    );
    this.addChild(b);
    this.scoreBg = b;
    b.setScale(0.85);
    a = UIToolManager.getLabelTTF(
      a.toString(),
      10 > a ? 48 : 100 > a ? 45 : 1e3 > a ? 42 : 1e4 > a ? 40 : 37,
      0.5,
      0.5,
      CW / 2,
      b.y,
  ...
  showScore: function (a) {
    ...
    var c = "\u300c" + LanguageManager.getText("game_name") + "\u300d",
      d =
        "I'm awesome\uff0cin" +
        c +
    ...
    a >= game_max_score
      ? (d =
          ...
          "got " +
          a +
          " score\uff0cdefeating all players worldwide, waiting for you to fight\uff01")
      : 0 < a && 600 >= a
      ? (d = "I am in" + c + "got " + a + " score\uff0creally great\uff01")
      : 600 < a && 2e3 >= a
      ? (d = "I am int" + c + "got " + a + " score\uff0creally great\uff01")
      : 2e3 < a && 3e3 >= a
      ? (d =
          "I am in" +
          c +
      ...
      ? (d =
          ...
          "got " +
          a +
          " score\uff0cbeating out 99% person\uff0cgreat\uff01")
      : 8e3 < a &&
        a < game_max_score &&
        ((d = 20 - Math.ceil((17 * (a - 8e3)) / (game_max_score - 8e3))),
        (d =
          "I am in" +
          c +
          "got " +
    ...
    null != endShowText &&
      ...
      null != MainManager.playAgainText &&
      "" != MainManager.playAgainText &&
      (d = endShowText.content);
    this.tipLabel0 = new cc.LabelTTF(d, "Arial", 42, cc.TEXT_ALIGNMENT_LEFT);
    c = Math.ceil(this.tipLabel0.width / 600) + 1;
    this.tipLabel = new cc.LabelTTF(
      d,
      "Arial",
      42,
    ...
    this.tipLabel.y =
      this.scoreBg.y - this.scoreBg.getBoundingBox().height / 2 - 30;
    this.addChild(this.tipLabel);
    cc.log("d,", c);
    b =
      this.scoreBg.y - this.scoreBg.getBoundingBox().height - 42 - 15 - 42 * c;
    this.clickMenuBtnS(b);
...
var GameEndLayer2 = cc.Layer.extend({
  ...
  ctor: function () {
    ...
    var a = cc.director.getVisibleSize(),
      b = "#3698C5",
      b = null == MainManager.endLayCol ? "#3698C5" : MainManager.endLayCol,
      b = new cc.LayerColor(cc.color(cc.color(b), 255));
    this.addChild(b);
    this._shareLabel = new cc.Sprite(res.fenxiang2_png);
    this._shareLabel.setAnchorPoint(1, 1);
    this._shareLabel.x = a.width - 25;
  ...
  onFocusClick1: function (a, b) {
    1 == a
      ...
      : 4 != a &&
        (window.location.href =
          5 == a
            ? "http://g.regogame.com/game/2/"
            : 6 == a
            ? "http://g.regogame.com/game/3/"
            : MainManager.ranLinkData.gameList[b].gameUrl);
  },
  returnFocusNum: function () {
    var a = [],
      ...
      b = navigator.userAgent.toLowerCase();
    0 < b.indexOf("micromessenger")
      ? 1 == MainManager.randomInt(1, 2)
        ? ((b = 1), (c = "\u5173\u6ce8\u5fae\u4fe1"), (d = 5))
        : ((b = UIToolManager.randomInt(5, 6)),
          (d = 1),
          (c = 5 == b ? "\u6253\u6ce1\u6ce1" : "\u9526\u4e0a\u6dfb\u82b1"))
      : (0 < b.indexOf("kakaotalk") || b.indexOf("line"),
        (b = UIToolManager.randomInt(5, 6)),
  ...
  showScore: function (a) {
    ...
    a >= game_max_score
      ...
      ? (d =
          ...
          "\u4e2d\u5f97\u4e86" +
          a +
          "\u5206\uff0c\u51fb\u8d25\u4e86\u5168\u740399%\u7684\u73a9\u5bb6\uff0c\u8fbe\u5230\u4e86\u72ec\u5b64\u6c42\u8d25\u7684\u5883\u754c\uff01")
      : 2e3 < a &&
        a < game_max_score &&
        ((d = 20 - Math.ceil((17 * (a - 2e3)) / (game_max_score - 2e3))),
        (d =
          "\u6211\u5728" +
          c +
          "\u4e2d\u5f97\u4e86" +
    ...
    null != endShowText &&
      ...
      (d = endShowText.content);
    this.tipLabel0 = new cc.LabelTTF(d, "Arial", 42, cc.TEXT_ALIGNMENT_LEFT);
    a = Math.ceil(this.tipLabel0.width / 600) + 1;
    this.tipLabel = new cc.LabelTTF(
      d,
      "Arial",
      42,
    ...
    cc.log("d,", a);
    b =
      this.scoreBg.y - this.scoreBg.getBoundingBox().height - 42 - 15 - 42 * a;
    this.clickMenuBtnS(b);
    score_share(d);
  },
  SetMaxScore: function (a) {},
...
var GameInfoLayer = cc.LayerColor.extend({
  ...
  init: function () {
    ...
    gamePV_load();
    cc.log("nihaossssssss");
    var b, c;
    b = LanguageManager.getText("game_info");
    c = LanguageManager.getText("start");
    b = new cc.LabelTTF(
      b,
      "Arial",
      42,
...
var loadLayer = cc.Layer.extend({
    ...
    btnStartFunc: function (a) {
      cc.log("\u5f00\u59cb\u6e38\u620f");
      a = MainManager.adShowBefore;
      cc.log("ADDDDD", a);
      (a = null == a || void 0 == a ? true : MainManager.adShowBefore)
        ? ((this.needShow = true), showMyAds())
        : (this.needShow = false);
      cc.LoaderScene.preload(
        ...
        function () {
          this.needShow
            ? (cc.log("pre", preloader),
              void 0 == preloader && cc.director.runScene(new GameScene()),
              (resCompleteFlag = true),
              adCompleteFlag &&
                resCompleteFlag &&
                cc.director.runScene(new GameScene()))
            : cc.director.runScene(new GameScene());
...
function checkShowAd() {
  1 == getLocalStorage("old_key_kantushiying11")
    ? ((gameT = 1), (this.needShow = true), showMyAds())
    : setLocalStorage("old_key_kantushiying11", 1);
}

function setLocalStorage(a, b) {
  try {
    return cc.sys.localStorage.setItem(a, b), true;
  } catch (c) {
    return false;
  }
}
...
function getLocalStorage(a) {
  try {
    return cc.sys.localStorage.getItem(a);
  } catch (b) {
    return false;
  }
}
var HttpManager = cc.Class.extend({
  URL: "http://g.regogame.com/Service/Share/index",
  cacheList: null,
  isBusy: null,
  req: null,
  perform: null,
  ctor: function () {
    this.URL = window.__ROOT__ + "/Service/Share/index.json";
    this.cacheList = [];
  },
  checkHave: function () {
  ...
  sendOne: function () {
    if (0 != this.cacheList.length) {
      ...
      var a = this.returnLanguage(),
        b = 1,
        c = document.URL,
        c = c.substring(c.lastIndexOf("/game/") + 1, c.length).split("/");
      2 <= c.length && (b = c[1]);
      a =
        "send\x3d" +
        JSON.stringify({
  ...
  onDataHandler: function () {
    if (
      ...
      if (this.req.responseText) {
        var a = JSON.parse(this.req.responseText);
        this.isBusy = false;
        this.perform.target
          ...
          : this.perform.func(a);
      } else this.perform.func("zhongguo0");
  },
  ...
  clearAll: function () {
    for (var a = this.cacheList.length, b = 0; b < a; b++) {
      var c = this.cacheList[b];
      c && (c.target ? c.func.call(c.target, -1) : c.func(-1));
    }
...
var LinkLayer = cc.Layer.extend({
  ...
  onTouchMoved: function (a, b) {},
  onTouchEnded: function (a, b) {
    a.getLocation().x > CW / 2 && this.layerOut();
  },
  initUI: function (a) {
    this.LW = CW / 2 + 100;
    ...
    var f = LanguageManager.getText("link_top_tip");
    this.txt1 = UIToolManager.getLabelTTF(f, 42, 0, 0.5, b - d / 2, c);
    this.nodeContainer.addChild(this.txt1);
    this.txt1.width > d && (this.txt1.scale = d / this.txt1.width);
    d = new cc.Menu();
    d.setPosition(0, 0);
    this.nodeContainer.addChild(d);
    for (var f = a.gameList.length, g = 0; g < f; g++) {
      var c = c - 100,
        h = new cc.MenuItemImage(
          res.button1_png,
          res.button1_png,
          this.openLink.bind(this, a.gameList[g][1])
        );
      h.setPosition(b, c);
      h.setScaleX(e);
      h.setScaleY(0.75);
      var k = UIToolManager.getLabelTTF(
        "" + a.gameList[g][0],
        36,
        0.5,
        0.5,
      ...
      this.nodeContainer.addChild(k);
      d.addChild(h);
      cc.log("txt.width: " + k.width);
      cc.log("btn.width: " + h.width);
      h = (h.width - 20) * h.scaleX;
      k.width > h && (k.scale = h / k.width);
    }
    c = CH / 2;
    e = new cc.MenuItemImage(
      res.btn_jiantou_png,
      res.btn_jiantou_png,
      this.layerOut.bind(this)
    );
    e.setAnchorPoint(1, 0.5);
    e.setPosition(this.LW - 15, c);
    d.addChild(e);
    this.logo = UIToolManager.getSprite(res.Loading_png, 0.5, 0, b, 220);
    this.nodeContainer.addChild(this.logo);
    this.logo.scale = 0.83;
    c = 145;
    this.btnCenter = new cc.MenuItemImage(
      res.button2_png,
      res.button2_png,
      this.openLink.bind(this, a.gameCenter)
    );
    this.btnCenter.setPosition(b, c);
    this.btnCenter.setScale(0.85);
    a = LanguageManager.getText("game_center");
    k = UIToolManager.getLabelTTF(a, 40, 0.5, 0.5, b, c);
    this.nodeContainer.addChild(k);
    d.addChild(this.btnCenter);
    200 < k.width && (k.scale = 200 / k.width);
  },
  openLink: function (a) {
  ...
  layerIn: function () {
    ...
    this.nodeContainer.runAction(
      cc.sequence(cc.moveTo(0.2, 0, 0), cc.callFunc(this.layerInEnd.bind(this)))
    );
  },
  layerInEnd: function () {
    this.createListener();
  ...
  layerOut: function () {
    ...
    this.nodeContainer.runAction(
      cc.sequence(
        cc.moveTo(0.2, -CW / 2, 0),
        cc.callFunc(this.closeLayer.bind(this))
      )
    );
  },
  closeLayer: function () {
    this.hide();
    MainLayer.canTouch = true;
...
var MainManager = {
    ...
    getDist: function (a, b, c, d) {
      return cc.pDistance(cc.p(a, b), cc.p(c, d));
    },
    gotoCover: function () {
    ...
    getLinkGame: function () {
      var a = {};
      a.language = cc.sys.language;
      HttpManager.instance.send("101", a, this.getLinkGameReturn, this);
    },
    getLinkGameReturn: function (a, b, c, d) {
      0 == a
        ? ((this.ranLinkData = b),
          ...
          this.ranRecGameData(),
          (this.InfoData = d),
          cc.log("this.infoData", this.InfoData),
        ...
        : cc.log("\u83b7\u53d6\u5931\u8d25");
      cc.log("MainLoad0", MainManager.adShowAfter);
      document.title =
        null != this.infoGameName && "" != this.infoGameName
          ? this.infoGameName
          : LanguageManager.getText("game_name");
    ...
    ranRecGameData: function () {
      if (null != this.recGameData && "" != this.recGameData) {
        ...
        var a = MainManager.randomInt(1, this.recGameData.length) - 1;
        cc.log("ranNNN", a);
        this.recGameUrl = this.recGameData[a].data_link;
        this.recGameDelPer = this.recGameData[a].delay_per;
        this.recGameDelPau = this.recGameData[a].delay_pau;
        this.recGameimg1 = this.recGameData[a].img_1;
        this.recGameimg2 = this.recGameData[a].img_2;
        this.recGamePos = this.recGameData[a].poistion;
      }
    },
    ranLinkUrl: function () {
      if (null != this.ranLinkData) {
        var a = this.randomInt(1, this.ranLinkData.gameList.length) - 1;
        cc.log("templ", a, this.ranLinkData.gameList);
        cc.log(
          "url",
    ...
    gotoMoreGame: function (a) {
      window.location.href =
        null != this.ranLinkData.gameSet.moreBtnUrl &&
        "" != this.ranLinkData.gameSet.moreBtnUrl
          ? this.ranLinkData.gameSet.moreBtnUrl
          : a;
    },
    testFunc: function () {},
  ...
  setO = 200;
var UIToolManager = {
  getSprite: function (a, b, c, d, e) {
    a = new cc.Sprite(a);
    null != b && null != c && a.setAnchorPoint(b, c);
    null != d && null != e && a.setPosition(d, e);
    return a;
  },
  getLabelTTF: function (a, b, c, d, e, f, g) {
    a = new cc.LabelTTF("" + a, "Arial \u7c97\u4f53", b);
    a.setAnchorPoint(c, d);
    a.setPosition(e, f);
    null != g && a.setFontFillColor(g);
    return a;
  },
  getLabelTTF2: function (a, b, c, d, e, f, g) {
    a = new cc.LabelTTF("" + a, "Arial", b);
    a.setAnchorPoint(c, d);
    a.setPosition(e, f);
    null != g && a.setFontFillColor(g);
    return a;
...
var LayerManager = {
  init: function () {},
  showGameInfoLayer: function (a) {
    var b = new GameInfoLayer();
    a || (a = 100);
    MainLayer.addChild(b, a);
  },
  showGameEndLayer: function (a, b) {
    setSubmitLoad(0);
    b || (b = 25);
    var c,
      d = false,
    ...
    if ("zh-tw" == e || "zh-hk" == e || "zh-TW" == e)
      (ChineseFlag = false), (d = true), (c = new GameEndLayer3());
    !ChineseFlag ||
      FaceBookFlag ||
      TwitterFlag ||
      ((d = true), (c = new GameEndLayer2()));
    if (false == d) {
      switch (cc.sys.language) {
        case cc.sys.LANGUAGE_KOREAN:
        case cc.sys.LANGUAGE_JAPANESE:
        case "th":
          c = new EndLayerDefault();
          break;
        default:
          c = new EndLayerEnglish();
      }
      true == langBool && (c = new EndLayerDefault());
    }
    MainLayer.addChild(c, b);
    d = MainLayer.score;
    e = cc.sys.localStorage.getItem(a);
    e || ((e = d), score_submit(d, 1));
    d > e && score_submit(d, 1);
    c.showScore(d);
  },
};
var _lastAdTime = 0,
  ...
  AdLayer = cc.Layer.extend({
    ...
    init: function () {
      ...
      this.addChild(this.bg);
      var a = cc.director.getVisibleSize().width / 720;
    ...
    setLastShowAd: function () {
      _lastAdTime = new Date().getTime() / 1e3;
    },
    getInterval: function () {
      var a = new Date().getTime() / 1e3 - _lastAdTime;
      cc.log("nt-\x3e" + a);
      return a;
    },
    layerIn: function () {
      ...
      this.node.runAction(
        cc.sequence(
          cc.moveTo(0.3, 0, 0),
          cc.callFunc(this.setState.bind(this, 2))
        )
      );
    },
    layerOut: function () {
      this.node.runAction(
        cc.sequence(
          cc.moveTo(0.3, -CW, 0),
          cc.callFunc(this.destroy.bind(this))
        )
      );
    },
    createListener: function () {
    ...
    onTouchEnded: function (a, b) {
      2 == this.state &&
        ...
        showMyAds(),
        this.runAction(
          cc.sequence(cc.delayTime(0), cc.callFunc(this.layerOut.bind(this)))
        ),
        this.setLastShowAd());
    },
    setState: function (a) {
...
var GameEndLayer3 = cc.Layer.extend({
  tipLabel: null,
  chouJiangItem: null,
  moreGameItem: null,
  _shareLabel: null,
  ...
  onFocusClick1: function (a, b) {
    1 == a
      ...
      : 4 != a &&
        (window.location.href =
          5 == a
            ? "http://g.lisagame.com/game/9"
            : 6 == a
            ? "http://g.lisagame.com/game/24"
            : MainManager.ranLinkData.gameList[b].gameUrl);
  },
  returnFocusNum: function () {
    var a = [],
...
var EndLayerDefault = cc.Layer.extend({
  tipLabel: null,
  chouJiangItem: null,
  moreGameItem: null,
  _shareLabel: null,
  ...
  clickMenuBtnS: function (a) {
    var b = this.returnLinkText(),
      c = "" + b[0],
      d = "" + b[1],
      e = "" + b[3],
      b = b[4],
      f = cc.director.getVisibleSize();
    null != MainManager.moreGameText &&
      "" != MainManager.moreGameText &&
      (c = MainManager.moreGameText);
    null != MainManager.playAgainText &&
    ...
    null != MainManager.ranLinkData &&
      null != MainManager.ranLinkData.gameList &&
      ((d = 100),
      (k = h = MainManager.ranLinkUrl()),
      (h = MainManager.ranLinkData.gameList[h].gameName));
    this.btnGuanzhu = this.getTxtButton(
      this,
      res.button1_png,
      this.onFocusClick.bind(this, d, b, k),
      h,
      f.width / 2 + 150,
      a - 140,
      0.6,
  ...
  onFocusClick: function (a, b, c) {
    this.btnGuanzhu.runAction(
      cc.sequence(
        cc.scaleTo(0.05, 0.51, 0.765),
        cc.scaleTo(0.05, 0.6, 0.9),
        cc.delayTime(0.1),
        cc.callFunc(this.onFocusClick1.bind(this, a, b, c))
      )
    );
    this._textArr[1].runAction(
      cc.sequence(cc.scaleTo(0.05, 0.85, 0.85), cc.scaleTo(0.05, 1, 1))
    ...
    1 == a
      ...
      : 4 != a &&
        (window.location.href =
          5 == a
            ? 1 == b
              ? "http://g.hibisgame.com/game/60/"
              : 2 == b
              ? "http://g.camegame.com/game/29"
              : 13 == b
              ? "http://g.kakogame.com/game/36"
              : "http://g.fromgame.com/game/53"
            : 6 == a
            ? 1 == b
              ? "http://g.hibisgame.com/game/55/"
              : 2 == b
              ? "http://g.camegame.com/game/2"
              : 13 == b
              ? "http://g.kakogame.com/game/2"
              : "http://g.fromgame.com/game/13"
            : MainManager.ranLinkData.gameList[c].gameUrl);
  },
  returnFocusNum: function () {
    var a = [],
      b = 0,
  ...
  showScore: function (a) {
    ...
    game_max_score = 100;
    parseFloat(a / game_max_score).toFixed(2);
    var c = this.returnLanguageNum(),
      c = this.returnNameAndText(c);
    null != MainManager.endShow1 &&
      "" != MainManager.endShow1 &&
      null != MainManager.endShow2 &&
      "" != MainManager.endShow2 &&
      ((c[1] = MainManager.endShow1 + " "),
      (c[2] = "," + MainManager.endShow2));
    c = c[1] + a + c[2];
    null != endShowText &&
      "" != endShowText &&
      null != MainManager.moreGameText &&
      ...
      null != MainManager.playAgainText &&
      "" != MainManager.playAgainText &&
      (c = endShowText.content);
    this.tipLabel0 = new cc.LabelTTF(c, "Arial", 42, cc.TEXT_ALIGNMENT_LEFT);
    var d = Math.ceil(this.tipLabel0.width / 600) + 1;
    this.tipLabel = new cc.LabelTTF(
      c,
      "Arial",
      42,
    ...
    cc.log("d,", d);
    b =
      this.scoreBg.y - this.scoreBg.getBoundingBox().height - 42 - 15 - 42 * d;
    this.clickMenuBtnS(b);
    a >= game_max_score && (game_max_score = a);
    this.tipLabel.string = c;
    score_share(c);
  },
  returnNameAndText: function (a) {
    var b = [],
      c = "",
      d = "",
      e = "";
    1 == a
      ...
      ? ((c = "\u300c\u6e07\u304d\u306e\u30d0\u30fc\u30c7\u30a3\u30fc\u300d"),
        ...
        (e =
          "\uff0c\u30dd\u30a4\u30f3\u30c8\u3067\u3059\uff01\u662f\u975e\u3001\u79c1\u3068\u4e00\u7dd2\u306b\u904a\u3073\u307e\u3059\uff01"))
      : 3 == a
      ? ((c = "CROW"), (d = "In Game "), (e = "\uff0cLet's play together!"))
      : 4 == a
      ? ((c = "CROW"),
        (d = "\u0e43\u0e19\u0e40\u0e01\u0e21 "),
        (e =
...
var _languageManagerInstance,
  ...
  LanguageManager = {
      ...
      if (!_languageManagerInstance)
        switch (((_languageManagerInstance = {}), cc.sys.language)) {
          case cc.sys.LANGUAGE_CHINESE:
            ...
            "zh-tw" == window.navigator.language
              ? (cc.log("\u7e41\u4f53"),
                (_languageManagerInstance.data = languageTra_Chinese),
                (langNumType = 2),
                (langNumText = "\u7a0d \u5019 \u67e5 \u770b \u5206 \u6578"))
              : (cc.log("\u7b80\u4f53"),
                (langNumType = 1),
                (langNumText = "\u7a0d \u5019 \u67e5 \u770b \u5206 \u6570"),
          ...
          case "th":
            ...
            langNumText =
              "\u0e08\u0e30\u0e23\u0e2d\u0e14\u0e39\u0e04\u0e27\u0e32\u0e21\u0e2a\u0e33\u0e40\u0e23\u0e47\u0e08";
            _languageManagerInstance.data = language_Thai;
            break;
          case cc.sys.LANGUAGE_JAPANESE:
            langNumType = 5;
            langNumText =
          ...
          default:
            (langNumType = 3),
              (langNumText = "View the score later"),
    ...
    getText: function (a) {
      return "game_info" == a
        ? null != MainManager.showText && "" != MainManager.showText
          ? MainManager.showText
          : _languageManagerInstance.data[a]
          ? _languageManagerInstance.data[a]
          : "NULL"
        : "start" == a
        ? null != MainManager.startText && "" != MainManager.startText
          ? MainManager.startText
          : _languageManagerInstance.data[a]
          ? _languageManagerInstance.data[a]
          : "NULL"
        : _languageManagerInstance.data[a]
...
var language_English = {
  game_name: "Thousand Flower",
  game_info: "Three same color petals can be eliminated.",
  tip_info: "Double tap continuous jump",
  start: "Start",
  link_top_tip: "Others are playing : ",
  game_center: "Game center",
  more_game: "More Games",
  replay: "Replay",
  share_info: "My score is $$$ points! Come and play with me!",
};
var language_Korean = {
  game_name: "\ucc9c \uaf43",
  game_info:
    "3 \uac1c\uc758 \ub3d9\uc77c\ud55c \uc0c9\uae54 \uaf43\uc78e\uc740 \uc0ad\uc81c \ub420 \uc218\uc788\ub2e4.",
  tip_info: "\ub450 \ubc88 \ud0ed \uc5f0\uc18d \uc810\ud504",
  start: "\ubd80\ud130 \uac8c\uc784",
  ...
  replay: "\ub2e4\uc2dc \ud50c\ub808\uc774",
  share_info:
    "\ub0b4 \uac8c\uc784\uc740 $$$ \uc810\uc744 \ub4dd\uc810\ud55c\ub2e4.\uc88b\uc544!\ub2f9\uc2e0\uc740 \ub098\uc640 \ud568\uaed8 \ud50c\ub808\uc774 \uc628!",
};
var language_Japanese = {
  game_name: "\u5343\u82b1",
  game_info:
    "3\u3064\u306e\u540c\u3058\u8272\u306e\u82b1\u5f01\u3092\u6392\u9664\u3059\u308b\u3053\u3068\u304c\u3067\u304d\u307e\u3059\u3002",
  tip_info:
    "\u30c0\u30d6\u30eb\u30bf\u30c3\u30d7\u9023\u7d9a\u30b8\u30e3\u30f3\u30d7",
  start: "\u30b2\u30fc\u30e0\u3092\u59cb\u3081\u308b",
  ...
  replay: "\u518d\u3073\u30d7\u30ec\u30fc",
  share_info:
    "\u79c1\u306e\u30b9\u30b3\u30a2\u306f $$$ \u30dd\u30a4\u30f3\u30c8\u3067\u3059\uff01\u662f\u975e\u3001\u79c1\u3068\u4e00\u7dd2\u306b\u904a\u3073\u307e\u3059\uff01",
};
var language_Spanish = {
  game_name: "Mil flores",
  game_info: "Tres p\u00e9talos del mismo color se pueden eliminar.",
  start: "Juegos Comenzar",
  link_top_tip: "Others are playing : ",
  game_center: "Game center",
  more_game: "m\u00e1s Juegos",
  replay: "Jugar de nuevo",
  share_info: "Mi puntuaci\u00f3n es de $$$ puntos! Ven a jugar conmigo!",
};
var language_Portuguese = {
  game_name: "Mil Flor",
  game_info: "Tr\u00eas p\u00e9talas da mesma cor podem ser eliminadas.",
  start: "Come\u00e7ar Jogo",
  link_top_tip: "Outros est\u00e3o jogando : ",
  game_center: "Game Center",
  more_game: "Mais Jogos",
  replay: "Jogar de Novo",
  share_info:
    "Minha pontua\u00e7\u00e3o \u00e9 $$$ pontos! Vem brincar comigo!",
};
var language_French = {
  game_name: "Mille fleurs",
  game_info:
    "Trois p\u00e9tales de m\u00eame couleur peuvent \u00eatre \u00e9limin\u00e9s.",
  start: "D\u00e9marrer Jeu",
  link_top_tip: "D'autres personnes jouent : ",
  game_center: "Game Center",
  more_game: "Plus de Jeux",
  replay: "Jouer Encore",
  share_info: "Mon score est de $$$ points! Viens jouer avec moi!",
};
var language_Italian = {
  game_name: "Mille fiori",
  game_info: "Tre petali dello stesso colore possono essere eliminati.",
  start: "Inizia il Gioco",
  link_top_tip: "Altre persone stanno giocando : ",
  game_center: "Game Center",
  more_game: "Pi\u00f9 Gioco",
  replay: "Giocare di nuovo",
  share_info: "Il mio punteggio \u00e8 di $$$ punti! Vieni a giocare con me!",
};
var language_German = {
  game_name: "Tausend Blume",
  game_info:
    "Drei gleichfarbige Bl\u00fctenbl\u00e4tter k\u00f6nnen eliminiert werden.",
  start: "Spiel beginnen",
  link_top_tip: "Andere Leute spielen : ",
  game_center: "Game Center",
  more_game: "Mehr Spiel",
  replay: "Noch Einmal Spielen",
  share_info: "Meine Punktzahl betr\u00e4gt $$$ Punkte! Komm, spiel mit mir!",
};
var language_Russian = {
  game_name:
    "\u0422\u044b\u0441\u044f\u0447\u0430 \u0446\u0432\u0435\u0442\u043e\u0432",
  game_info:
    "\u0422\u0440\u0438 \u043e\u0434\u0438\u043d\u0430\u043a\u043e\u0432\u044b\u0445 \u0446\u0432\u0435\u0442\u043d\u044b\u0445 \u043b\u0435\u043f\u0435\u0441\u0442\u043a\u0430 \u043c\u043e\u0436\u043d\u043e \u0443\u0441\u0442\u0440\u0430\u043d\u0438\u0442\u044c.",
  start: "\u043d\u0430\u0447\u0430\u0442\u044c \u0438\u0433\u0440\u0443",
  link_top_tip: "Others are playing : ",
  game_center: "Game center",
  more_game: "\u0431\u043e\u043b\u044c\u0448\u0435 \u0438\u0433\u0440",
  replay: "\u0438\u0433\u0440\u0430\u0442\u044c \u0441\u043d\u043e\u0432\u0430",
  share_info:
    "\u041c\u043e\u044f \u043e\u0446\u0435\u043d\u043a\u0430 \u0441\u043e\u0441\u0442\u0430\u0432\u043b\u044f\u0435\u0442 $$$ \u0431\u0430\u043b\u043b\u043e\u0432! \u041f\u043e\u0438\u0433\u0440\u0430\u0439 \u0441\u043e \u043c\u043d\u043e\u0439!",
};
var language_Thai = {
  game_name: "\u0e1e\u0e31\u0e19\u0e14\u0e2d\u0e01\u0e44\u0e21\u0e49",
  game_info:
    "\u0e2a\u0e32\u0e21\u0e01\u0e25\u0e35\u0e1a\u0e2a\u0e35\u0e40\u0e14\u0e35\u0e22\u0e27\u0e01\u0e31\u0e19\u0e2a\u0e32\u0e21\u0e32\u0e23\u0e16\u0e01\u0e33\u0e08\u0e31\u0e14\u0e44\u0e14\u0e49",
  start: "\u0e40\u0e23\u0e34\u0e48\u0e21\u0e40\u0e01\u0e21\u0e2a\u0e4c",
  link_top_tip:
    "\u0e04\u0e19\u0e2d\u0e37\u0e48\u0e19 \u0e46 \u0e01\u0e33\u0e25\u0e31\u0e07\u0e40\u0e25\u0e48\u0e19 : ",
  game_center: "\u0e28\u0e39\u0e19\u0e22\u0e4c\u0e40\u0e01\u0e21",
  more_game:
    "\u0e21\u0e32\u0e01\u0e01\u0e27\u0e48\u0e32\u0e40\u0e01\u0e21\u0e2a\u0e4c",
  replay:
    "\u0e40\u0e25\u0e48\u0e19\u0e2d\u0e35\u0e01\u0e04\u0e23\u0e31\u0e49\u0e07",
  share_info:
    "\u0e04\u0e30\u0e41\u0e19\u0e19\u0e02\u0e2d\u0e07\u0e09\u0e31\u0e19\u0e04\u0e37\u0e2d $$$ \u0e04\u0e30\u0e41\u0e19\u0e19! \u0e21\u0e32\u0e40\u0e25\u0e48\u0e19\u0e01\u0e31\u0e1a\u0e09\u0e31\u0e19!",
};
var language_Filipino = {
  game_name: "Libong Bulaklak",
  game_info: "Tatlong parehong kulay petals maaaring eliminated.",
  start: "Simulan ang Laro",
  link_top_tip: "Ang iba ay naglalaro : ",
  game_center: "Game Center",
  more_game: "Pang Laro",
  replay: "Play Again",
  share_info: "Aking iskor ay $$$ points! Halika i-play sa akin!",
};
var language_Malay = {
  game_name: "Seribu Bunga",
  game_info: "Tiga kelopak warna yang sama boleh dihapuskan.",
  start: "Mula Permainan",
  link_top_tip: "Lain bermain : ",
  game_center: "Game Center",
  more_game: "Lebih Permainan",
  replay: "Play Again",
  share_info: "Skor saya adalah $$$ mata! Marilah bermain dengan saya!",
};
var language_Indonesian = {
  game_name: "Ribuan Bunga",
  game_info: "Tiga kelopak warna yang sama bisa dihilangkan.",
  start: "Memulai Permainan",
  link_top_tip: "Orang lain bermain : ",
  game_center: "Game Center",
  more_game: "Lebih Permainan",
  replay: "Mainkan Lagi",
  share_info: "Skor saya adalah $$$ poin! Marilah bermain dengan saya!",
};
var PC_FLAG = false,
  ChineseFlag = false;
cc.game.onStart = function () {
  ...
  cc.sys.os === cc.sys.OS_BLACKBERRY ||
  cc.sys.os === cc.sys.OS_WP8 ||
  cc.sys.os === cc.sys.OS_BADA
  ...
  cc.sys.language == cc.sys.LANGUAGE_CHINESE && (ChineseFlag = true);
...
function setSubmitLoad(a) {
  cc.sys.localStorage.setItem("FromHua", a);
}

function getSubmitLoad() {
  return cc.sys.localStorage.getItem("FromHua");
}

function judgeSceneNum() {
  if (1 == getLocalStorage0("FromHuaGame")) return 1;
  setLocalStorage0("FromHuaGame", 1);
  return -1;
}

function getLocalStorage0(a) {
  try {
    return cc.sys.localStorage.getItem(a);
  } catch (b) {
    return false;
...
function checkShowAd() {
  1 == getLocalStorage("old_key_p125")
    ? (showMyAds(), (HasOldKey = true))
    : setLocalStorage("old_key_p125", 1);
}
