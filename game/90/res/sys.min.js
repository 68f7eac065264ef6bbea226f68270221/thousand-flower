...
var guide_btn = "更多游戏";
var guide_href =
  "http://mp.weixin.qq.com/s?__biz=MzA5NzQxMzU4NQ==&mid=207293871&idx=1&sn=173662dd6d0b62ec9f19382a5368f270#rd";
var is_prize = "";
...
function gamePV_load() {
  ajaxLoad(window.__ROOT__ + "/Service/GamePv/index.html", "gameId=" + game_id, ajaxOnLogoResult);
}
...
function score_submit(gameScore, gameType) {
  ajaxLoad(
    "http://" + window.location.host + window.__ROOT__ + "/Service/Score/index",
    "gameScore=" + gameScore + "&gameId=" + game_id + "&gameType=" + gameType,
    scoreResult
  );
}
